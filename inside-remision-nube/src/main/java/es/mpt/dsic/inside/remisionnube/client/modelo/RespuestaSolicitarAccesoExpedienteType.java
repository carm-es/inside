...
/**
 * Esquema que representa una respuesta a la solicitud de acceso a expediente
 * 
 * <p>Clase Java para RespuestaSolicitarAccesoExpedienteType complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="RespuestaSolicitarAccesoExpedienteType">
 *   &lt;complexContent>
...
@XmlType(name = "RespuestaSolicitarAccesoExpedienteType", namespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/remisionNube", propOrder = {
    "respuesta",
    "idPeticion"
})
public class RespuestaSolicitarAccesoExpedienteType {
