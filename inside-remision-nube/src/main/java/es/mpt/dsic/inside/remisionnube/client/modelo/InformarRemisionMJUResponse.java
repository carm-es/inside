...
/**
 * <p>Clase Java para informarRemisionMJUResponse complex type.
 * 
...
@XmlType(name = "informarRemisionMJUResponse", propOrder = {
    "respuestaComunicacionResultadoEnvioMJUType"
})
public class InformarRemisionMJUResponse {

    @XmlElement(name = "RespuestaComunicacionResultadoEnvioMJUType", namespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService")
