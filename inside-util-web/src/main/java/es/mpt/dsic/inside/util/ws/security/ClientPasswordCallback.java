...
/**
 * Clase que implemente la interfaz CallbackHandler para poder usar la clave
 * privada del certificado a fin de firmar las peticiones.
 * Genera un callback de salida.
 * 
 */
