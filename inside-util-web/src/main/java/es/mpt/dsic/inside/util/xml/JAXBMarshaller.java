...
public class JAXBMarshaller {
	...
	public void marshallDataDocumentAndWriteFile(Object doc, String pathDocENITemp, String nameSapce, String localPart,
			String prefix) throws JAXBException, XPathExpressionException, ParserConfigurationException, SAXException,
		...
		if (doc instanceof TipoDocumento) {
			...
			if (((TipoDocumento) doc).getContenido() != null && ((TipoDocumento) doc).getContenido().getDatosXML() != null) {
			...
			JAXBElement<TipoDocumento> jx = new JAXBElement<TipoDocumento>(new QName(nameSapce, localPart, prefix),
		...
		if (doc instanceof TipoDocumentoInsideConMAdicionales) {
			...
			JAXBElement<TipoDocumentoInsideConMAdicionales> jx = new JAXBElement<TipoDocumentoInsideConMAdicionales>(
	...
	public String marshallDataDocument(Object doc, String nameSapce, String localPart, String prefix) throws JAXBException,
	...
	public TipoExpediente unmarshallDataExpedient(byte[] data) throws JAXBException, ParserConfigurationException, SAXException,
	...
	public TipoExpedienteInsideConMAdicionales unmarshallDataExpedientAditional(byte[] data) throws JAXBException,
	...
	/**
	 * Los metadatos de archive tipo eEMGDE los pasa a 
	 ...
	 */
	public TipoExpedienteInsideConMAdicionales unmarshallDataExpedientArchive(byte[] data) throws JAXBException,
			ParserConfigurationException, SAXException, IOException, TransformerFactoryConfigurationError, TransformerException {
		TipoExpedienteInsideConMAdicionales retorno = new TipoExpedienteInsideConMAdicionales();
		...
		Unmarshaller unmarshaller = jc.createUnmarshaller(); //
		JAXBElement<?> element = (JAXBElement<?>) unmarshaller.unmarshal(new ByteArrayInputStream(expediente));
		retorno.setExpediente((TipoExpediente) element.getValue());
		...
		if (nodoAdicionales != null && nodoAdicionales.hasChildNodes()) {
			byte[] nodoMetadatosAdicionales = XMLUtils.objetoArchiveToEni(data, "archiveexp:metadatosAdicionales");
			HandlerExpedient handler = new HandlerExpedient(new ByteArrayInputStream(nodoMetadatosAdicionales));
		...
		if (nodoAdicionalesEmdge != null) {
			byte[] nodoMetadatosAdicionalesEmgdeString = XMLUtils.objetoArchiveToEni(data, "metadatosAdicionales");
	...
	public TipoDocumentoInsideConMAdicionales unmarshallDataDocumentAditional(byte[] data) throws JAXBException,
			ParserConfigurationException, SAXException, IOException, TransformerFactoryConfigurationError, TransformerException {
	...
	/**
	 * Los metadatos de archive tipo eMGDE los pasa a 
	 * metadatos adicionales.
	 * @param data
	 * @return
	 * @throws JAXBException
	 ...
	 * @throws TransformerException
	 */
	public TipoDocumentoInsideConMAdicionales unmarshallDataDocumentoArchive(byte[] data) throws JAXBException,
			ParserConfigurationException, SAXException, IOException, TransformerFactoryConfigurationError, TransformerException {
		TipoDocumentoInsideConMAdicionales retorno = new TipoDocumentoInsideConMAdicionales();
		...
		Unmarshaller unmarshaller = jc.createUnmarshaller(); //
		JAXBElement<?> element = (JAXBElement<?>) unmarshaller.unmarshal(new ByteArrayInputStream(documento));
		retorno.setDocumento((TipoDocumento) element.getValue());

		Node nodoAdicionales = XMLUtils.getNode(data, "archivedoc:metadatosAdicionales");
		if (nodoAdicionales != null && nodoAdicionales.hasChildNodes()) {
			byte[] nodoMetadatosAdicionales = XMLUtils.objetoArchiveToEni(data, "archivedoc:metadatosAdicionales");
			HandlerExpedient handler = new HandlerExpedient(new ByteArrayInputStream(nodoMetadatosAdicionales));
			retorno.setMetadatosAdicionales(new TipoMetadatosAdicionales());
			retorno.getMetadatosAdicionales().getMetadatoAdicional()
			.addAll(handler.getMetadatosAdicionales().getMetadatoAdicional());
	...
	public SignatureType unmarshallDataSignature(byte[] data) throws JAXBException, ParserConfigurationException, SAXException,
			IOException, TransformerFactoryConfigurationError, TransformerException {
