...
public abstract class ObjetoInside<T extends ObjetoInsideMetadatos> implements Serializable{
	...
	/**
	 * Establece el identificador unico para este objeto
	 * También establece el valor del campo IdentificadorObjetoInside
	 * de sus metadatos
	 * @param identificador
	 */
	...
	public String toString() {
		return "Objeto Inside, identificador " + this.getIdentificador() + " . ";
	}*/
	...
	/**
	 * Los objetos Inside deben disponer de este 
	 * método para crear una instancia de sus metadatos
	 * @return
	 */
