...
public class SolicitudAccesoExpediente implements java.io.Serializable {
	...
	@Id
	@TableGenerator(name = "GeneradorPk_SolicitudAccesoExpediente",
    		table = "GeneradorClaves",
    		pkColumnName = "GenName",
    		valueColumnName = "GenValue",
    		pkColumnValue = "GEN_SolicitudAccesoExpediente",
    		allocationSize=1)
    @GeneratedValue(strategy = GenerationType.TABLE, generator = "GeneradorPk_SolicitudAccesoExpediente")
