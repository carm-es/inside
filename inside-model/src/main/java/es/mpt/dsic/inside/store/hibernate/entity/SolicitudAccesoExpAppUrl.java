...
public class SolicitudAccesoExpAppUrl implements java.io.Serializable {
	...
	@Id
	@TableGenerator(name = "GeneradorPk_SolicitudAccesoExpAppUrl",
    		table = "GeneradorClaves",
    		pkColumnName = "GenName",
    		valueColumnName = "GenValue",
    		pkColumnValue = "GEN_SolicitudAccesoExpAppUrl",
    		allocationSize=1)
    @GeneratedValue(strategy = GenerationType.TABLE, generator = "GeneradorPk_SolicitudAccesoExpAppUrl")
