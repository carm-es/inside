...
public class ObjetoInsidePermiso
extends ObjetoPermisos{
	...
	public ObjetoInsidePermiso(ObjetoInsideAplicacion app,
			ObjetoInside<?> objeto, Boolean lectura, Boolean escritura) {
