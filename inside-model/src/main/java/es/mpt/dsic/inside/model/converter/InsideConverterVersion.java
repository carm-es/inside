...
public class InsideConverterVersion {
	...
	/**
	 * Convierte un objeto ObjetoInsideVersion de Inside al mensaje 
	 * TipoVersionInside del WS de Inside
	 * @param version
	 * @return
	 * @throws InsideConverterVersionInsideException 
	 * @throws InsideWSInternalErrorException 
	 */
	public static TipoVersionInside versionInsideToXml(ObjetoInsideVersion version) throws InsideConverterException {
		TipoVersionInside xmlVersion = new TipoVersionInside();
		xmlVersion.setVersion(version.getVersion());
		try {
			xmlVersion.setFechaVersion(InsideConverterXmlGregorianCalendar.calendarToXmlCalendar(version.getFechaVersion()));
	...
	/**
	 * Convierte un objeto TipoVersionInside del WS deInside
	 * al objeto ObjetoInsideVersion de Inside 
	 * @param xmlVersion
	 * @return
	 */
	public static ObjetoInsideVersion versionXmlToInside(TipoVersionInside xmlVersion) {
		ObjetoInsideVersion version = new ObjetoInsideVersion(xmlVersion.getVersion(),xmlVersion.getFechaVersion().toGregorianCalendar());
		return version;
	}
	
	/**
	 * Convierte una lista de objetos ObjetoInsideVersion de Inside
	 * a una lista de TipoVersionInside del Inside WS
	 * @param versiones
	 * @return
	 * @throws InsideConverterVersionInsideException 
	 * @throws InsideWSInternalErrorException 
	 */
	public static List<TipoVersionInside> versionesInsideToXml(List<ObjetoInsideVersion> versiones) throws InsideConverterException {
		...
		for (ObjetoInsideVersion versionInside : versiones) {
			...
			/*} catch (InsideConverterVersionInsideException e) {
				throw new InsideConverterVersionInsideException(e);
			}*/
		}
		return versionesXml;
	}
	...
	/**
	 *  Convierte una lista de TipoVersionInside del WS de Inside
	 *  a una lista de ObjetoInsideVersion de Inside
	 * @param versiones
	 * @return
	 */
