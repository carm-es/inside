...
public abstract class InsideConverterIndice {
	...
	public static ObjetoExpedienteInsideIndice indiceEniToInside(TipoIndice indiceEni, boolean expedienteCerrado)
		...
		indice.setIndiceContenido(InsideConverterIndice.contenidoEniToInside(indiceEni.getIndiceContenido(), expedienteCerrado));
		return indice;
	}

	private static ObjetoExpedienteInsideIndiceContenido contenidoEniToInside(TipoIndiceContenido indiceContenido,
		...
		for (Object elementoIndizadoEni : indiceContenido.getDocumentoIndizadoOrExpedienteIndizadoOrCarpetaIndizada()) {
			ObjetoExpedienteInsideIndiceContenidoElementoIndizado elementoIndizadoInside = InsideConverterIndice
					.elementoIndizadoEniToInside(elementoIndizadoEni, expedienteCerrado);
	...
	private static ObjetoExpedienteInsideIndiceContenidoElementoIndizado elementoIndizadoEniToInside(Object elementoIndizadoEni,
			boolean expedienteCerrado) throws InsideConverterException {
		...
		if (elementoIndizadoEni instanceof TipoDocumentoIndizado) {
			...
			ObjetoExpedienteInsideIndiceContenidoCarpetaIndizada carpetaIndizada = new ObjetoExpedienteInsideIndiceContenidoCarpetaIndizada();
			List<ObjetoExpedienteInsideIndiceContenidoElementoIndizado> elementosIndizados = new ArrayList<ObjetoExpedienteInsideIndiceContenidoElementoIndizado>();
			...
			ObjetoExpedienteInsideIndiceContenido indiceIndizado = new ObjetoExpedienteInsideIndiceContenido();
			List<ObjetoExpedienteInsideIndiceContenidoElementoIndizado> elementosIndizados = new ArrayList<ObjetoExpedienteInsideIndiceContenidoElementoIndizado>();
			...
			indiceIndizado.setFechaIndiceElectronico(
					InsideConverterXmlGregorianCalendar.calendarToXmlCalendar(indiceIndizadoEni.getFechaIndiceElectronico()));
			indiceIndizado.setIdentificadorExpedienteAsociado(indiceIndizadoEni.getId());
			if (!expedienteCerrado)
				indiceIndizado.setTipoAsociacion(ObjetoExpedienteInsideIndiceContenido.TipoAsociacion.VINCULACION);
			elemento = indiceIndizado;
		} else {
			throw new InsideConverterException("Tipo de elemento no válido " + elementoIndizadoEni.getClass().toString(), false);
		}

		return elemento;
	}

	public static TipoIndice indiceInsideToEni(ObjetoExpedienteInsideIndice indice, String identificadorExpediente)
			throws InsideConverterException {
		TipoIndice indiceEni = new TipoIndice();
		indiceEni.setId("EXP_INDICE_" + identificadorExpediente);
		TipoIndiceContenido indiceContenido = Contenido.indiceContenidoInsideToEni(indice.getIndiceContenido());
	...
	public static ObjetoExpedienteInsideIndice indiceConversionToInside(TipoIndiceConversion indiceConversion)
			throws InsideConverterException {
		ObjetoExpedienteInsideIndice indiceInside = new ObjetoExpedienteInsideIndice();
		indiceInside.setIndiceContenido(InsideConverterIndice.Contenido.contenidoConversionToInside(indiceConversion));
		return indiceInside;
	}
	...
	public static ObjetoExpedienteInsideIndice indiceConversionToInside(TipoIndice indiceConversion)
		...
		indiceInside.setIndiceContenido(
				InsideConverterIndice.Contenido.contenidoConversionToInside(indiceConversion.getIndiceContenido()));
		return indiceInside;
	}

	public static TipoIndiceContenido estructuraCarpetasInsideToEni(ObjetoEstructuraCarpetaInside estructuraCarpeta)
			throws InsideConverterException {
	...
	public static ObjetoExpedienteInsideIndiceContenidoCarpetaIndizada carpetaIndizadaConversionToInside(
		...
		List<ObjetoExpedienteInsideIndiceContenidoElementoIndizado> elementosIndizados = new ArrayList<ObjetoExpedienteInsideIndiceContenidoElementoIndizado>();
		for (Object hijoIndizadoEni : carpetaIndizada.getDocumentoIndizadoOrExpedienteIndizadoOrCarpetaIndizada()) {
			elementosIndizados.add(InsideConverterIndice.Contenido.elementoIndizadoConversionToInside(hijoIndizadoEni));
		}
	...
	static class Contenido {
		...
		public static TipoIndiceContenido indiceContenidoInsideToEni(ObjetoExpedienteInsideIndiceContenido indiceContenido)
				throws InsideConverterException {
			TipoIndiceContenido contenidoIndiceEni = new TipoIndiceContenido();
			try {
				contenidoIndiceEni.setFechaIndiceElectronico(
						InsideConverterXmlGregorianCalendar.calendarToXmlCalendar(indiceContenido.getFechaIndiceElectronico()));
				...
				throw new InsideConverterException("No se puede convertir la fecha de indice electrónico", e, true);
			}
		...
		private static Object elementoIndizadoInsideToEni(ObjetoExpedienteInsideIndiceContenidoElementoIndizado elementoIndizado)
				throws InsideConverterException {
			if (elementoIndizado instanceof ObjetoExpedienteInsideIndiceContenido) {
				...
				ObjetoExpedienteInsideIndiceContenidoCarpetaIndizada carpetaIndizadaInside = (ObjetoExpedienteInsideIndiceContenidoCarpetaIndizada) elementoIndizado;
				...
				if (documentoIndizado.getFechaIncorporacionExpediente() != null) {
					...
					documentoIndizadoEni.setFechaIncorporacionExpediente(
							InsideConverterXmlGregorianCalendar.calendarToXmlCalendar(fechaIncorporacionExpediente));
				}
				...
				documentoIndizadoEni.setOrdenDocumentoExpediente(
						Integer.toString(((ObjetoExpedienteInsideIndiceContenidoDocumentoIndizado) elementoIndizado)
								.getOrdenDocumentoExpediente()));
				return documentoIndizadoEni;
			} else {
				throw new InsideConverterException("No se como convertir un objeto de tipo " + elementoIndizado.getClass()
						+ " a un elemento indizado del Eni", false);
			}
		}

		public static ObjetoExpedienteInsideIndiceContenido contenidoConversionToInside(TipoIndiceConversion indiceConversion)
				throws InsideConverterException {
			ObjetoExpedienteInsideIndiceContenido contenidoInside = new ObjetoExpedienteInsideIndiceContenido();

			if (indiceConversion.getFechaIndiceElectronico() != null) {
				contenidoInside.setFechaIndiceElectronico(indiceConversion.getFechaIndiceElectronico().toGregorianCalendar());
			}

			int orden = 1;
			if (indiceConversion.getDocumentoIndizadoOrExpedienteIndizadoOrCarpetaIndizada() != null) {
				for (Object obj : indiceConversion.getDocumentoIndizadoOrExpedienteIndizadoOrCarpetaIndizada()) {
					ObjetoExpedienteInsideIndiceContenidoElementoIndizado elementoIndizadoInside = elementoIndizadoConversionToInside(
							obj);
					elementoIndizadoInside.setOrden(orden++);
		...
		public static ObjetoExpedienteInsideIndiceContenido contenidoConversionToInside(TipoIndiceContenido indiceConversion)
				throws InsideConverterException {
			ObjetoExpedienteInsideIndiceContenido contenidoInside = new ObjetoExpedienteInsideIndiceContenido();
		...
		private static ObjetoExpedienteInsideIndiceContenidoElementoIndizado elementoIndizadoConversionToInside(
			...
			if (elementoIndizadoConversion instanceof TipoDocumentoIndizadoConversion) {
				TipoDocumentoIndizadoConversion documentoIndizadoConversion = (TipoDocumentoIndizadoConversion) elementoIndizadoConversion;
				ObjetoExpedienteInsideIndiceContenidoDocumentoIndizado documentoIndizado = new ObjetoExpedienteInsideIndiceContenidoDocumentoIndizado();
				...
				documentoIndizado.setIdentificadorDocumento(documentoIndizadoConversion.getIdentificadorDocumento());
				...
				TipoCarpetaIndizadaConversion carpetaIndizadaConversion = (TipoCarpetaIndizadaConversion) elementoIndizadoConversion;
				ObjetoExpedienteInsideIndiceContenidoCarpetaIndizada carpetaIndizada = new ObjetoExpedienteInsideIndiceContenidoCarpetaIndizada();
				List<ObjetoExpedienteInsideIndiceContenidoElementoIndizado> elementosIndizados = new ArrayList<ObjetoExpedienteInsideIndiceContenidoElementoIndizado>();
				...
				carpetaIndizada.setElementosIndizados(elementosIndizados);
				carpetaIndizada.setIdentificadorCarpeta(carpetaIndizadaConversion.getIdentificadorCarpeta());
				elemento = carpetaIndizada;
			} else if (elementoIndizadoConversion instanceof TipoIndiceConversion) {
				TipoIndiceConversion indiceIndizadoConversion = (TipoIndiceConversion) elementoIndizadoConversion;
				ObjetoExpedienteInsideIndiceContenido indiceIndizado = new ObjetoExpedienteInsideIndiceContenido();
				List<ObjetoExpedienteInsideIndiceContenidoElementoIndizado> elementosIndizados = new ArrayList<ObjetoExpedienteInsideIndiceContenidoElementoIndizado>();
				...
				TipoCarpetaIndizada carpetaIndizadaConversion = (TipoCarpetaIndizada) elementoIndizadoConversion;
				ObjetoExpedienteInsideIndiceContenidoCarpetaIndizada carpetaIndizada = new ObjetoExpedienteInsideIndiceContenidoCarpetaIndizada();
				List<ObjetoExpedienteInsideIndiceContenidoElementoIndizado> elementosIndizados = new ArrayList<ObjetoExpedienteInsideIndiceContenidoElementoIndizado>();
				for (Object hijoIndizadoEni : carpetaIndizadaConversion
						.getDocumentoIndizadoOrExpedienteIndizadoOrCarpetaIndizada()) {
				...
				TipoDocumentoIndizado documentoIndizadoConversion = (TipoDocumentoIndizado) elementoIndizadoConversion;
				ObjetoExpedienteInsideIndiceContenidoDocumentoIndizado documentoIndizado = new ObjetoExpedienteInsideIndiceContenidoDocumentoIndizado();
				documentoIndizado.setFechaIncorporacionExpediente(InsideConverterXmlGregorianCalendar
						.calendarToXmlCalendar(documentoIndizadoConversion.getFechaIncorporacionExpediente()));
				documentoIndizado.setFuncionResumen(documentoIndizadoConversion.getFuncionResumen());
				...
				throw new InsideConverterException(
						"Tipo de elemento no válido " + elementoIndizadoConversion.getClass().toString(), false);
			}
