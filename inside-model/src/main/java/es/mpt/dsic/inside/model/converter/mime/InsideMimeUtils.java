...
public class InsideMimeUtils {
	 ...
	 * Si no es de Office lo intenta con MagicMatch.
	 * @param data
	 * @return
	 */
	 ...
	 * @throws  
	 */
	private static String getMimeType(String filename,byte[] data) throws InsideConverterUtilsException{
	 ...
	 * @throws InsideConverterUtilsException
	 */
	private static String getFirstMimeTypeMimeUtil(Collection<?> mimeTypes) throws InsideConverterUtilsException{
		if(mimeTypes.size() >= 1){
	 ...
	 * 
	 * entrada:
	 * <CONTENT Id="CONTENT-81fe6a7d-1b07-4e9b-b4ea-ced5801a3fb9" MimeType="text/xml">
	 * <raiz>
	 * 	contenido
	 * </raiz>
	 * </CONTENT>
	...
	public static String getCONTENTContenidoXml(String datosXML) {
		...
		return datosXML.substring(datosXML.indexOf("MimeType=\"text/xml\">") + "MimeType=\"text/xml\">".length() , datosXML.indexOf("</CONTENT>"));
	}
}
