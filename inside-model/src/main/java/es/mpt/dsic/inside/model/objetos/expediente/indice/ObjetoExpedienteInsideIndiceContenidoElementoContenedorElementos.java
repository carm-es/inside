...
public abstract class ObjetoExpedienteInsideIndiceContenidoElementoContenedorElementos extends ObjetoExpedienteInsideIndiceContenidoElementoIndizado{
	...
	public void setElementosIndizados(
			List<ObjetoExpedienteInsideIndiceContenidoElementoIndizado> elementoIndizado) {
		this.elementosIndizados = elementoIndizado;
	}
	
	@Override
	public String toString () {		
		StringBuffer sb = new StringBuffer ("ObjetoExpedienteInsideIndiceContenidoElementoContenedorElementos=[");
		String coma = ", ";
