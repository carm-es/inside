...
public abstract class MetadataConverter {
	...
	public static TipoMetadatos tipoMetadatosInsideToEeutilClient(es.mpt.dsic.inside.xml.eni.documento.metadatos.TipoMetadatos input) {
		TipoMetadatos retorno = new TipoMetadatos();
		retorno.setEstadoElaboracion(estadoElaboracionInsideToEeutilClient(input.getEstadoElaboracion()));
	...
	public static TipoEstadoElaboracion estadoElaboracionInsideToEeutilClient(es.mpt.dsic.inside.xml.eni.documento.metadatos.TipoEstadoElaboracion input) {
		...
		retorno.setValorEstadoElaboracion(EnumeracionEstadoElaboracion.valueOf(input.getValorEstadoElaboracion().name()));
		return retorno;
	}
	
	public static TipoDocumental tipoDocumentalInsideToEeutilClient(es.mpt.dsic.inside.xml.eni.documento.metadatos.TipoDocumental input) {
