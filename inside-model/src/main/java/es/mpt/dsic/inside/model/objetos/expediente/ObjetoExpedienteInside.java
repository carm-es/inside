...
public class ObjetoExpedienteInside extends ObjetoInside<ObjetoExpedienteInsideMetadatos> implements ObjetoInsideVersionable{
    ...
    public List<ObjectInsideRespuestaEnvioJusticia> getObjectInsideRespuestaEnvioJusticiaLista() {
    	if (this.objectInsideRespuestaEnvioJusticiaLista == null) {
			this.objectInsideRespuestaEnvioJusticiaLista = new ArrayList<ObjectInsideRespuestaEnvioJusticia>();
		}
		return objectInsideRespuestaEnvioJusticiaLista;
	}

	public void setObjectInsideRespuestaEnvioJusticiaLista(List<ObjectInsideRespuestaEnvioJusticia> objectInsideRespuestaEnvioJusticiaLista) {
	...
	public void setVisualizacionIndice(
			ObjetoDocumentoInsideContenido visualizacionIndice) {
