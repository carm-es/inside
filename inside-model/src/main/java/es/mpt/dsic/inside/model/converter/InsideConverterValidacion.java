...
public class InsideConverterValidacion {
	...
	public static List<OpcionValidacionExpediente> tipoOpcionesValidacionExpedienteInsideToListOpcionValidacionExpediente (TipoOpcionesValidacionExpedienteInside opciones) {
	...
	public static  List<OpcionValidacionDocumento> tipoOpcionesValidacionDocumentoInsideToListOpcionValidacionDocumento (TipoOpcionesValidacionDocumentoInside opciones) {
	...
	public static TipoResultadoValidacionDocumentoInside listResultadoValidacionDocumentoToTipoResultadoValidacionDocumentoInside (List<ResultadoValidacionDocumento> resultados) {
		...
		if (resultados != null) {
			for (ResultadoValidacionDocumento resultado : resultados) {
				TipoResultadoValidacionDetalleDocumentoInside detalle = new TipoResultadoValidacionDetalleDocumentoInside ();
				detalle.setResultadoValidacion(resultado.isValido());
				detalle.setDetalleValidacion(resultado.getMensaje());
				detalle.setTipoValidacion(TipoOpcionValidacionDocumento.fromValue(resultado.getTipoValidacion().value()));
	...
	public static TipoResultadoValidacionExpedienteInside listResultadoValidacionExpedienteToTipoResultadoValidacionExpedienteInside (List<ResultadoValidacionExpediente> resultados) {
		...
		if (resultados != null) {
			for (ResultadoValidacionExpediente resultado : resultados) {
				...
				detalle.setResultadoValidacion(resultado.isValido());
				detalle.setDetalleValidacion(resultado.getMensaje());
				detalle.setTipoValidacion(TipoOpcionValidacionExpediente.fromValue(resultado.getTipoValidacion().value()));
				res.getValidacionDetalle().add(detalle);
			}
		}
		return res;
