...
public class ObjetoExpedienteToken {
	...
	public ObjetoExpedienteToken(ObjetoInsideUsuario usuario, String identificador, String csv, String uuid) {
		super();
	...
	public ObjetoExpedienteToken(ObjetoInsideUsuario usuario, String identificador, String csv, String uuid, Date fechaCaducidad,  String dir3, String asunto, String nifs) {
		super();
		this.usuario = usuario;
		this.identificador = identificador;
		this.csv = csv;
	...
	public ObjetoExpedienteToken(ObjetoInsideUsuario usuario, String identificador, String csv, String uuid, Date fechaCaducidad,  String dir3, String asunto, String nifs, String mail) {
		super();
		this.usuario = usuario;
		this.identificador = identificador;
		this.csv = csv;
