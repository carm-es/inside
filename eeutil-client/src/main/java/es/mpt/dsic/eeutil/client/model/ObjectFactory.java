...
public class ObjectFactory {
    ...
    private final static QName _FoliarResponse_QNAME = new QName("http://service.ws.inside.dsic.mpt.es/", "foliarResponse");
    private final static QName _ErrorTest_QNAME = new QName("http://service.ws.inside.dsic.mpt.es/", "ErrorTest");
    private final static QName _Foliar_QNAME = new QName("http://service.ws.inside.dsic.mpt.es/", "foliar");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: es.mpt.dsic.eeutil.client.model
     * 
     */
    ...
    public JAXBElement<FoliarResponse> createFoliarResponse(FoliarResponse value) {
        return new JAXBElement<FoliarResponse>(_FoliarResponse_QNAME, FoliarResponse.class, null, value);
    }
