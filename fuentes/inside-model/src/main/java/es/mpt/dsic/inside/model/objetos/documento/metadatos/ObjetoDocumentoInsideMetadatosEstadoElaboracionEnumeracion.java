...
public enum ObjetoDocumentoInsideMetadatosEstadoElaboracionEnumeracion implements Serializable {
  ...
  /**
   * - EE01 - Original. - EE02 - Copia electrónica auténtica con cambio de formato. - EE03 - Copia
   * electrónica auténtica de documento papel. - EE04 - Copia electrónica parcial auténtica. - EE99
   * - Otros.
   **/
  EE_01("EE01"),
  ...
  public static ObjetoDocumentoInsideMetadatosEstadoElaboracionEnumeracion fromValue(String v) {
    for (ObjetoDocumentoInsideMetadatosEstadoElaboracionEnumeracion c : ObjetoDocumentoInsideMetadatosEstadoElaboracionEnumeracion
        .values()) {
      if (c.value.equals(v)) {
        return c;
      }
