...
public class InsideObjectsUtils {
   ...
   * @return
   */
  public static List<FirmaInside> getFirmasReferencianNodo(String identificadorNodo,
      List<FirmaInside> firmas) {
    ...
    if (firmas != null) {
      for (FirmaInside firma : firmas) {
        if (firma.getContenidoFirma() instanceof ContenidoFirmaCertificadoReferenciaInside) {
          ContenidoFirmaCertificadoReferenciaInside contRef =
              (ContenidoFirmaCertificadoReferenciaInside) firma.getContenidoFirma();
  ...
  /**
   * Devuelve la firma cuyo identificador de nodo coincida con el identificador pasado en el
   * parámetro
   * 
   * @param identificador
   * @param firmas
   * @return
   */
  public static FirmaInside getFirmaInsideByIdentificadorEnDocumento(String identificador,
      List<FirmaInside> firmas) {
  ...
  /**
   * Obtiene el valor de un metadato adicional. Devuelve la cadena vacía si no lo encuentra
   * 
   * @param metadatos
   * @param nombreMetadato
   * @return
   */
  public static String getMetadatoAdicionalNotNull(ObjetoInsideMetadatos metadatos,
  ...
  /**
   * Obtiene el valor de un metadato Adicional. Devuelve null si no lo encuentra.
   */
  public static String getMetadatoAdicional(ObjetoInsideMetadatos metadatos,
      String nombreMetadato) {
    String ret = null;
  ...
  public static Integer getBytesObjetoDocumentoInside(ObjetoDocumentoInside documento) {
    ...
    if (documento.getContenido().getReferencia() != null) {
      ...
      // La referencia comenzará con el carácter "#". Eliminamos este carácter para obtener el
      // identificador.
      String identificadorFirma = documento.getContenido().getReferencia().substring(1);
      FirmaInside firmaInside =
          getFirmaInsideByIdentificadorEnDocumento(identificadorFirma, documento.getFirmas());
  ...
  /**
   * Busca un elemento con un identificador determinado en una lista contenedora de elementos
   * indizados. Si lo encuentra lo devuelve, si no lo encuentra devuelve NULL.
   * 
   * @param identificadorElemento: - identificador del documento en caso de buscar un documento. -
   *        identificador del expediente asociado en caso de buscar un expediente vinculado o
   *        importado - identificador de la carpeta en caso de buscar una carpeta
   ...
   */
  public static <T extends ObjetoExpedienteInsideIndiceContenidoElementoIndizado> ObjetoExpedienteInsideIndiceContenidoElementoIndizado getElementoIndizadoInList(
      String identificadorElemento, Class<T> clase,
    ...
    while (i < listaContenedora.size() && elementoEncontrado == null) {
      ...
      if (elemento instanceof ObjetoExpedienteInsideIndiceContenidoDocumentoIndizado) {
        if (clase == null
            || clase == ObjetoExpedienteInsideIndiceContenidoDocumentoIndizado.class) {
          ...
          if (documentoIndizado.getIdentificadorDocumento()
              .equalsIgnoreCase(identificadorElemento)) {
        ...
        if (clase == null || clase == ObjetoExpedienteInsideIndiceContenido.class) {
          ObjetoExpedienteInsideIndiceContenido contenidoIndizado =
              (ObjetoExpedienteInsideIndiceContenido) elemento;
          if (contenidoIndizado.getIdentificadorExpedienteAsociado()
              .equalsIgnoreCase(identificadorElemento)) {
   ...
   */
  public static void asignarOrdenAElementosIndizados(
