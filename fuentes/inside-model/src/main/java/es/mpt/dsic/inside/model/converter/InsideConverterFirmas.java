...
public abstract class InsideConverterFirmas {
  ...
  public static List<FirmaInside> firmasEniToInside(Firmas firmas) throws InsideConverterException {
    ...
    if (firmas != null) {
      ...
      for (TipoFirmasElectronicas firmaEni : firmas.getFirma()) {
        firmasInside.add(
            InsideConverterFirmas.firmaEniToInside(firmaEni, firmas.getFirma().indexOf(firmaEni)));
      }
    }
  ...
  public static FirmaInside firmaEniToInside(TipoFirmasElectronicas firmaEni)
    ...
    firmaInside.setContenidoFirma(
        Contenido.contenidoFirmaEniToInside(firmaEni.getContenidoFirma(), firmaEni.getTipoFirma()));
    firmaInside.setRef(firmaEni.getRef());
    return firmaInside;
  }

  public static FirmaInside firmaEniToInside(TipoFirmasElectronicas firmaEni, int orden)
      throws InsideConverterException {
    Assert.notNull(firmaEni);
  ...
  public static Firmas firmasInsideToEni(List<FirmaInside> firmas, boolean convertBase64)
      throws InsideConverterException {
    // Según el ENI del documento, si no existen firmas NO deberá incluirse
    // el nodo Firmas.
  ...
  public static Firmas ultimaFirmaInsideToEni(List<FirmaInside> firmas, boolean convertBase64)
      throws InsideConverterException {
    Firmas firmasEni = null;
    if (firmas != null) {
      firmasEni = new Firmas();
  ...
  private static TipoFirmasElectronicas firmaInsideToEni(FirmaInside firmaInside,
      boolean convertBase64) throws InsideConverterException {
    ...
    firma.setContenidoFirma(
        Contenido.contenidoFirmaInsideToEni(firmaInside.getContenidoFirma(), convertBase64));
  ...
  public static class Contenido {
    ...
    public static ContenidoFirma contenidoFirmaInsideToEni(
        ContenidoFirmaInside contenidoFirmaInside, boolean convertBase64)
        throws InsideConverterException {
      TipoFirmasElectronicas.ContenidoFirma contenidoFirmaEni =
          new TipoFirmasElectronicas.ContenidoFirma();

      Assert.notNull(contenidoFirmaInside);

      if (contenidoFirmaInside instanceof ContenidoFirmaCertificadoContenidoBinarioInside) {
        ContenidoFirmaCertificadoContenidoBinarioInside contenidoCertificadoBinario =
            (ContenidoFirmaCertificadoContenidoBinarioInside) contenidoFirmaInside;
        TipoFirmasElectronicas.ContenidoFirma.FirmaConCertificado firmaConCertificadoEni =
            new TipoFirmasElectronicas.ContenidoFirma.FirmaConCertificado();
        if (convertBase64) {
          logger.warn("establecemos la firma base 64:"
              + Base64.encode(contenidoCertificadoBinario.getValorBinario()));
          firmaConCertificadoEni
              .setFirmaBase64(Base64.encode(contenidoCertificadoBinario.getValorBinario()));
        } else {
        ...
        ContenidoFirmaCertificadoDsSignatureInside contenidoCertificadoSignature =
            (ContenidoFirmaCertificadoDsSignatureInside) contenidoFirmaInside;
        TipoFirmasElectronicas.ContenidoFirma.FirmaConCertificado firmaConCertificadoEni =
            new TipoFirmasElectronicas.ContenidoFirma.FirmaConCertificado();
        try {
          firmaConCertificadoEni.setSignature(InsideConverterUtils
              .arrayOfBytesToSignature(contenidoCertificadoSignature.getValorBinario()));
        } catch (JAXBException e) {
          throw new InsideConverterException(
              "Error convirtiendo el contenido del Signature a SignatureType ", e);
        }
        contenidoFirmaEni.setFirmaConCertificado(firmaConCertificadoEni);
      } else if (contenidoFirmaInside instanceof ContenidoFirmaCSVInside) {
        ContenidoFirmaCSVInside contenidoFirmaInsideCSV =
            (ContenidoFirmaCSVInside) contenidoFirmaInside;
        ...
        ContenidoFirmaCertificadoReferenciaInside contenidoFirmaInsideReferencia =
            (ContenidoFirmaCertificadoReferenciaInside) contenidoFirmaInside;
        TipoFirmasElectronicas.ContenidoFirma.FirmaConCertificado firmaConCertificadoEni =
            new TipoFirmasElectronicas.ContenidoFirma.FirmaConCertificado();
        firmaConCertificadoEni
            .setReferenciaFirma(contenidoFirmaInsideReferencia.getReferenciaFirma());
        contenidoFirmaEni.setFirmaConCertificado(firmaConCertificadoEni);
      } else {
        throw new InsideConverterException(
    ...
    public static ContenidoFirmaInside contenidoFirmaEniToInside(
        TipoFirmasElectronicas.ContenidoFirma contenidoFirmaEni, TipoFirma tipoFirma)
        throws InsideConverterException {
      ...
      if (contenidoFirmaEni != null && contenidoFirmaEni.getFirmaConCertificado() != null) {
        if (contenidoFirmaEni.getFirmaConCertificado().getFirmaBase64() != null) {
          ...
          /*
           * try { contenidoFirma.setMime(InsideConverterUtils.getMimeType( bytesFirma); } catch
           * (InsideConverterUtilsException e) { throw new InsideConverterFirmasException(
          ...
          ContenidoFirmaCertificadoDsSignatureInside contenidoFirma =
              new ContenidoFirmaCertificadoDsSignatureInside();
          try {
            contenidoFirma.setValorBinario(InsideConverterUtils.signatureToArrayOfBytes(
                contenidoFirmaEni.getFirmaConCertificado().getSignature()));
            contenidoFirma.setMime("application/octect-stream");
          } catch (JAXBException e) {
            throw new InsideConverterException(
                "Error convirtiendo el nodo ds:Signature a array de bytes", e, true);
          }
          contenidoFirmaInside = contenidoFirma;
          ...
          if (contenidoFirmaEni.getFirmaConCertificado().getReferenciaFirma() instanceof String) {
            contenidoFirma.setReferenciaFirma(
                contenidoFirmaEni.getFirmaConCertificado().getReferenciaFirma().toString());
          } else {
        ...
        contenidoFirma
            .setRegulacionGeneracionCSV(contenidoFirmaEni.getCSV().getRegulacionGeneracionCSV());
        contenidoFirmaInside = contenidoFirma;
      }
