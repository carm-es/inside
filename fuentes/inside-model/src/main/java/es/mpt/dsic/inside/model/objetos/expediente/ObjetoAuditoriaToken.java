...
public class ObjetoAuditoriaToken {
  ...
  public ObjetoAuditoriaToken(ObjetoInsideUsuario usuario, ObjetoExpedienteToken token, byte[] acta,
      byte[] justificante, Date fechaUso, String dir3UsuarioUso, String nombreDir3UsuarioUso,
      Integer idRolUso, String descripcionRolUso) {
    super();
