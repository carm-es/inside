...
public class ComunicacionTokenExpediente implements java.io.Serializable {
  ...
  @Id
  @TableGenerator(name = "GeneradorPk_ComunicacionTokenExpediente", table = "GeneradorClaves",
      pkColumnName = "GenName", valueColumnName = "GenValue",
      pkColumnValue = "GEN_ComunicacionTokenExpediente", allocationSize = 1)
  @GeneratedValue(strategy = GenerationType.TABLE,
      generator = "GeneradorPk_ComunicacionTokenExpediente")
