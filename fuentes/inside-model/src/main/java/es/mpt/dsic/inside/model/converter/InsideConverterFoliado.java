...
public abstract class InsideConverterFoliado {
  ...
  public static TipoContenido contenidoFoliadoInsideToEni(FoliadoInside foliadoInside)
    ...
    try {
      contenidoEni
          .setNombreFormato(InsideConverterUtils.getNombreFormatoByMime(foliadoInside.getMime()));
    } catch (InsideConverterUtilsException e) {
      throw new InsideConverterException(
          "Error obteniendo el nombre del formato desde el mime " + foliadoInside.getMime(), e);
    }
    return contenidoEni;
  }
}
