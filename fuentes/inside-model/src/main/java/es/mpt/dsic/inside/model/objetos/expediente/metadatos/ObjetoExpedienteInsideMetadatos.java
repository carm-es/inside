...
public class ObjetoExpedienteInsideMetadatos extends ObjetoInsideMetadatos {
    ...
    public Object clone () throws CloneNotSupportedException {
    	ObjetoExpedienteInsideMetadatos objetoExpedienteInsideMetadatos = (ObjetoExpedienteInsideMetadatos) super.clone();
    ...
    public String toString () {
		...
		sb.append("Fecha Apertura Exp=" + InsideConverterUtils.calendarToStringISO8601(this.fechaAperturaExpediente) + coma);
