...
public abstract class ContenidoFirmaInside implements Cloneable, Serializable {
  ...
  public Object clone() throws CloneNotSupportedException {
    if (this instanceof ContenidoFirmaCertificadoContenidoBinarioInside) {
      ContenidoFirmaCertificadoContenidoBinarioInside yo =
          (ContenidoFirmaCertificadoContenidoBinarioInside) this;
      ContenidoFirmaCertificadoContenidoBinarioInside ret =
      ...
      ContenidoFirmaCertificadoDsSignatureInside yo =
          (ContenidoFirmaCertificadoDsSignatureInside) this;
      ContenidoFirmaCertificadoDsSignatureInside ret =
      ...
      throw new CloneNotSupportedException(
          "No se como clonar un contenido de Firma " + this.getClass());
    }
