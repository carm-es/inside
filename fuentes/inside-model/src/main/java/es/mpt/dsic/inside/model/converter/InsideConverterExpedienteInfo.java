...
public abstract class InsideConverterExpedienteInfo {
	...
	public static ExpedienteInsideInfo fromExpediente(ObjetoExpedienteInside expediente) throws InsideConverterException {
		ExpedienteInsideInfo expedienteInfo = new ExpedienteInsideInfo();
		expedienteInfo.setEstado(EnumeracionEstados.fromValue(expediente.getMetadatos().getEstado().value()));
		expedienteInfo.setIdentificador(expediente.getMetadatos().getIdentificadorObjetoInside());
		expedienteInfo.setVersionActual(InsideConverterVersion.versionInsideToXml(expediente.getVersion()));
		return expedienteInfo;
	}

	public static ExpedienteInsideInfo fromExpedienteMasInfo(ObjetoExpedienteInside expediente, String info)
