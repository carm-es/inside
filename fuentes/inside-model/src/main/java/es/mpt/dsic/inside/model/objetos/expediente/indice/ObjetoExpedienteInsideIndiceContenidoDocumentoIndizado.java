...
public class ObjetoExpedienteInsideIndiceContenidoDocumentoIndizado
    extends ObjetoExpedienteInsideIndiceContenidoElementoIndizado {
  ...
  protected Calendar fechaIncorporacionExpediente;

  protected int ordenDocumentoExpediente;
  ...
  public String toString() {
    String coma = ", ";
    StringBuffer sb = new StringBuffer("ObjetoExpedienteInsideIndiceContenidoDocumentoIndizado=[");
