...
public abstract class InsideConverterExpediente {
  private static final String EL_XML_INTRODUCIDO_NO_ES_UN_EXPEDIENTE_ENI_VALIDO =
      "El xml introducido no es un Expediente Eni válido ";
  ...
  public static ObjetoExpedienteInside fromMetadatos(TipoMetadatos metadatosEni,
    ...
    expediente.setMetadatos(InsideConverterMetadatos.Expediente
  ...
  /**
   * Crea un ObjetoExpedienteInside a partir de un TipoExpediente(Eni) de entrada
   * 
   * @param expedienteEni
   * @return
  ...
  public static ObjetoExpedienteInside expedienteEniToInside(TipoExpediente expedienteEni)
    ...
    if (expedienteEni.getMetadatosExp().getIdentificador() == null) {
      throw new InsideConverterException(
          "El identificador de los metadatos del expediente no puede estar vacio", true);
    }
    ...
    expediente.setIndice(
        InsideConverterIndice.indiceEniToInside(expedienteEni.getIndice(), expedienteCerrado));

    if (expedienteEni.getVisualizacionIndice() != null) {
      expediente.setVisualizacionIndice(InsideConverterDocumento.Contenido
          .contenidoEniToInside(expedienteEni.getVisualizacionIndice()));
    }
    expediente.setMetadatos(InsideConverterMetadatos.Expediente
        .metadatosEniToMetadatosInside(expedienteEni.getMetadatosExp()));
    return expediente;
  }

  /**
   * Crea un ObjetoExpedienteInside a partir de un TipoExpediente(Eni) de entrada y un listado de
  ...
  public static ObjetoExpedienteInside expedienteEniToInside(TipoExpediente expedienteEni,
    ...
    expediente.getMetadatos().setMetadatosAdicionales(
        InsideConverterMetadatos.metadatosAdicionalesXmlToInside(metadatosAdicionales));
    return expediente;
  }

  public static TipoExpediente expedienteInsideToEni(ObjetoExpedienteInside expediente,
    ...
    // try {
    expedienteEni.setIndice(InsideConverterIndice.indiceInsideToEni(expediente.getIndice(),
        expediente.getIdentificador()));
    expedienteEni.setMetadatosExp(
        InsideConverterMetadatos.Expediente.metadatosInsideToEni(expediente.getMetadatos()));
    /*
    ...
    if (expediente.getVisualizacionIndice() != null) {
      expedienteEni.setVisualizacionIndice(InsideConverterDocumento.Contenido
          .contenidoInsideToEni(expediente.getVisualizacionIndice(), bytesContenido));
    }
    return expedienteEni;
  }

  public static TipoExpedienteInside expedienteInsideToXml(ObjetoExpedienteInside expedienteInside,
      byte[] bytesContenido) throws InsideConverterException {
    ...
    expedienteXml.setMetadatosAdicionales(InsideConverterMetadatos.metadatosAdicionalesInsideToXml(
  ...
  public static ObjetoExpedienteInside expedienteConversionToInside(
      TipoExpedienteConversionInside expedienteConversion) throws InsideConverterException {
    ...
    expedienteInside.setMetadatos(InsideConverterMetadatos.Expediente.metadatosPrimitivoToInside(
        ...
        expedienteConversion.getMetadatosEni().getInteresado(),
        expedienteConversion.getMetadatosEni().getOrgano(),
        expedienteConversion.getMetadatosEni().getVersionNTI(),
        expedienteConversion.getMetadatosEni().getIdentificador()));
    expedienteInside.setIndice(
        InsideConverterIndice.indiceConversionToInside(expedienteConversion.getIndice()));
  ...
  public static ObjetoExpedienteInside expedienteConversionToInside(
      TipoExpediente expedienteConversion) throws InsideConverterException {
    ...
    expedienteInside.setMetadatos(InsideConverterMetadatos.Expediente.metadatosPrimitivoToInside(
        ...
        expedienteConversion.getMetadatosExp().getInteresado(),
        expedienteConversion.getMetadatosExp().getOrgano(),
  ...
  public static TipoExpedienteInsideConMAdicionales expedienteInsideToConMAdicionales(
      ObjetoExpedienteInside expedienteInside, byte[] bytesContenido)
      throws InsideConverterException {
    TipoExpedienteInsideConMAdicionales expedienteConMAdicionales =
        new TipoExpedienteInsideConMAdicionales();
    expedienteConMAdicionales
        .setExpediente(expedienteInsideToEni(expedienteInside, bytesContenido));
    expedienteConMAdicionales
  ...
  public static TipoExpedienteEniFileInside expedienteEniToTipoExpedienteEniFileInside(
      TipoExpediente expedienteEni, boolean cabeceraXml) throws InsideConverterException {
  ...
  public static ObjetoExpedienteInside tipoExpedienteValidacionToInside(
      TipoExpedienteValidacionInside expedienteValidacion) throws InsideConverterException {
    ...
    try {
      ...
      element = (JAXBElement<?>) unmarshaller
          .unmarshal(new ByteArrayInputStream(expedienteValidacion.getContenido()));
      ...
      try {
        ...
        if (nodoEni != null) {
          ...
          String nodoEniString =
              XMLUtils.expedienteAdicionalWsToEni(expedienteValidacion.getContenido());
          element = (JAXBElement<?>) unmarshaller
              .unmarshal(new ByteArrayInputStream(IOUtils.toByteArray(nodoEniString)));
          exp = (TipoExpediente) element.getValue();
        }
        ...
        throw new InsideConverterException(EL_XML_INTRODUCIDO_NO_ES_UN_EXPEDIENTE_ENI_VALIDO, e2,
            true);
      }
    }
  ...
  public static byte[] getFirmaElectronica(ObjetoExpedienteInside expedienteInside)
      throws InsideConverterException {
    byte[] contenido;
    ...
    if (tipoFirma.getContenidoFirma().getFirmaConCertificado().getFirmaBase64() != null) {
      ...
      SignatureType signaturaType =
          tipoFirma.getContenidoFirma().getFirmaConCertificado().getSignature();
      String indice = indiceEni.getIndiceContenido().toString();
      StringBuilder firma = new StringBuilder("<AFIRMA>");
      firma.append(
          "<CONTENT Id=\"EXP_INDICE_CONTENIDO" + expedienteInside.getIdentificador() + "\">");
    }
