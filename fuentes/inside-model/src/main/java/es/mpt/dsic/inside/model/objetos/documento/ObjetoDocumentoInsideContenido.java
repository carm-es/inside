...
public class ObjetoDocumentoInsideContenido implements Cloneable, Serializable {
  ...
  // TODO Si sale el listado de formatos del NTI, lo cambiamos a
  // ObjetoDocumentoInsideContenidoNombreFormato
  ...
  /*
   * public Object getDatosXML() { return datosXML; }
   * 
   * public void setDatosXML(Object value) { this.datosXML = value; }
   * 
   * 
   * public String getReferenciaFichero() { return referenciaFichero; }
   * 
   * public void setReferenciaFichero(String value) { this.referenciaFichero = value; }
   */
  ...
  public Object clone() throws CloneNotSupportedException {
    ObjetoDocumentoInsideContenido objetoDocumentoInsideContenido =
        (ObjetoDocumentoInsideContenido) super.clone();
