...
public class InsideConverterMtom {
  ...
  public static TipoDocumentoAltaInside mtomTipoDocumentoAltaToInside(
      TipoDocumentoAltaInsideMtom mtom) throws InsideConverterException {// throws IOException {
    TipoDocumentoAltaInside retorno = new TipoDocumentoAltaInside();
    if (mtom.getAsociadoaExpediente() != null) {
      retorno.setAsociadoaExpediente(
          mtomTipoDocumentoAsociadoExpedienteToInside(mtom.getAsociadoaExpediente()));
    }
    if (mtom.getContenido() != null) {
      try {
        retorno.setContenido(IOUtils.toByteArray(mtom.getContenido().getInputStream()));
      } catch (IOException e) {
        throw new InsideConverterException("No se puede leer el contenido del DataHandler", e,
            false);
      }
    }
    if (mtom.getCsv() != null) {
  ...
  private static TipoDocumentoAltaInside.Csv mtomTipoDocumentoAltaCsvToInside(
      TipoDocumentoAltaInsideMtom.Csv mtom) {
  ...
  public static TipoDocumentoConversionInside mtomTipoDocumentoConversionToInside(
      TipoDocumentoConversionInsideMtom mtom) throws InsideConverterException {// throws IOException
                                                                               // {
    ...
    if (mtom.getMetadatosEni() != null) {
      retorno
          .setMetadatosEni(mtomTipoDocumentoConversionMetadatosEniToInside(mtom.getMetadatosEni()));
    }
    return retorno;
  }

  public static TipoDocumentoConversionInsideMtom tipoDocumentoConversionToMtom(
      TipoDocumentoConversionInside inside) {// throws
                                             // IOException
                                             // {
  ...
  private static TipoDocumentoConversionInside.MetadatosEni mtomTipoDocumentoConversionMetadatosEniToInside(
    ...
    TipoDocumentoConversionInside.MetadatosEni retorno =
  ...
  private static TipoDocumentoConversionInsideMtom.MetadatosEni tipoDocumentoConversionMetadatosEniToMtom(
    ...
    TipoDocumentoConversionInsideMtom.MetadatosEni retorno =
  ...
  public static TipoDocumento mtomTipoDocumentoToInside(TipoDocumentoMtom mtom)
  ...
  private static TipoContenido mtomTipoContenidoToInside(TipoContenidoMtom mtom)
      throws InsideConverterException {// throws
                                       // IOException
                                       // {
  ...
  public static TipoDocumentoEniFileInsideMtom tipoDocumentoEniFileToMtom(
      TipoDocumentoEniFileInside inside) {
    TipoDocumentoEniFileInsideMtom retorno = new TipoDocumentoEniFileInsideMtom();
    if (inside.getDocumentoEniBytes() != null) {
      retorno.setDocumentoEniBytes(
          new DataHandler(new ByteArrayDataSource(inside.getDocumentoEniBytes())));
    }
    return retorno;
  }

  public static TipoExpedienteEniFileInsideMtom tipoExpedienteEniFileToMtom(
      TipoExpedienteEniFileInside inside) {
    TipoExpedienteEniFileInsideMtom retorno = new TipoExpedienteEniFileInsideMtom();
    if (inside.getExpedienteEniBytes() != null) {
      retorno.setExpedienteEniBytes(
          new DataHandler(new ByteArrayDataSource(inside.getExpedienteEniBytes())));
    }
    return retorno;
  }

  public static TipoExpediente mtomTipoExpedienteToInside(TipoExpedienteMtom mtom)
      throws InsideConverterException {// throws
                                       // IOException
                                       // {
  ...
  public static TipoExpedienteMtom tipoExpedienteToMtom(TipoExpediente inside)
      throws InsideConverterException {// throws
                                       // IOException
                                       // {
  ...
  public static TipoResultadoVisualizacionDocumentoInsideMtom tipoResultadoVisualizacionDocumentoToMtom(
    ...
    TipoResultadoVisualizacionDocumentoInsideMtom retorno =
        new TipoResultadoVisualizacionDocumentoInsideMtom();
    if (inside.getContenido() != null) {
      retorno.setContenido(new DataHandler(new ByteArrayDataSource(inside.getContenido())));
    }
  ...
  public static TipoDocumentoConversionInside tipoDocumentoConversionToInside(
      TipoDocumentoConversionInsideMtom mtom) throws InsideConverterException {
    TipoDocumentoConversionInside retorno = new TipoDocumentoConversionInside();
    if (mtom.getContenido() != null) {
      try {
        retorno.setContenido(IOUtils.toByteArray(mtom.getContenido().getInputStream()));
      } catch (IOException e) {
        throw new InsideConverterException("No se puede extraer el contenido del DataHandler", e,
            false);
      }
    }
    if (mtom.getCsv() != null) {
  ...
  public static TipoDocumentoConversionInside tipoDocumentoConversionToInside(
      TipoDocumentoConversionInsideMtom mtom, byte[] contenido) throws InsideConverterException {
    TipoDocumentoConversionInside retorno = new TipoDocumentoConversionInside();
  ...
  public static TipoDocumentoInsideConMAdicionalesMtom tipoDocumentoConMAdicionalesToMtom(
    ...
    if (inside.getMetadatosAdicionales() != null
        && inside.getMetadatosAdicionales().getMetadatoAdicional() != null) {
  ...
  public static TipoExpedienteInsideConMAdicionalesMtom tipoExpedienteConMAToMtom(
      TipoExpedienteInsideConMAdicionales inside) throws InsideConverterException {
  ...
  public static MetadatoAdicional convertMetadata(MetadatoAdicional data)
      throws InsideConverterException {
    try {
  ...
  public static TipoDocumentoValidacionInside tipoDocumentoValidacionToInside(
      TipoDocumentoValidacionInsideMtom mtom) throws IOException {
  ...
  public static TipoExpedienteValidacionInside tipoExpedienteValidacionToInside(
      TipoExpedienteValidacionInsideMtom mtom) throws IOException {
  ...
  public static TipoDocumentoVisualizacionInside tipoDocumentoVisualizacionToInside(
      TipoDocumentoVisualizacionInsideMtom mtom) throws IOException {
  ...
  private static TipoDocumentoEniBinarioOTipo tipoDocumentoEniBinariooTipoToInside(
      TipoDocumentoEniBinarioOTipoMtom mtom) throws IOException {
    TipoDocumentoEniBinarioOTipo retorno = new TipoDocumentoEniBinarioOTipo();
    if (mtom.getDocumentoEniBinario() != null) {
      retorno.setDocumentoEniBinario(
          IOUtils.toByteArray(mtom.getDocumentoEniBinario().getInputStream()));
    } else {
  ...
  private static TipoOpcionesVisualizacionDocumento.FilasNombreOrganismo filasNombreOrganismoToInside(
    ...
    TipoOpcionesVisualizacionDocumento.FilasNombreOrganismo retorno =
        new TipoOpcionesVisualizacionDocumento.FilasNombreOrganismo();
  ...
  public static DocumentoEniFileInsideMtom documentoEniFileToMtom(
      DocumentoEniFileInside tipoDocumento) {
    ...
    retorno.setDocumentoEniBytes(
        new DataHandler(new ByteArrayDataSource(tipoDocumento.getDocumentoEniBytes())));
    return retorno;
  }

  public static DocumentoEniFileInsideConMAdicionalesMtom documentoEniFileToMtomConAdicionales(
      DocumentoEniFileInsideConMAdicionales documento) {
    DocumentoEniFileInsideConMAdicionalesMtom retorno =
        new DocumentoEniFileInsideConMAdicionalesMtom();
    ...
    retorno.setDocumentoEniBytes(
        new DataHandler(new ByteArrayDataSource(documento.getDocumentoEniBytes())));
    return retorno;
  }

  public static ExpedienteEniFileInsideMtom expedienteEniFileToMtom(
      ExpedienteEniFileInside expediente) throws InsideConverterException {
    ...
    retorno.setExpedienteEniBytes(
        new DataHandler(new ByteArrayDataSource(expediente.getExpedienteEniBytes())));
    return retorno;
  }
  ...
  public static ExpedienteEniFileInsideConMAdicionalesMtom expedienteEniFileToMtomConAdicionales(
    ...
    ExpedienteEniFileInsideConMAdicionalesMtom retorno =
        new ExpedienteEniFileInsideConMAdicionalesMtom();
    retorno.setExpedienteMtom(
        InsideConverterMtom.tipoExpedienteToMtom(expedienteEniFile.getExpediente()));
    retorno.setMetadatosAdicionales(expedienteEniFile.getMetadatosAdicionales());
    retorno.setExpedienteEniBytes(
        new DataHandler(new ByteArrayDataSource(expedienteEniFile.getExpedienteEniBytes())));
    return retorno;
  }
