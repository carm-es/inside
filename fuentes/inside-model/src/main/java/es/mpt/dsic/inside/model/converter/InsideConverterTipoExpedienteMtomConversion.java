...
public abstract class InsideConverterTipoExpedienteMtomConversion {
	...
	public static TipoExpedienteConversionInside convertTipoExpedienteFromWS(TipoExpedienteConversionInsideWSMtom data) throws InsideConverterException {
	...
	public static TipoIndiceConversion convertTipoIndiceFromWS(TipoIndiceConversionWSMtom data) throws InsideConverterException {
		...
		if (data != null) {
			for (Object element : data) {
				...
				if (element instanceof TipoCarpetaIndizadaConversionWSMtom) {
					...
					carpeta.setIdentificadorCarpeta(((TipoCarpetaIndizadaConversionWSMtom) element).getIdentificadorCarpeta());
					carpeta.getDocumentoIndizadoOrExpedienteIndizadoOrCarpetaIndizada().addAll(
							convertIndicefromWS(((TipoCarpetaIndizadaConversionWSMtom) element)
	...
	public static TipoDocumentoIndizadoConversion convertTipoDocumentoFromWS(TipoDocumentoIndizadoConversionWSMtom data) throws InsideConverterException {
			...
			try {
				...
				try {
					...
					if (nodoAdicionales != null) {
						...
						TipoDocumento tDoc = unmarshallRootElement(IOUtils.toByteArray(nodoEniString), TipoDocumento.class);
						retorno.setIdentificadorDocumento(tDoc.getId());
					} else {
