...
public abstract class InsideConverterMetadatos {
	...
	public static class Expediente{
		...
		/**
		 * Convierte los metadatos adicionales desde la entrada del WS 
		 * a un tipo válido para el InsideService
		 * @param metadatosEni
		 * @param metadatosAdicionales
		 * @return
		 */
		public static ObjetoExpedienteInsideMetadatos metadatosXmlToMetadatosInside(
				TipoMetadatos metadatosEni,
		 ...
		 * @return
		 */
		public static ObjetoExpedienteInsideMetadatos metadatosEniToMetadatosInside(TipoMetadatos metadatosExp)
		{
			...
			if(metadatosExp.getEstado() != null && metadatosExp.getEstado().getValue() != null){
				metadatos.setEstado(ObjetoExpedienteInsideMetadatosEnumeracionEstados.fromValue(metadatosExp.getEstado().getValue().value()));
			}
		...
		/**
		 * Convierte todos los metadatos de un expediente al mensaje 
		 * metadatos del WS de Inside
		 * @param metadatos
		 * @return
		 * @throws InsideConverterMetadatosInsideToEniException 
		 * @throws InsideWSInternalErrorException 
		 */
		public static ExpedienteInsideMetadatos metadatosInsideToXml(ObjetoExpedienteInsideMetadatos metadatos) throws InsideConverterException
		{
			Assert.notNull(metadatos);
			ExpedienteInsideMetadatos metadatosXml = new ExpedienteInsideMetadatos(); 
			metadatosXml.setMetadatosAdicionales(metadatosAdicionalesInsideToXml(metadatos.getMetadatosAdicionales()));
		 ...
		 * @throws InsideWSInternalErrorException 
		 */
		public static TipoMetadatos metadatosInsideToEni(ObjetoExpedienteInsideMetadatos metadatosInside) throws InsideConverterException
		{
			...
			try {
				metadatosEni.setFechaAperturaExpediente(InsideConverterXmlGregorianCalendar.calendarToXmlCalendar(metadatosInside.getFechaAperturaExpediente()));
			} catch (InsideConverterCalendarToXmlCalendarException e) {
				throw new InsideConverterException("No se puede convertir la fecha: " + metadatosInside.getFechaAperturaExpediente(), e, true);
			}
		...
		public static ObjetoExpedienteInsideMetadatos metadatosPrimitivoToInside (String clasificacion,
				String estado,
				Object fechaApertura,
				List<String> interesados,
				List<String> organos,
				String versionNTI,
				String identificadorObjetoInside) throws InsideConverterException{
			...
			if (estado != null) {
				metadatosInside.setEstado(ObjetoExpedienteInsideMetadatosEnumeracionEstados.fromValue(estado));
			}
			...
			if (fechaApertura instanceof Calendar) {				
				...
				metadatosInside.setFechaAperturaExpediente(((XMLGregorianCalendar) fechaApertura).toGregorianCalendar());
	...
	public static class Documento{
		...
		public static ObjetoDocumentoInsideMetadatos metadatosXmlToMetadatosInside(
			...
			Assert.notNull(metadatosEni);
			ObjetoDocumentoInsideMetadatos metadatos = metadatosEniToInside(metadatosEni, metadatosAdicionales);
			metadatos.setMetadatosAdicionales(metadatosAdicionalesXmlToInside(metadatosAdicionales));
		...
		/**
		 * Convierte los metadatos de un objeto Eni y los Adicionales del WS de Inside
		 * en un objeto ObjetoDocumentoInsideMetadatos de Inside
		 * @param metadatosEni
		 * @param metadatosAdicionales
		 * @return
		...
		public static ObjetoDocumentoInsideMetadatos metadatosEniToInside(
				es.mpt.dsic.inside.xml.eni.documento.metadatos.TipoMetadatos metadatosEni, TipoMetadatosAdicionales metadatosAdicionales)
			throws InsideConverterException
		{
			...
			if(metadatosEni.getEstadoElaboracion() != null){
				if(metadatosEni.getEstadoElaboracion().getValorEstadoElaboracion() != null){
					estadoElaboracion.setValorEstadoElaboracion(ObjetoDocumentoInsideMetadatosEstadoElaboracionEnumeracion.fromValue(metadatosEni.getEstadoElaboracion().getValorEstadoElaboracion().value()));
				}
				estadoElaboracion.setIdentificadorDocumentoOrigen(metadatosEni.getEstadoElaboracion().getIdentificadorDocumentoOrigen());
			}
			...
			metadatosInside.setMetadatosAdicionales(InsideConverterMetadatos.metadatosAdicionalesXmlToInside(metadatosAdicionales));
			metadatosInside.setOrigenCiudadanoAdministracion(metadatosEni.isOrigenCiudadanoAdministracion());
			if(metadatosEni.getTipoDocumental() != null){
				metadatosInside.setTipoDocumental(ObjetoDocumentoInsideMetadatosTipoDocumental.fromValue(metadatosEni.getTipoDocumental().value()));
			}else{
		...
		public static es.mpt.dsic.inside.xml.eni.documento.metadatos.TipoMetadatos metadatosInsideToEni(ObjetoDocumentoInsideMetadatos metadatosInside)
			throws InsideConverterException
		{
			// TODO Llamar a metadatosPrimitivosToEni
			Assert.notNull(metadatosInside);
			es.mpt.dsic.inside.xml.eni.documento.metadatos.TipoMetadatos metadatosEni = new es.mpt.dsic.inside.xml.eni.documento.metadatos.TipoMetadatos();
			...
			try {
				metadatosEni.setFechaCaptura(InsideConverterXmlGregorianCalendar.calendarToXmlCalendar(metadatosInside.getFechaCaptura()));
			} catch (InsideConverterCalendarToXmlCalendarException e) {
		...
		public static es.mpt.dsic.inside.xml.eni.documento.metadatos.TipoMetadatos metadatosPrimitivoToEni (String identificador,
																											String id,
			...
			metadatosEni.setEstadoElaboracion(estadoElaboracionPrimitivoToEni (estadoElaboracion, identificadorDocumentoOrigen));
			try {
				metadatosEni.setFechaCaptura(InsideConverterXmlGregorianCalendar.calendarToXmlCalendar(fechaCaptura));
			} catch (InsideConverterCalendarToXmlCalendarException e) {
		...
		public static es.mpt.dsic.inside.xml.eni.documento.metadatos.TipoEstadoElaboracion estadoElaboracionPrimitivoToEni (String estadoElaboracion,
																																			 String identificadorDocumentoOrigen) {
			TipoEstadoElaboracion estadoElaboracionEni = new TipoEstadoElaboracion();
			if (estadoElaboracion != null) {
				estadoElaboracionEni.setValorEstadoElaboracion(EnumeracionEstadoElaboracion.fromValue(estadoElaboracion));
			}
			estadoElaboracionEni.setIdentificadorDocumentoOrigen(identificadorDocumentoOrigen);
			return estadoElaboracionEni;
		}
		
		public static ObjetoDocumentoInsideMetadatos metadatosPrimitivoToInside (String estadoElaboracion,
																				 String identificadorDocumentoOrigen,
																				 Object fechaCaptura,
																				 boolean origenCiudadanoAdministracion,
																				 String tipoDocumental,
			...
			if (estadoElaboracion != null) {				
				metadatosInside.setEstadoElaboracion(estadoElaboracionPrimitivoToInside (estadoElaboracion, identificadorDocumentoOrigen));
			}
						
			if (fechaCaptura instanceof Calendar) {				
				metadatosInside.setFechaCaptura(InsideConverterXmlGregorianCalendar.calendarToGregorianCalendar((Calendar) fechaCaptura));
			} else if (fechaCaptura instanceof XMLGregorianCalendar) {
				metadatosInside.setFechaCaptura(((XMLGregorianCalendar) fechaCaptura).toGregorianCalendar());
			...
			if (tipoDocumental != null) {
				ObjetoDocumentoInsideMetadatosTipoDocumental tDocumental =  ObjetoDocumentoInsideMetadatosTipoDocumental.fromValue(tipoDocumental);
		...
		public static TipoDocumentoConversionInside.MetadatosEni metadatosInsideToPrimitivo (ObjetoDocumentoInsideMetadatos metadatosInside) throws InsideConverterException {

		    TipoDocumentoConversionInside.MetadatosEni metadatosEni = new TipoDocumentoConversionInside.MetadatosEni();
							
			// Estado Elaboración
			metadatosEni.setEstadoElaboracion(estadoElaboracionInsideToPrimitivo(metadatosInside.getEstadoElaboracion()));
		...
		public static ObjetoDocumentoInsideMetadatosEstadoElaboracion estadoElaboracionPrimitivoToInside (String estadoElaboracion, String identificadorDocumentoOrigen) {
			ObjetoDocumentoInsideMetadatosEstadoElaboracion eElaboracion =  new ObjetoDocumentoInsideMetadatosEstadoElaboracion ();
			eElaboracion.setValorEstadoElaboracion(ObjetoDocumentoInsideMetadatosEstadoElaboracionEnumeracion.fromValue(estadoElaboracion));
			eElaboracion.setIdentificadorDocumentoOrigen(identificadorDocumentoOrigen);
			return eElaboracion;
		}
		
		public static TipoEstadoElaboracion estadoElaboracionInsideToPrimitivo (ObjetoDocumentoInsideMetadatosEstadoElaboracion objElaboracion) {
			TipoEstadoElaboracion eElaboracion =  new TipoEstadoElaboracion ();
			eElaboracion.setValorEstadoElaboracion(EnumeracionEstadoElaboracion.fromValue(objElaboracion.getValorEstadoElaboracion().value()));
			eElaboracion.setIdentificadorDocumentoOrigen(objElaboracion.getIdentificadorDocumentoOrigen());
			return eElaboracion;
		}
		
		public static DocumentoInsideMetadatos metadatosInsideToXml(ObjetoDocumentoInsideMetadatos metadatos) throws InsideConverterException
		{
			Assert.notNull(metadatos);
		...
		public static ObjetoDocumentoInsideMetadatos metadatosEniToInside(MetadatosEni metadatosAltaEni,TipoMetadatosAdicionales metadatosAdicionales)
			throws InsideConverterException
		{
			es.mpt.dsic.inside.xml.eni.documento.metadatos.TipoMetadatos metadatosEni = new es.mpt.dsic.inside.xml.eni.documento.metadatos.TipoMetadatos();
			metadatosEni.setFechaCaptura(metadatosAltaEni.getFechaCaptura());
			metadatosEni.setOrigenCiudadanoAdministracion(metadatosAltaEni.isOrigenCiudadanoAdministracion());
		...
		public static ObjetoDocumentoInsideMetadatos metadatosConversionToInside (es.mpt.dsic.inside.xml.inside.ws.documento.conversion.TipoDocumentoConversionInside.MetadatosEni metadatosConversion) throws InsideConverterException {
			
			ObjetoDocumentoInsideMetadatos metadatosInside = metadatosPrimitivoToInside(metadatosConversion.getEstadoElaboracion().getValorEstadoElaboracion().value(),
																						...
																						metadatosConversion.getTipoDocumental().value(),
																						metadatosConversion.getVersionNTI(),
																						metadatosConversion.getOrgano(),
																						metadatosConversion.getIdentificador());
	...
	public static List<ObjetoInsideMetadatoAdicional> metadatosAdicionalesXmlToInside(
		...
		List<ObjetoInsideMetadatoAdicional> adicionales = new ArrayList<ObjetoInsideMetadatoAdicional>();
	...
	/**
	 * Convierte un MetadatoAdicional de la entrada del WS a un tipo
	 * válido para el InsideService
...
//		adicional.setValor(objValor);
		...
		//if (metadatoAdicional.getTipo().getNamespaceURI().equalsIgnoreCase("http://www.w3.org/2001/XMLSchema") &&
...
//		}
		...
		String valor = null;
		String VACIO = "";
		//Lo de arriba comentado porque se quita el tipo de forma QName y se pone string y se sustituye por la linea de abajo
	...
	/**
	 * Convierte los metadatos Adicionales a un mensaje
	 * MetadatosAdicionales del WS de Inside
	 * @param metadatosAdicionales
	 * @return
	 */
	...
	public static String tipoMetadatosAdicionalesToString (TipoMetadatosAdicionales metadatosAdicionales) {
		String coma = ", ";
	...
	public static String objetoInsideMetadatoAdicionalToString (ObjetoInsideMetadatoAdicional metadatoAdicional) {
	...
	/**
	 * Convierte un metadatoAdicional del modelo de Inside a un
	 * mensaje MetadatoAdicional del WS de Inside
	 * @param metadatoAdicional
	 * @return
	 */
