...
public class ExpedienteNoInsideRespuestaEnvioJusticia implements java.io.Serializable {
  ...
  public ExpedienteNoInsideRespuestaEnvioJusticia(String id_expediente_envio,
  ...
  @TableGenerator(name = "GeneradorPk_ExpedienteNoInsideRespuestaEnvioJusticia",
      ...
      pkColumnValue = "GEN_ExpedienteNoInsideRespuestaEnvioJusticia", allocationSize = 1)
  @GeneratedValue(strategy = GenerationType.TABLE,
      generator = "GeneradorPk_ExpedienteNoInsideRespuestaEnvioJusticia")
