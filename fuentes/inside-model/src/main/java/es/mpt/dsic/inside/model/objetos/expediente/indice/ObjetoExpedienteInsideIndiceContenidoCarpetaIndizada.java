...
public class ObjetoExpedienteInsideIndiceContenidoCarpetaIndizada extends ObjetoExpedienteInsideIndiceContenidoElementoContenedorElementos{
	...
	public String toString () {
		String coma = ", ";
		StringBuffer sb = new StringBuffer ("ObjetoExpedienteInsideIndiceContenidoCarpetaIndizada=[");
