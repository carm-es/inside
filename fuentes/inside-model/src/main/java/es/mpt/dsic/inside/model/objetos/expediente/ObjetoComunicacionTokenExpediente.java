...
public class ObjetoComunicacionTokenExpediente {
  ...
  /**
   * La fecha del próximo intento lo determina el número de intento en el que se encuentre. En caso
   * de no haber intentos por tratarse de una comunicación no tratada por el job la fecha será la
   * misma que el de la petición. En caso contrario se añaden minutos de modo exponencial 5.
   */
  ...
  public String getEndpointRemitenteCorto() {
    return endpointRemitente != null && endpointRemitente.length() > 40
        ? endpointRemitente.substring(0, 40)
        : endpointRemitente;
  }
