...
public abstract class InsideConverterTipoExpedienteConversion {
	...
	public static TipoExpedienteConversionInside convertTipoExpedienteFromWS(TipoExpedienteConversionInsideWS data) throws InsideConverterException {
		...
		retorno.setOpcionesVisualizacion(convertOpcionesVisualizacionFromWS(data.getOpcionesVisualizacion()));

		return retorno;

	}

	public static TipoIndiceConversion convertTipoIndiceFromWS(TipoIndiceConversionWS data) throws InsideConverterException {
	...
	public static List<Object> convertIndicefromWS(List<Object> data) throws InsideConverterException {
		...
		if (data != null) {
			for (Object element : data) {
				...
				if (element instanceof TipoCarpetaIndizadaConversionWS) {
					...
					carpeta.setIdentificadorCarpeta(((TipoCarpetaIndizadaConversionWS) element).getIdentificadorCarpeta());
					carpeta.getDocumentoIndizadoOrExpedienteIndizadoOrCarpetaIndizada().addAll(
							convertIndicefromWS(((TipoCarpetaIndizadaConversionWS) element)
	...
	public static TipoDocumentoIndizadoConversion convertTipoDocumentoFromWS(TipoDocumentoIndizadoConversionWS data) throws InsideConverterException {
		...
		try {
			...
			element = (JAXBElement<?>) unmarshaller.unmarshal(new ByteArrayInputStream(data.getContenido()));
			...
			try {
				...
				if (nodoEni != null) {
					...
					element = (JAXBElement<?>) unmarshaller.unmarshal(new ByteArrayInputStream(IOUtils.toByteArray(nodoEniString)));
					retorno.setIdentificadorDocumento(((TipoDocumento) element.getValue()).getMetadatos().getIdentificador());
				} else {
	...
	public static TipoExpedienteConversionInside.MetadatosEni convertMetadataEnifromWS(
		...
		TipoExpedienteConversionInside.MetadatosEni retorno = new TipoExpedienteConversionInside.MetadatosEni();
	...
	public static TipoExpedienteConversionInside.MetadatosEni.Estado convertEstadoFromWS(
		...
		TipoExpedienteConversionInside.MetadatosEni.Estado retorno = new TipoExpedienteConversionInside.MetadatosEni.Estado();
		retorno.setValue(data.getValue());
		return retorno;
	}

	public static TipoOpcionesVisualizacionIndice convertOpcionesVisualizacionFromWS(TipoOpcionesVisualizacionIndiceWS data) {
	...
	public static TipoOpcionesVisualizacionIndice.FilasNombreOrganismo convertFilasOrganismoFromWS(
		...
		TipoOpcionesVisualizacionIndice.FilasNombreOrganismo retorno = new TipoOpcionesVisualizacionIndice.FilasNombreOrganismo();
		if (data != null) {
