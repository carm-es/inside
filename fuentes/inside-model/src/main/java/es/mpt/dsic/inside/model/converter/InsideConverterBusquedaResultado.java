...
public class InsideConverterBusquedaResultado {
  ...
  public static ExpedienteResultadoBusqueda respuestaBusquedaExpedienteInsideToXml(
      ResultadoBusquedaInside<ObjetoExpedienteInsideMetadatos> res)
    ...
    for (ItemResultadoBusquedaInside<ObjetoExpedienteInsideMetadatos> resultado : res
        .getResultados()) {
      ...
      // try {
      resXml.setMetadatosExp(
          InsideConverterMetadatos.Expediente.metadatosInsideToEni(resultado.getMetadatos()));
      resXml.setVersionActual(InsideConverterVersion.versionInsideToXml(resultado.getVersion()));
      /*
       * } catch (InsideConverterMetadatosInsideToEniException e) { throw new
       * InsideConverterBusquedaResultadoException("Error convirtiendo metadatos del expediente Inside a Eni"
       * ,e); } catch (InsideConverterVersionInsideException e) { throw new
       * InsideConverterBusquedaResultadoException("Error convirtiendo la versión del expediente de Inside a Xml"
       * ,e); }
       */
  ...
  public static DocumentoResultadoBusqueda respuestaBusquedaDocumentoInsideToXml(
      ResultadoBusquedaInside<ObjetoDocumentoInsideMetadatos> res) throws InsideConverterException {
    DocumentoResultadoBusqueda docRes = new DocumentoResultadoBusqueda();
    docRes.setPaginador(resultadosInsideToPaginador(res));
    for (ItemResultadoBusquedaInside<ObjetoDocumentoInsideMetadatos> resultado : res
        .getResultados()) {
      DocumentoResultadoBusqueda.Resultados resXml = new DocumentoResultadoBusqueda.Resultados();
      resXml.setIdentificador(resultado.getIdentificador());
      // try {
      resXml.setMetadatos(
          InsideConverterMetadatos.Documento.metadatosInsideToEni(resultado.getMetadatos()));
      /*
       * } catch (InsideConverterDocumentoMetatosInsideToEniException e) { throw new
       * InsideConverterBusquedaResultadoException("Error convirtiendo metadatos del documento Inside a Eni"
       * ,e); } catch (InsideConverterVersionInsideException e) { throw new
       * InsideConverterBusquedaResultadoException("Error convirtiendo la versión del documento de Inside a Xml"
       * ,e); }
       */
  ...
  public static UsuarioResultadoBusqueda respuestaBusquedaUsuarioInside(
      ResultadoBusquedaUsuario res) throws InsideConverterException {
