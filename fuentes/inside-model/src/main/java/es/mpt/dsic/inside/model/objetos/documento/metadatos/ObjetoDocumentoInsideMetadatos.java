...
public class ObjetoDocumentoInsideMetadatos extends ObjetoInsideMetadatos {
  ...
  public Object clone() throws CloneNotSupportedException {
    ObjetoDocumentoInsideMetadatos objetoDocumentoInsideMetadatos =
        (ObjetoDocumentoInsideMetadatos) super.clone();
    ...
    if (estadoElaboracion != null) {
      objetoDocumentoInsideMetadatos.estadoElaboracion =
          (ObjetoDocumentoInsideMetadatosEstadoElaboracion) estadoElaboracion.clone();
    }
  ...
  public String toString() {
    ...
    sb.append(
        "fechaCaptura=" + InsideConverterUtils.calendarToStringISO8601(this.fechaCaptura) + coma);
