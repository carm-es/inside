...
public enum ClaveEnumType {
  ...
  VERSION_NTI("VersionNTI"), @XmlEnumValue("Identificador")
  IDENTIFICADOR("Identificador"), @XmlEnumValue("Organo")
  ORGANO("Organo"), @XmlEnumValue("FechaAperturaExpediente")
  FECHA_APERTURA_EXPEDIENTE("FechaAperturaExpediente"), @XmlEnumValue("Clasificacion")
  CLASIFICACION("Clasificacion"), @XmlEnumValue("Estado")
  ESTADO("Estado"), @XmlEnumValue("interesado")
