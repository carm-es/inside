 ...
 * generated in the csvstorage.es.gob.aapp.csvstorage.webservices.documentmtom.v1 package.
 * <p>
...
public class ObjectFactory {
  ...
  private final static QName _ModificarDocumento_QNAME =
      new QName("urn:es:gob:aapp:csvstorage:webservices:documentmtom:v1.0", "modificarDocumento");
  private final static QName _GuardarDocumento_QNAME =
      new QName("urn:es:gob:aapp:csvstorage:webservices:documentmtom:v1.0", "guardarDocumento");
  private final static QName _ModificarDocumentoENI_QNAME = new QName(
      "urn:es:gob:aapp:csvstorage:webservices:documentmtom:v1.0", "modificarDocumentoENI");
  private final static QName _GuardarDocumentoENI_QNAME =
      new QName("urn:es:gob:aapp:csvstorage:webservices:documentmtom:v1.0", "guardarDocumentoENI");
  private final static QName _ObtenerDocumento_QNAME =
      new QName("urn:es:gob:aapp:csvstorage:webservices:documentmtom:v1.0", "obtenerDocumento");
  private final static QName _ConsultarDocumento_QNAME =
      new QName("urn:es:gob:aapp:csvstorage:webservices:documentmtom:v1.0", "consultarDocumento");
  private final static QName _ObtenerDocumentoENI_QNAME =
      new QName("urn:es:gob:aapp:csvstorage:webservices:documentmtom:v1.0", "obtenerDocumentoENI");
  private final static QName _EliminarDocumento_QNAME =
      new QName("urn:es:gob:aapp:csvstorage:webservices:documentmtom:v1.0", "eliminarDocumento");

  /**
   * Create a new ObjectFactory that can be used to create new instances of schema derived classes
   * for package: csvstorage.es.gob.aapp.csvstorage.webservices.documentmtom.v1
   * 
   */
   ...
   * 
   */
  @XmlElementDecl(namespace = "urn:es:gob:aapp:csvstorage:webservices:documentmtom:v1.0",
