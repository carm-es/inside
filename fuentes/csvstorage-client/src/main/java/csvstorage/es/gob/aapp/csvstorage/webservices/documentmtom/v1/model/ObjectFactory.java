 ...
 * generated in the csvstorage.es.gob.aapp.csvstorage.webservices.documentmtom.v1.model package.
 * <p>
...
public class ObjectFactory {
  ...
  private final static QName _ObtenerDocumentoMtomResponse_QNAME = new QName(
      "urn:es:gob:aapp:csvstorage:webservices:document:model:v1.0", "obtenerDocumentoMtomResponse");
   ...
   * for package: csvstorage.es.gob.aapp.csvstorage.webservices.documentmtom.v1.model
   * 
   */
  public ObjectFactory() {}

  /**
   * Create an instance of {@link DocumentoEniMtomResponse }
   * 
   */
  public DocumentoEniMtomResponse createDocumentoEniMtomResponse() {
    return new DocumentoEniMtomResponse();
  }

  /**
   * Create an instance of {@link GuardarDocumentoEniMtomRequest }
   * 
   */
  public GuardarDocumentoEniMtomRequest createGuardarDocumentoEniMtomRequest() {
    return new GuardarDocumentoEniMtomRequest();
  }

  /**
   * Create an instance of {@link ContenidoMtomInfo }
   * 
   */
  public ContenidoMtomInfo createContenidoMtomInfo() {
    return new ContenidoMtomInfo();
  }

  /**
   * Create an instance of {@link DocumentoMtomResponse }
   * 
   */
  public DocumentoMtomResponse createDocumentoMtomResponse() {
    return new DocumentoMtomResponse();
  }

  /**
   * Create an instance of {@link GuardarDocumentoMtomRequest }
   * 
   */
  public GuardarDocumentoMtomRequest createGuardarDocumentoMtomRequest() {
    return new GuardarDocumentoMtomRequest();
  }
  ...
  /**
   * Create an instance of {@link ObtenerDocumentoMtomResponse }
   * 
   */
  public ObtenerDocumentoMtomResponse createObtenerDocumentoMtomResponse() {
    return new ObtenerDocumentoMtomResponse();
  }
  ...
  /**
   * Create an instance of {@link JAXBElement }{@code <}{@link ObtenerDocumentoMtomResponse
   * }{@code >}}
   * 
   */
  @XmlElementDecl(namespace = "urn:es:gob:aapp:csvstorage:webservices:document:model:v1.0",
      name = "obtenerDocumentoMtomResponse")
  public JAXBElement<ObtenerDocumentoMtomResponse> createObtenerDocumentoMtomResponse(
      ObtenerDocumentoMtomResponse value) {
    return new JAXBElement<ObtenerDocumentoMtomResponse>(_ObtenerDocumentoMtomResponse_QNAME,
        ObtenerDocumentoMtomResponse.class, null, value);
  }
