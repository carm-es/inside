...
/**
 * <p>
 * Clase Java para obtenerPlantillasResponse complex type.
 * 
 * <p>
...
@XmlType(name = "obtenerPlantillasResponse", propOrder = {"listaPlantillas"})
public class ObtenerPlantillasResponse {
   ...
   * there is not a <CODE>set</CODE> method for the listaPlantillas property.
   * 
   * <p>
   ...
   * 
   * <p>
   * Objects of the following type(s) are allowed in the list {@link Plantilla }
   * 
   * 
   */
