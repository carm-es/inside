...
@XmlType(name = "TipoFirmasElectronicas",
    namespace = "https://ssweb.seap.minhap.es/Eeutil/XSD/v1.0/firma",
    propOrder = {"tipoFirma", "contenidoFirma"})
public class TipoFirmasElectronicas {

  @XmlElement(name = "TipoFirma", namespace = "https://ssweb.seap.minhap.es/Eeutil/XSD/v1.0/firma",
      required = true)
  @XmlSchemaType(name = "string")
  protected TipoFirma tipoFirma;
  @XmlElement(name = "ContenidoFirma",
      namespace = "https://ssweb.seap.minhap.es/Eeutil/XSD/v1.0/firma", required = true)
  ...
  public static class ContenidoFirma {
    ...
    public static class CSV {
      ...
      @XmlElement(name = "ValorCSV",
          namespace = "https://ssweb.seap.minhap.es/Eeutil/XSD/v1.0/firma", required = true)
      protected String valorCSV;
      @XmlElement(name = "RegulacionGeneracionCSV",
          namespace = "https://ssweb.seap.minhap.es/Eeutil/XSD/v1.0/firma", required = true)
