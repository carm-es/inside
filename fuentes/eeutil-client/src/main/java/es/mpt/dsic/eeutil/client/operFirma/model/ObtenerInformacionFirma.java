 ...
 *         &lt;element name="ContenidoMtom" type="{http://www.w3.org/2001/XMLSchema}base64Binary" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "obtenerInformacionFirma",
    propOrder = {"aplicacionInfo", "firma", "opcionesObtenerInformacionFirma", "contenidoMtom"})
public class ObtenerInformacionFirma {
  ...
  @XmlElement(name = "ContenidoMtom")
  @XmlMimeType("application/octet-stream")
  protected DataHandler contenidoMtom;
   ...
   * 
   */
  public DataHandler getContenidoMtom() {
   ...
   * 
   */
  public void setContenidoMtom(DataHandler value) {
