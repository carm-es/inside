...
/**
 * <p>
 * Clase Java para generarJustificanteFirma complex type.
 * 
 * <p>
...
@XmlType(name = "generarJustificanteFirma",
    propOrder = {"aplicacionInfo", "copiaInfoFirma", "simpleFormat"})
public class GenerarJustificanteFirma {
   ...
   * 
   * @return possible object is {@link CopiaInfoFirma }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link CopiaInfoFirma }
   * 
   */
