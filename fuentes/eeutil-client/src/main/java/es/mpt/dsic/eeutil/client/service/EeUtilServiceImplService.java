...
/**
 * This class was generated by Apache CXF 2.4.2 2012-08-23T12:44:27.256+02:00 Generated source
 * version: 2.4.2
 * 
 */
...
public class EeUtilServiceImplService extends Service {
  ...
  static {
    ...
    try {
      ...
      java.util.logging.Logger.getLogger(EeUtilServiceImplService.class.getName()).log(
          java.util.logging.Level.INFO, "Can not initialize the default wsdl from {0}",
          "http://desappjava.seap.minhap.es/eeutil/ws/EeUtilService?wsdl");
    }
    WSDL_LOCATION = url;
  }
  ...
  /*
   * public EeUtilServiceImplService(WebServiceFeature ... features) { super(WSDL_LOCATION, SERVICE,
   * features); }
   * 
   ...
   * //This constructor requires JAX-WS API 2.2. You will need to endorse the 2.2 //API jar or
   * re-run wsdl2java with "-frontend jaxws21" to generate JAX-WS 2.1 //compliant code instead.
   * public EeUtilServiceImplService(URL wsdlLocation, QName serviceName, WebServiceFeature ...
   * features) { super(wsdlLocation, serviceName, features); }
   */
