 ...
 *         &lt;element name="DatosFirmadosMtom" type="{http://service.ws.inside.dsic.mpt.es/}DatosFirmadosMtom" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "validacionFirma",
    propOrder = {"aplicacionInfo", "firma", "tipoFirma", "datosFirmadosMtom"})
public class ValidacionFirma {
  ...
  @XmlElement(name = "DatosFirmadosMtom")
  protected DatosFirmadosMtom datosFirmadosMtom;
  ...
  /**
   * Obtiene el valor de la propiedad datosFirmadosMtom.
   * 
   * @return possible object is {@link DatosFirmadosMtom }
   * 
   */
  public DatosFirmadosMtom getDatosFirmadosMtom() {
    return datosFirmadosMtom;
  }

  /**
   * Define el valor de la propiedad datosFirmadosMtom.
   * 
   * @param value allowed object is {@link DatosFirmadosMtom }
   * 
   */
  public void setDatosFirmadosMtom(DatosFirmadosMtom value) {
    this.datosFirmadosMtom = value;
  }
