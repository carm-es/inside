...
/**
 * <p>
 * Clase Java para generarCSV complex type.
 * 
 * <p>
...
@XmlType(name = "generarCSV", propOrder = {"aplicacionInfo", "csvInfo"})
public class GenerarCSV {
  ...
  /**
   * Obtiene el valor de la propiedad csvInfo.
   * 
   * @return possible object is {@link CSVInfo }
   * 
   */
  ...
  /**
   * Define el valor de la propiedad csvInfo.
   * 
   * @param value allowed object is {@link CSVInfo }
   * 
   */
