 ...
 * generated in the es.mpt.dsic.eeutil.client.visDocExp.model package.
 * <p>
...
public class ObjectFactory {
  ...
  private final static QName _VisualizarContenidoOriginalResponse_QNAME =
      new QName("http://service.ws.inside.dsic.mpt.es/", "visualizarContenidoOriginalResponse");
  private final static QName _EliminarPlantilla_QNAME =
      new QName("http://service.ws.inside.dsic.mpt.es/", "eliminarPlantilla");
  private final static QName _VisualizarDocumentoConPlantillaResponse_QNAME =
      new QName("http://service.ws.inside.dsic.mpt.es/", "visualizarDocumentoConPlantillaResponse");
  private final static QName _ErrorTest_QNAME =
      new QName("http://service.ws.inside.dsic.mpt.es/", "ErrorTest");
  private final static QName _AsociarPlantillaResponse_QNAME =
      new QName("http://service.ws.inside.dsic.mpt.es/", "asociarPlantillaResponse");
  private final static QName _VisualizarDocumentoConPlantilla_QNAME =
      new QName("http://service.ws.inside.dsic.mpt.es/", "visualizarDocumentoConPlantilla");
  ...
  private final static QName _AsociarPlantilla_QNAME =
      new QName("http://service.ws.inside.dsic.mpt.es/", "asociarPlantilla");
  private final static QName _VisualizarContenidoOriginal_QNAME =
      new QName("http://service.ws.inside.dsic.mpt.es/", "visualizarContenidoOriginal");
  private final static QName _EliminarPlantillaResponse_QNAME =
      new QName("http://service.ws.inside.dsic.mpt.es/", "eliminarPlantillaResponse");
  private final static QName _ObtenerPlantillas_QNAME =
      new QName("http://service.ws.inside.dsic.mpt.es/", "obtenerPlantillas");
  private final static QName _ObtenerPlantillasResponse_QNAME =
      new QName("http://service.ws.inside.dsic.mpt.es/", "obtenerPlantillasResponse");
   ...
   * for package: es.mpt.dsic.eeutil.client.visDocExp.model
   * 
   */
  ...
  /**
   * Create an instance of {@link JAXBElement }{@code <}{@link VisualizarContenidoOriginalResponse
   * }{@code >}}
   * 
   */
  @XmlElementDecl(namespace = "http://service.ws.inside.dsic.mpt.es/",
      name = "visualizarContenidoOriginalResponse")
  public JAXBElement<VisualizarContenidoOriginalResponse> createVisualizarContenidoOriginalResponse(
      VisualizarContenidoOriginalResponse value) {
    return new JAXBElement<VisualizarContenidoOriginalResponse>(
        _VisualizarContenidoOriginalResponse_QNAME, VisualizarContenidoOriginalResponse.class, null,
        value);
  }
  ...
  public JAXBElement<EliminarPlantilla> createEliminarPlantilla(EliminarPlantilla value) {
    return new JAXBElement<EliminarPlantilla>(_EliminarPlantilla_QNAME, EliminarPlantilla.class,
        null, value);
  }

  /**
   * Create an instance of {@link JAXBElement
   * }{@code <}{@link VisualizarDocumentoConPlantillaResponse }{@code >}}
   * 
   */
  @XmlElementDecl(namespace = "http://service.ws.inside.dsic.mpt.es/",
      name = "visualizarDocumentoConPlantillaResponse")
  public JAXBElement<VisualizarDocumentoConPlantillaResponse> createVisualizarDocumentoConPlantillaResponse(
      VisualizarDocumentoConPlantillaResponse value) {
    return new JAXBElement<VisualizarDocumentoConPlantillaResponse>(
        _VisualizarDocumentoConPlantillaResponse_QNAME,
        VisualizarDocumentoConPlantillaResponse.class, null, value);
  }
   ...
   */
  @XmlElementDecl(namespace = "http://service.ws.inside.dsic.mpt.es/",
      name = "asociarPlantillaResponse")
  public JAXBElement<AsociarPlantillaResponse> createAsociarPlantillaResponse(
      AsociarPlantillaResponse value) {
    return new JAXBElement<AsociarPlantillaResponse>(_AsociarPlantillaResponse_QNAME,
        AsociarPlantillaResponse.class, null, value);
  }

  /**
   * Create an instance of {@link JAXBElement }{@code <}{@link VisualizarDocumentoConPlantilla
   * }{@code >}}
   * 
   */
  @XmlElementDecl(namespace = "http://service.ws.inside.dsic.mpt.es/",
      name = "visualizarDocumentoConPlantilla")
  public JAXBElement<VisualizarDocumentoConPlantilla> createVisualizarDocumentoConPlantilla(
      VisualizarDocumentoConPlantilla value) {
    return new JAXBElement<VisualizarDocumentoConPlantilla>(_VisualizarDocumentoConPlantilla_QNAME,
        VisualizarDocumentoConPlantilla.class, null, value);
  }
  ...
  public JAXBElement<AsociarPlantilla> createAsociarPlantilla(AsociarPlantilla value) {
    return new JAXBElement<AsociarPlantilla>(_AsociarPlantilla_QNAME, AsociarPlantilla.class, null,
        value);
  }

  /**
   * Create an instance of {@link JAXBElement }{@code <}{@link VisualizarContenidoOriginal
   * }{@code >}}
   * 
   */
  @XmlElementDecl(namespace = "http://service.ws.inside.dsic.mpt.es/",
      name = "visualizarContenidoOriginal")
  public JAXBElement<VisualizarContenidoOriginal> createVisualizarContenidoOriginal(
      VisualizarContenidoOriginal value) {
    return new JAXBElement<VisualizarContenidoOriginal>(_VisualizarContenidoOriginal_QNAME,
        VisualizarContenidoOriginal.class, null, value);
  }
   ...
   */
  @XmlElementDecl(namespace = "http://service.ws.inside.dsic.mpt.es/",
      name = "eliminarPlantillaResponse")
  public JAXBElement<EliminarPlantillaResponse> createEliminarPlantillaResponse(
      EliminarPlantillaResponse value) {
    return new JAXBElement<EliminarPlantillaResponse>(_EliminarPlantillaResponse_QNAME,
        EliminarPlantillaResponse.class, null, value);
  }
  ...
  public JAXBElement<ObtenerPlantillas> createObtenerPlantillas(ObtenerPlantillas value) {
    return new JAXBElement<ObtenerPlantillas>(_ObtenerPlantillas_QNAME, ObtenerPlantillas.class,
        null, value);
  }
   ...
   */
  @XmlElementDecl(namespace = "http://service.ws.inside.dsic.mpt.es/",
      name = "obtenerPlantillasResponse")
  public JAXBElement<ObtenerPlantillasResponse> createObtenerPlantillasResponse(
      ObtenerPlantillasResponse value) {
    return new JAXBElement<ObtenerPlantillasResponse>(_ObtenerPlantillasResponse_QNAME,
        ObtenerPlantillasResponse.class, null, value);
  }
