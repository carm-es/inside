...
@XmlType(name = "item", propOrder = {"identificador", "nombre", "padre", "hijos",
    "documentoContenido", "propiedadesItem"})
public class Item {
   ...
   * 
   * @return possible object is {@link ListaItem }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link ListaItem }
   * 
   */
