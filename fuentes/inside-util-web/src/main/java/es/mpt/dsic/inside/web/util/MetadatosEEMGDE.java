...
public enum MetadatosEEMGDE {
	...
	METADATO_SEGURIDAD_SENSIBILIDAD_DATOS_CARACTER_PERSONAL("eEMGDE8.4.Seguridad.SensibilidadDatosCaracterPersonal"),

	METADATO_SEGURIDAD_NIVEL_CONFIDENCIALIDAD_INFORMACION("eEMGDE8.6.Seguridad.NivelConfidencialidadInformacion"),

	METADATO_DERECHOS_ACCESO_USO_REUTILIZACION_TIPO_ACCESO("eEMGDE9.1.DerechosAccesoUsoReutilizacion.TipoAcceso"),

	METADATO_DERECHOS_ACCESO_USO_REUTILIZACION_CODIGO_CAUSA_LIMITACION("eEMGDE9.1.1.DerechosAccesoUsoReutilizacion.CodigoCausaLimitacion"),

	METADATO_DERECHOS_ACCESO_USO_REUTILIZACION_CAUSA_LEGAL_LIMITACION("eEMGDE9.1.2.DerechosAccesoUsoReutilizacion.CausaLegalLimitacion"),

	METADATO_DERECHOS_ACCESO_USO_REUTILIZACION_CONDICIONES_ACCESO_REUTILIZACION("eEMGDE9.2.DerechosAccesoUsoReutilizacion.CondicionesAccesoUsoReutilizacion"),

	METADATO_CALIFICACION_VALORACION_TIPO_VALOR("eEMGDE13.1.1.1.Calificacion.Valoracion.TipoValor"),

	METADATO_CALIFICACION_VALORACION_VALOR_PRIMARIO_PLAZO("eEMGDE13.1.1.2.Calificacion.Valoracion.ValorPrimario.Plazo"),

	METADATO_CALIFICACION_VALORACION_VALOR_SECUNDARIO("eEMGDE13.1.2.Calificacion.Valoracion.ValorSecundario"),

	METADATO_CALIFICACION_DICTAMEN_TIPO_DICTAMEN("eEMGDE13.2.1.Calificacion.Dictamen.TipodeDictamen"),

	METADATO_CALIFICACION_DICTAMEN_ACCION_DICTAMINADA("eEMGDE13.2.2.Calificacion.Dictamen.AccionDictaminada"),

	METADATO_CALIFICACION_DICTAMEN_PLAZO_EJECUCION_ACCION_DICTAMINADA("eEMGDE13.2.3.Calificacion.Dictamen.PlazoEjecucionAccionDictaminada"),

	METADATO_CALIFICACION_TRANSFERENCIA_FASE_ARCHIVO("eEMGDE13.3.1.Calificacion.Transferencia.FaseArchivo"),

	METADATO_CALIFICACION_TRANSFERENCIA_PLAZO_TRANSFERENCIA("eEMGDE13.3.2.Calificacion.Transferencia.PlazoTransferencia"),
	...
	METADATO_CARACTERISTICAS_TECNICAS_VERSION_FORMATO("eEMGDE14.3.CaracteristicasTecnicas.VersionFormato"),

	METADATO_CARACTERISTICAS_TECNICAS_RESOLUCION("eEMGDE14.7.CaracteristicasTecnicas.Resolucion"),

	METADATO_CARACTERISTICAS_TECNICAS_TAMANO_TAMANO_LOGICO("eEMGDE14.8.2.CaracteristicasTecnicas.Tamano.TamanoLogico"),

	METADATO_CARACTERISTICAS_TECNICAS_TAMANO_UNIDADES("eEMGDE14.8.4.CaracteristicasTecnicas.Tamano.Unidades"),

	METADATO_CARACTERISTICAS_TECNICAS_NOMBRE_FORMATO("eEMGDE14.2.CaracteristicasTecnicas.NombreFormato"),

	METADATO_CARACTERISTICAS_TECNICAS_EXTENSION_FICHERO("eEMGDE14.2.2.CaracteristicasTecnicas.Formato.ExtensionFichero"),

	METADATO_CARACTERISTICAS_TECNICAS_PROFUNDIDAD_COLOR("eEMGDE14.9.CaracteristicasTecnicas.ProfundidadColor"),
	...
	METADATO_FIRMA_FIRMANTE_NUMERO_IDENTIFICACION_FIRMANTES("eEMGDE17.5.2.Firma.Firmante.NumeroIdentificacionFirmantes"),
	...
	METADATO_TRAZABILIDAD_HISTORIA_CAMBIO_NOMBRE_ELEMENTO("eEMGDE21.6.1.Trazabilidad.HistoriaCambio.NombreElemento"),

	METADATO_TRAZABILIDAD_HISTORIA_CAMBIO_VALOR_ANTERIOR("eEMGDE21.6.2.Trazabilidad.HistoriaCambio.ValorAnterior"),
