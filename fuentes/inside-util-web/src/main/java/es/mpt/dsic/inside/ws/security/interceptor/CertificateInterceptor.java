...
public class CertificateInterceptor extends AbstractPhaseInterceptor<SoapMessage>
      ...
      for (WSHandlerResult wshr : results) {
        for (WSSecurityEngineResult wsser : wshr.getResults()) {
          ...
          Authentication authentication =
              new UsernamePasswordAuthenticationToken(publicKey.getSerialNumber().toString(),
                  publicKey.getSubjectX500Principal().getName());
