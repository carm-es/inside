...
public class ElasticController {
	...
	public ModelAndView busquedaElastic(Locale locale, HttpSession session, HttpServletRequest request) {
		...
		try {
			...
			List<ObjetoElastic> datos = insideService.getObjetosElastic(usuario.getUnidadOrganicaActiva().split(" - ")[0]);
