...
/**
 * Clase de gesti�n de seguridad peticiones a clientes de WS a trav�s de interceptor.
 * 
 */
public class WSSecurityManager {
   ...
   * 
   * @param client Client Devuelve el interceptor de salida para a�adir las cabeceras de WS-Security
   *        correspondiente a la autenticaci�n con usernametoken.
   * @param user Cadena con el usuario.
   * @param passwordType Cadena con el tipo de Password para el interceptor.
   * @param passwordCallback Objeto ClientPasswordCallback
   */
  public static void setupWSSecurity(Client client, String user, String passwordType,
   ...
   * @param passwordType Cadena con el tipo de Password para el interceptor.
   * @param passwordCallback Objeto ClientPasswordCallback
   * @return WSS4JOutInterceptor Devuelve el interceptor de salida para a�adir las cabeceras de
   *         WS-Security correspondiente a la autenticaci�n con usuario/contrase�a.
   */
