...
public class TemporalDataCleanController extends QuartzJobBean {
  ...
  protected void executeInternal(JobExecutionContext context) throws JobExecutionException {
    ...
    try {
      ...
      temporalDataBusinessService =
          (TemporalDataBusinessService) appCtx.getBean("temporalDataBusinessService");
      ...
      logger.error(
          "TemporalDataCleanController-executeInternal error al cargar datos: " + e.getMessage(),
          e);
    }
  }
