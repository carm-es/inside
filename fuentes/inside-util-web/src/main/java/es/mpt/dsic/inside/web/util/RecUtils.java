...
public class RecUtils {
	...
	public JustificanteType doRegistroElectronico(String dsNombre, String blDocumento, String blHash) throws RecFormatException,
			RecException, Exception {
		...
		try {
			...
			documentos[0] = RegistroElectronicoFacade.getDocumentoType(dsNombre, cdValidez, cdTipo, blDocumento, "", // blFirma
