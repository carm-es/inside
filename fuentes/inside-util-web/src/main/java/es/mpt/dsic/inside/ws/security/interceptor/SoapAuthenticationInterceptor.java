...
public class SoapAuthenticationInterceptor extends AbstractPhaseInterceptor<SoapMessage>
  ...
  public void handleMessage(SoapMessage message) throws Fault {
    ...
    if (authentication == null) {
      throw new SoapFault(
          "Credenciales Erroneas. No se encuentra elemento InsideApplicationLogin en la petición",
    ...
    try {
      ...
      throw new SoapFault("Credenciales Erroneas. compruebe id de aplicación y password", ex,
          message.getVersion().getSender());
    }
