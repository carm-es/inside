    ...
    try {
      ...
      for (WSHandlerResult wshr : results) {
        for (WSSecurityEngineResult wsser : wshr.getResults()) {
          ...
          logger.warn(
              "recibida petición ws por certificado:" + publicKey.getSerialNumber().toString());
          ObjetoInsideAplicacion app = insideUsersService
              .getAplicacionBySerialNumber(publicKey.getSerialNumber().toString());
          if (app == null) {
            ...
            Authentication authentication =
                new UsernamePasswordAuthenticationToken(app.getAplicacion(), app.getPasswordHash());
            ...
            try {
              ...
              securityContext.setAuthentication(null);
              throw new SoapFault("Credenciales Erroneas. compruebe id de aplicación y password",
                  ex, message.getVersion().getSender());
            }
          }
        }
      }
      ...
      securityContext.setAuthentication(null);
      throw new SoapFault("Credenciales Erroneas. compruebe certificado", e,
          message.getVersion().getSender());
    }
