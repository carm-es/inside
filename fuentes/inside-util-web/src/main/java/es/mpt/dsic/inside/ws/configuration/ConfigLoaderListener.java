...
/**
 * Listener para cargar la variable de sistema "config.path".
 * Si se ha arrancado la aplicación con esta opción no hace nada.
 * En caso contrario lo toma de un parámetro que se establecerá en el web.xml
 * @author rus
 *
 */
public class ConfigLoaderListener  implements ServletContextListener
{
	...
	private static void setKeyStore(String configPathProperty) {
		System.setProperty("javax.net.ssl.trustStore", configPathProperty + File.separator + TRUSTSTORE_FILE); 
