...
public class CsvServiceImpl implements CsvService {
  ...
  @Override
  public String generarCSV(ObjetoExpedienteInside expediente) throws InSideServiceException {

    try {
      TipoExpedienteInsideConMAdicionales tipoExpedienteMA =
          new TipoExpedienteInsideConMAdicionales();
      tipoExpedienteMA
          .setExpediente(InsideConverterExpediente.expedienteInsideToEni(expediente, null));
      tipoExpedienteMA.setMetadatosAdicionales(InsideConverterMetadatos
          .metadatosAdicionalesInsideToXml(expediente.getMetadatos().getMetadatosAdicionales()));
