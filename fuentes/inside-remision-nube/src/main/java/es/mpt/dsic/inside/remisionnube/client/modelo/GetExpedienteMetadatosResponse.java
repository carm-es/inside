...
/**
 * <p>
 * Clase Java para getExpedienteMetadatosResponse complex type.
 * 
 * <p>
...
@XmlType(name = "getExpedienteMetadatosResponse", propOrder = {"metadatos"})
public class GetExpedienteMetadatosResponse {
   ...
   * 
   * @return possible object is {@link ExpedienteInsideMetadatos }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link ExpedienteInsideMetadatos }
   * 
   */
