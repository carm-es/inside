...
@XmlType(name = "TipoMetadatos",
    namespace = "http://administracionelectronica.gob.es/ENI/XSD/v1.0/expediente-e/metadatos",
    propOrder = {"versionNTI", "identificador", "organo", "fechaAperturaExpediente",
        "clasificacion", "estado", "interesado"})
public class TipoMetadatos2 {
  ...
  protected TipoMetadatos2.Estado estado;
   ...
   * 
   * @return possible object is {@link TipoMetadatos2 .Estado }
   * 
   */
  public TipoMetadatos2.Estado getEstado() {
    return estado;
  }
   ...
   * 
   * @param value allowed object is {@link TipoMetadatos2 .Estado }
   * 
   */
  public void setEstado(TipoMetadatos2.Estado value) {
    this.estado = value;
  }
