...
/**
 * Aporta información sobre el número de resultados obtenidos, el número de resultados totales, si
 * el número de resultados excede a los que se pueden devolver en una sola llamada el resultado se
 * "pagina" devolviendose el número de "páginas" en las que están divididos los resultados y la
 * "página" actual
 * 
 * 
 * <p>
 * Clase Java para InfoResultadosBusquedaInside complex type.
 * 
 * <p>
...
@XmlType(name = "InfoResultadosBusquedaInside",
