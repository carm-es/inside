...
/**
 * <p>
 * Clase Java para accesoDocumentoExpedienteResponse complex type.
 * 
 * <p>
...
@XmlType(name = "accesoDocumentoExpedienteResponse",
    namespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService",
    propOrder = {"respuestaAccesoDocumentoExpedienteType"})
public class AccesoDocumentoExpedienteResponse {
   ...
   * 
   * @return possible object is {@link RespuestaAccesoDocumentoExpedienteType }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link RespuestaAccesoDocumentoExpedienteType }
   * 
   */
  public void setRespuestaAccesoDocumentoExpedienteType(
      RespuestaAccesoDocumentoExpedienteType value) {
