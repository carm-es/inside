...
package es.mpt.dsic.inside.remisionnube.service;
...
public interface PuntoUnicoRemisionNubeService {
	
	public RespuestaConsultaEnvioJusticia consultaEstadoRemisionAJusticia(String codigoEnvioATEA) throws InsideWSException;
	
	public ParametrosEnvioJusticia getParametrosMJU(DatosRemisionJusticiaType datosRemisionJusticiaType, String dir3Juzgado) throws InsideWSException;
