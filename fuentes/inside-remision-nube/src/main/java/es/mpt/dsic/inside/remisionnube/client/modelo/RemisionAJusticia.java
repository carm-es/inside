...
/**
 * <p>
 * Clase Java para remisionAJusticia complex type.
 * 
 * <p>
...
@XmlType(name = "remisionAJusticia", propOrder = {"peticionRemisionAJusticiaType"})
public class RemisionAJusticia {
   ...
   * 
   * @return possible object is {@link PeticionRemisionAJusticiaType }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link PeticionRemisionAJusticiaType }
   * 
   */
