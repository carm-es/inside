...
/**
 * <p>
 * Clase Java para solicitarAccesoExpediente complex type.
 * 
 * <p>
...
@XmlType(name = "solicitarAccesoExpediente",
    namespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService",
    propOrder = {"peticionSolicitarAccesoExpedienteType"})
public class SolicitarAccesoExpediente {
   ...
   * 
   * @return possible object is {@link PeticionSolicitarAccesoExpedienteType }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link PeticionSolicitarAccesoExpedienteType }
   * 
   */
  public void setPeticionSolicitarAccesoExpedienteType(
      PeticionSolicitarAccesoExpedienteType value) {
