...
/**
 * <p>Clase Java para cambiarUbicacionEnExpediente complex type.
 * 
...
@XmlType(name = "cambiarUbicacionEnExpediente", propOrder = {
    "identificadorExpediente",
    "identificadoresElementos",
    "rutaOrigen",
    "rutaDestino"
})
public class CambiarUbicacionEnExpediente {
     ...
     * This is why there is not a <CODE>set</CODE> method for the identificadoresElementos property.
     * 
     * <p>
