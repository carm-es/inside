...
@XmlType(name = "convertirDocumentoAEni", propOrder = {"documento", "contenido"})
public class ConvertirDocumentoAEni {
   ...
   * 
   * @return possible object is {@link TipoDocumentoConversionInside }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link TipoDocumentoConversionInside }
   * 
   */
