...
/**
 * <p>
 * Clase Java para informarAccesoExpediente complex type.
 * 
 * <p>
...
@XmlType(name = "informarAccesoExpediente",
    namespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService",
    propOrder = {"peticionInformarAccesoExpedienteType"})
public class InformarAccesoExpediente {
   ...
   * 
   * @return possible object is {@link PeticionInformarAccesoExpedienteType }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link PeticionInformarAccesoExpedienteType }
   * 
   */
