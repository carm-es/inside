...
/**
 * <p>Clase Java para comunicacionTokenExpediente complex type.
 * 
...
@XmlType(name = "comunicacionTokenExpediente", namespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService", propOrder = {
    "peticionComunicacionTokenExpedienteType"
})
public class ComunicacionTokenExpediente {
     ...
     * @return
     *     possible object is
     *     {@link PeticionComunicacionTokenExpedienteType }
     *     
     */
     ...
     *     
     */
    public void setPeticionComunicacionTokenExpedienteType(PeticionComunicacionTokenExpedienteType value) {
