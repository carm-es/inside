...
/**
 * <p>
 * Clase Java para comunicacionTokenExpedienteResponse complex type.
 * 
 * <p>
...
@XmlType(name = "comunicacionTokenExpedienteResponse",
    namespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService",
    propOrder = {"respuestaComunicacionTokenExpedienteType"})
public class ComunicacionTokenExpedienteResponse {
   ...
   * 
   * @return possible object is {@link RespuestaComunicacionTokenExpedienteType }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link RespuestaComunicacionTokenExpedienteType }
   * 
   */
  public void setRespuestaComunicacionTokenExpedienteType(
      RespuestaComunicacionTokenExpedienteType value) {
