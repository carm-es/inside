 ...
 * 
 * <p>Clase Java para PeticionSolicitarAccesoExpedienteType complex type.
 * 
...
@XmlType(name = "PeticionSolicitarAccesoExpedienteType", namespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/remisionNube", propOrder = {
    "peticion",
    "asunto",
    "adjunto",
    "idExpedPedido",
