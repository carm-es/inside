...
/**
 * <p>
 * Clase Java para accesoDocumentoExpediente complex type.
 * 
 * <p>
...
@XmlType(name = "accesoDocumentoExpediente",
    namespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService",
    propOrder = {"peticionAccesoDocumentoExpedienteType"})
public class AccesoDocumentoExpediente {
   ...
   * 
   * @return possible object is {@link PeticionAccesoDocumentoExpedienteType }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link PeticionAccesoDocumentoExpedienteType }
   * 
   */
  public void setPeticionAccesoDocumentoExpedienteType(
      PeticionAccesoDocumentoExpedienteType value) {
