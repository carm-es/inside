...
public class InsideServiceStoreHibernateConverterExpedienteIndiceContenido {
  ...
  public static ExpedienteInsideIndice toEntity(
      ObjetoExpedienteInsideIndiceContenido indiceContenido, Session session)
  ...
  public static ObjetoExpedienteInsideIndiceContenido toInside(ExpedienteInsideIndice entity)
    ...
    List<ObjetoExpedienteInsideIndiceContenidoElementoIndizado> elemIndizados =
        ElementoIndizado.elementosIndizadosToInside(entity);

    List<ObjetoExpedienteInsideIndiceContenidoDocumentoIndizado> docsIndizados =
        ElementoIndizado.GetDocsExpedinte(elemIndizados, null);
    Collections.sort(docsIndizados,
        new Comparator<ObjetoExpedienteInsideIndiceContenidoDocumentoIndizado>() {
          public int compare(ObjetoExpedienteInsideIndiceContenidoDocumentoIndizado one,
            ...
            if (one.getFechaIncorporacionExpediente() != null
                && two.getFechaIncorporacionExpediente() != null
                && one.getFechaIncorporacionExpediente()
                    .before(two.getFechaIncorporacionExpediente())) {
              return 0;
            } else {
              return 1;
            }
  ...
  public static class ElementoIndizado {
    ...
    public static List<ObjetoExpedienteInsideIndiceContenidoElementoIndizado> elementosIndizadosToInside(
      ...
      if (carpetaOExpedienteIndizadoEntity instanceof ExpedienteInsideIndice) {
        ExpedienteInsideIndice expedienteIndizadoEntity =
            (ExpedienteInsideIndice) carpetaOExpedienteIndizadoEntity;
        ...
        if (expedienteIndizadoEntity.getExpedienteInsideIndiceDocumentoIndizados() != null) {
          for (ExpedienteInsideIndiceDocumentoIndizado documentoIndizado : expedienteIndizadoEntity
            ...
            ObjetoExpedienteInsideIndiceContenidoDocumentoIndizado documentoInside =
                ElementoIndizado.documentoToInside(documentoIndizado);
        ...
        if (expedienteIndizadoEntity.getExpedienteInsideIndiceCarpetaIndizadas() != null) {
          for (ExpedienteInsideIndiceCarpetaIndizada carpetaIndizada : expedienteIndizadoEntity
            ...
            ObjetoExpedienteInsideIndiceContenidoCarpetaIndizada carpetaInside =
                ElementoIndizado.carpetaToInside(carpetaIndizada);
            elementosIndizados.add(carpetaInside);
          }
        }

        if (expedienteIndizadoEntity.getExpedienteInsideIndices() != null) {
          for (ExpedienteInsideIndice expedienteIndizado : expedienteIndizadoEntity
              .getExpedienteInsideIndices()) {
            ObjetoExpedienteInsideIndiceContenido expedienteIndizadoInside =
                ElementoIndizado.expedienteToInside(expedienteIndizado);
        ...
        ExpedienteInsideIndiceCarpetaIndizada carpetaEntity =
            (ExpedienteInsideIndiceCarpetaIndizada) carpetaOExpedienteIndizadoEntity;
        ...
        if (carpetaEntity.getExpedienteInsideIndices() != null) {
          for (ExpedienteInsideIndice expedienteIndizado : carpetaEntity
              .getExpedienteInsideIndices()) {
            ObjetoExpedienteInsideIndiceContenido expedienteIndizadoInside =
                ElementoIndizado.expedienteToInside(expedienteIndizado);
            elementosIndizados.add(expedienteIndizadoInside);
    ...
    public static ObjetoExpedienteInsideIndiceContenidoCarpetaIndizada carpetaToInside(
      ...
      carpetaInside
          .setElementosIndizados(ElementoIndizado.elementosIndizadosToInside(carpetaEntity));
      carpetaInside.setOrden(carpetaEntity.getOrden());

      return carpetaInside;
    }

    public static ObjetoExpedienteInsideIndiceContenido expedienteToInside(
        ExpedienteInsideIndice expedienteEntity) throws InsideServiceStoreException {
      ObjetoExpedienteInsideIndiceContenido expedienteIndizado =
          new ObjetoExpedienteInsideIndiceContenido();
      ...
      if (expedienteEntity.getExpedienteInside() != null) {
        ...
        elementosIndizados.addAll(ElementoIndizado.elementosIndizadosToInside(
            expedienteEntity.getExpedienteInside().getExpedienteInsideIndice()));
      ...
      expedienteIndizado
          .setIdentificadorExpedienteAsociado(expedienteEntity.getIdentificadorExpediente());
    ...
    public static ObjetoExpedienteInsideIndiceContenidoDocumentoIndizado documentoToInside(
      ...
      ObjetoExpedienteInsideIndiceContenidoDocumentoIndizado documentoIndizadoInside =
      ...
      documentoIndizadoInside
          .setIdentificadorDocumento(documentoEntity.getIdentificadorDocumento());
      documentoIndizadoInside
          .setOrdenDocumentoExpediente(documentoEntity.getOrdenDocumentoExpediente() > -1
              ? documentoEntity.getOrdenDocumentoExpediente()
              : documentoEntity.getOrden());
    ...
    public static void toEntity(
        ObjetoExpedienteInsideIndiceContenidoElementoIndizado elementoIndizado, Object parent,
      ...
      if (elementoIndizado instanceof ObjetoExpedienteInsideIndiceContenidoDocumentoIndizado) {
        ...
        ExpedienteInsideIndiceDocumentoIndizado documentoEntity =
            new ExpedienteInsideIndiceDocumentoIndizado();
        if (documentoIndizado.getFechaIncorporacionExpediente() != null) {
          documentoEntity.setFechaIncorporacionExpediente(
              documentoIndizado.getFechaIncorporacionExpediente().getTime());
        }
        documentoEntity
        ...
        if (parent instanceof ExpedienteInsideIndice) {
          ...
          ((ExpedienteInsideIndice) parent).getExpedienteInsideIndiceDocumentoIndizados()
              .add(documentoEntity);
        } else if (parent instanceof ExpedienteInsideIndiceCarpetaIndizada) {
          documentoEntity.setExpedienteInsideIndiceCarpetaIndizada(
              (ExpedienteInsideIndiceCarpetaIndizada) parent);
          ((ExpedienteInsideIndiceCarpetaIndizada) parent)
              .getExpedienteInsideIndiceDocumentoIndizados().add(documentoEntity);
        } else {
          throw new InsideServiceStoreException(
              "Tipo de Padre no soportado: " + parent.getClass().getName());
        }
        ...
        ExpedienteInsideIndiceCarpetaIndizada carpetaEntity =
            new ExpedienteInsideIndiceCarpetaIndizada();
        ...
        if (parent instanceof ExpedienteInsideIndice) {
          ...
          ((ExpedienteInsideIndice) parent).getExpedienteInsideIndiceCarpetaIndizadas()
              .add(carpetaEntity);
        } else if (parent instanceof ExpedienteInsideIndiceCarpetaIndizada) {
          carpetaEntity.setExpedienteInsideIndiceCarpetaIndizada(
              (ExpedienteInsideIndiceCarpetaIndizada) parent);
          ((ExpedienteInsideIndiceCarpetaIndizada) parent)
              .getExpedienteInsideIndiceCarpetaIndizadas().add(carpetaEntity);
        } else {
          throw new InsideServiceStoreException(
              "Tipo de Padre no soportado: " + parent.getClass().getName());
        }
        ...
        if (parent instanceof ExpedienteInsideIndice) {
          ...
          expIndizadoEntity.setExpedienteInsideIndiceCarpetaIndizada(
              (ExpedienteInsideIndiceCarpetaIndizada) parent);
          ((ExpedienteInsideIndiceCarpetaIndizada) parent).getExpedienteInsideIndices()
              .add(expIndizadoEntity);
        } else {
          throw new InsideServiceStoreException(
              "Tipo de Padre no soportado: " + parent.getClass().getName());
        }
        ...
        if (StringUtils.isNotBlank(expedienteIndizado.getIdentificadorExpedienteAsociado())) {
          expIndizadoEntity
              .setIdentificadorExpediente(expedienteIndizado.getIdentificadorExpedienteAsociado());
          if (expedienteIndizado
            ...
            criteria.add(Restrictions.eq("identificador",
                expedienteIndizado.getIdentificadorExpedienteAsociado()));
            ...
            if (expedienteAsociado != null && expedienteAsociado instanceof ExpedienteInside) {
              ...
              throw new InsideServiceStoreException(
                  "No se puede asociar el expediente con identificador "
                      + expedienteIndizado.getIdentificadorExpedienteAsociado()
                      + " porque no existe en Inside");
            }
          } else {
            expIndizadoEntity.setFechaIndiceElectronico(
                expedienteIndizado.getFechaIndiceElectronico().getTime());
          }
    ...
    public static List<ObjetoExpedienteInsideIndiceContenidoDocumentoIndizado> GetDocsExpedinte(
      ...
      for (ObjetoExpedienteInsideIndiceContenidoElementoIndizado elemento : objetos) {
        ...
        if (elemento instanceof ObjetoExpedienteInsideIndiceContenidoCarpetaIndizada) {
          GetDocsExpedinte(((ObjetoExpedienteInsideIndiceContenidoCarpetaIndizada) elemento)
              .getElementosIndizados(), docsIndizados);
        }
