...
/**
 * Error de validación en un objeto de Inside
 * Si el error está producido por la validación de alguna o varias
 * de sus propiedades, estas estarán almacenadas en la propiedad
 * validationErrors de esta excepción
 * 
...
public class InsideServiceObjectValidationException extends InSideServiceValidationException {
	...
	public InsideServiceObjectValidationException(ObjetoInside<?> objeto,String mensaje, Throwable e) {
	...
	public InsideServiceObjectValidationException(ObjetoInside<?> objeto,List<InSideServiceMetadatoValidationException> validationErrors) {
	...
	private static String generateMessage(ObjetoInside<?> objeto,List<InSideServiceMetadatoValidationException> validationErrors){
