...
public class InsideStoreObjectPermisosException extends InSideServiceRequestErrorException {
  ...
  protected static String generateMessage(String nombreAplicacion, String identificador,
      String message) {
    return "nombreAplicacion:" + nombreAplicacion + " identificador: " + identificador + " "
        + message;
  }
