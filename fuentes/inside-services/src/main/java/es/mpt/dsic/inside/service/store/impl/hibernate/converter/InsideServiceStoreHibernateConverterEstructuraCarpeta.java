...
public class InsideServiceStoreHibernateConverterEstructuraCarpeta {
  ...
  public static EstructuraCarpetaInside toEntity(
    ...
    ExpedienteInsideIndiceCarpetaIndizada carpetaDefault =
        new ExpedienteInsideIndiceCarpetaIndizada(
            objetoEstructuraCarpetaInside.getIdentificadorEstructura(), 0,
  ...
  public static ObjetoEstructuraCarpetaInside toInside(EstructuraCarpetaInside entity)
      throws InsideServiceStoreException {
    ...
    List<ObjetoExpedienteInsideIndiceContenidoElementoIndizado> elemIndizados =
        carpetaIndizadaToInside(entity.getExpedienteInsideIndiceCarpetaIndizada());
  ...
  public static void carpetaIndizadaToEntity(
      ObjetoExpedienteInsideIndiceContenidoElementoIndizado objElementoIndizado,
    ...
    ObjetoExpedienteInsideIndiceContenidoCarpetaIndizada objCarpetaIndizada =
        (ObjetoExpedienteInsideIndiceContenidoCarpetaIndizada) objElementoIndizado;
    ...
    for (ObjetoExpedienteInsideIndiceContenidoElementoIndizado hijoIndizado : objCarpetaIndizada
        .getElementosIndizados()) {
  ...
  public static List<ObjetoExpedienteInsideIndiceContenidoElementoIndizado> carpetaIndizadaToInside(
    ...
    if (carpetaEntity.getExpedienteInsideIndiceCarpetaIndizadas() != null) {
      for (ExpedienteInsideIndiceCarpetaIndizada carpetaIndizada : carpetaEntity
        ...
        ObjetoExpedienteInsideIndiceContenidoElementoIndizado carpetaInside =
