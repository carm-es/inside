...
public interface InSideService {
  ...
  public ObjetoExpedienteInside importarExpediente(ObjetoExpedienteInside expedienteNuevo,
  ...
  public ObjetoExpedienteInside vincularExpediente(ObjetoExpedienteInside expedienteNuevo,
      String identificadorVinculado, String ruta, boolean signatureServer, String usuario,
      boolean online) throws InSideServiceException;

  public ObjetoExpedienteInside createOpenViewExpedient(String identifier, String identifierView,
      String usuario, boolean online) throws InSideServiceException;

  public ObjetoExpedienteInside createOpenViewExpedient(String identifier, String identifierView,
      boolean signatureServer, String usuario, boolean online) throws InSideServiceException;

  public ObjetoExpedienteInside createClosedViewExpedient(String identifier, String identifierView,
      String usuario, boolean online) throws InSideServiceException;
  ...
  ObjetoDocumentoInside modificaDocumento(ObjetoDocumentoInside documento,
      String identificadorExpediente, String ruta, String usuario, boolean online)
      throws InSideServiceException;
  ...
  public void establecerFirmaExpedienteANodoFirmaBase64(ObjetoExpedienteInside expediente,
      String idFirma, FirmaInsideTipoFirmaEnum tipoFirma, byte[] firma, String ref);
   ...
   * 
   * @param obj Un objeto de tipo documento/expediente
   * @param usuario El usuario gestionando ya sea Online o Web Service
   * @return true si el usuario tiene permiso sobre el objeto
   * @throws InSideServiceException
   */
  boolean permisoObjetoUnidad(ObjetoInside<?> obj, String identificadorUsuario, boolean online)
      throws InSideServiceException;
   ...
   * @param soloUnidadActiva solo queremos los expedientes asociados a su unidad activa
   * @return Lista de expediente
   * @throws InSideServiceException
   */
  List<ObjetoInsideExpedienteUnidad> getExpedientesUnidad(ObjetoInsideUsuario usuario,
   ...
   * @throws InSideServiceException
   */
  List<ObjetoInsideExpedienteUnidad> getExpedientesUnidadAutocompleter(ObjetoInsideUsuario usuario,
      boolean soloUnidadActiva) throws InSideServiceException;
  ...
  /**
   * Asociamos una unidad orgánica (dir3) a una aplicacion (Usuario Web Service)
   * 
   * @param idUnidad Código Unidad Orgánica
   * @param idAplicacion Nombre de la aplicación
   * @return Mensaje informando del resultado de la operación
   * @throws InSideServiceException
   */
  ObjetoInsideUnidad asociarUnidadAplicacion(String idUnidad, String numeroProcedimiento,
      String idAplicacion) throws InSideServiceException;

  /**
   * Eliminamos una unidad orgánica (dir3) y su procedimiento con una aplicacion (Usuario Web
   * Service)
   * 
   * @param idUnidad Código Unidad Orgánica
   * @param idAplicacion Nombre de la aplicación
   ...
   * @throws InSideServiceException
   */
  void eliminarUnidadAplicacion(String idUnidad, String numeroProcedimiento, String idAplicacion)
      throws InSideServiceException;
   ...
   * 
   * @param idUnidad Código Unidad Orgánica
   * @param idUsuario Nif del usuario
   * @return Mensaje informando del resultado de la operación
   * @throws InSideServiceException
   */
  ObjetoInsideUnidad asociarUnidadUsuario(String idUnidad, String numeroProcedimiento,
      String idUsuario) throws InSideServiceException;

  /**
   * Eliminamos una unidad orgánica (dir3) y su procedimiento a un usuario (Usuario Online)
   * 
   * @param idUnidad Código Unidad Orgánica
   * @param idUsuario Nif del usuario
   * @return Mensaje informando del resultado de la operación
   * @throws InSideServiceException
   */
  void eliminarUnidadUsuario(String idUnidad, String numeroProcedimiento, String idUsuario)
      throws InSideServiceException;

  /**
   * Obtenemos las unidades orgánica de una aplicación (Usuario Web Service), todas a true nos
   * recoge las activas e inactivas, todas a false solo la activa
   * 
   * @param idAplicacion Nombre de la aplicación
  ...
  /**
   * Obtenemos las unidades orgánicas de un usuario (Usuario Online), todas a true nos recoge las
   * activas e inactivas, todas a false solo la activa
   * 
   * @param idUsuario Nif del usuario
   * @return Lista de Unidades Orgánicas
   * @throws InSideServiceException
   ...
   * @throws InSideServiceException
   */
  boolean checkAssociatedViewsExpedient(String identificadorExpediente)
      throws InSideServiceException;
