...
public class InsideServiceStoreHibernateConverterAuditoriaAccesoDocumento {
  ...
  public static AuditoriaAccesoDocumento toEntity(
  ...
  public static ObjetoAuditoriaAccesoDocumento toInside(AuditoriaAccesoDocumento entity)
      throws InsideServiceStoreException {

    ObjetoAuditoriaAccesoDocumento objetoAuditoriaAccesoDocumento =
        new ObjetoAuditoriaAccesoDocumento();
