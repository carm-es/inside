...
//	@Autowired
	...
	public ObjetoExpedienteInside getExpediente(String identificador, Integer version, boolean visualizacionIndice)
		...
		ObjetoExpedienteInside expediente = getObjetoInside(ObjetoExpedienteInside.class, identificador, version);
	...
	public ObjetoExpedienteInsideMetadatos getMetadatosExpediente(String identificador) throws InSideServiceException {
		...
		ObjetoExpedienteInsideMetadatos metadatos = getObjetoInsideMetadatos(ObjetoExpedienteInside.class, identificador, null);
	...
	public ObjetoExpedienteInsideMetadatos getMetadatosExpediente(String identificador, Integer version)
		...
		ObjetoExpedienteInsideMetadatos metadatos = getObjetoInsideMetadatos(ObjetoExpedienteInside.class, identificador,
				version);
		logger.debug("metadatos recuperados: " + metadatos.toString());
		logger.debug("Fin operacion getMetadatosExpediente");
		return metadatos;
	...
	@Override
	public ObjetoExpedienteInside importarExpediente(ObjetoExpedienteInside expedienteNew, String identificadorImportado,
			String ruta, boolean signatureServer, String usuario, boolean online) throws InSideServiceException {
		ObjetoExpedienteInside expediente = importExpedient(expedienteNew, identificadorImportado, ruta);
	...
	public ObjetoExpedienteInside importExpedient(ObjetoExpedienteInside expediente, String identificadorImportado, String ruta)
			throws InSideServiceException {
		ObjetoExpedienteInside expedienteImportado = getExpediente(identificadorImportado, false);
		ObjetoExpedienteInsideIndiceContenidoElementoContenedorElementos destino = getCarpetaOExpedienteDeRuta(expediente, ruta);
		ObjetoExpedienteInsideIndiceContenido indiceImportado = new ObjetoExpedienteInsideIndiceContenido();

		indiceImportado.setIdentificadorExpedienteAsociado(identificadorImportado);
		indiceImportado.setTipoAsociacion(ObjetoExpedienteInsideIndiceContenido.TipoAsociacion.IMPORTACION);
		indiceImportado.setOrden(destino.getElementosIndizados().size() + 1);
		indiceImportado
				.setFechaIndiceElectronico(expedienteImportado.getIndice().getIndiceContenido().getFechaIndiceElectronico());
	...
	@Override
	public ObjetoExpedienteInside vincularExpediente(ObjetoExpedienteInside expedienteNew, String identificadorVinculado,
			String ruta, boolean signatureServer, String usuario, boolean online) throws InSideServiceException {
	...
	public ObjetoExpedienteInside linkExpedient(ObjetoExpedienteInside expediente, String identificadorVinculado, String ruta)
			throws InSideServiceException {
		ObjetoExpedienteInside expedienteVinculado = getExpediente(identificadorVinculado, false);
		ObjetoExpedienteInsideIndiceContenidoElementoContenedorElementos destino = getCarpetaOExpedienteDeRuta(expediente, ruta);
		ObjetoExpedienteInsideIndiceContenido indiceVinculado = new ObjetoExpedienteInsideIndiceContenido();

		indiceVinculado.setIdentificadorExpedienteAsociado(identificadorVinculado);
		indiceVinculado.setTipoAsociacion(ObjetoExpedienteInsideIndiceContenido.TipoAsociacion.VINCULACION);
		indiceVinculado.setOrden(destino.getElementosIndizados().size() + 1);
		indiceVinculado
				.setFechaIndiceElectronico(expedienteVinculado.getIndice().getIndiceContenido().getFechaIndiceElectronico());
	...
	@Override
	public ObjetoExpedienteInside createOpenViewExpedient(String identificador, String identifierView, String usuario,
			boolean online) throws InSideServiceException {

		ObjetoExpedienteInside nuevoExpediente = createNewViewExp(identificador, identifierView, false);

		return vincularExpediente(nuevoExpediente, identificador, "/", insideSigner.isActivo(), usuario, online);
	}

	@Override
	public ObjetoExpedienteInside createOpenViewExpedient(String identificador, String identifierView, boolean signatureServer,
			String usuario, boolean online) throws InSideServiceException {

		ObjetoExpedienteInside nuevoExpediente = createNewViewExp(identificador, identifierView, false);

		if (signatureServer)
			nuevoExpediente = vincularExpediente(nuevoExpediente, identificador, "/", signatureServer, usuario, online);
		else
	...
	@Override
	public ObjetoExpedienteInside createClosedViewExpedient(String identificador, String identifierView, String usuario,
			boolean online) throws InSideServiceException {

		ObjetoExpedienteInside nuevoExpediente = createNewViewExp(identificador, identifierView, true);

		return importarExpediente(nuevoExpediente, identificador, "/", insideSigner.isActivo(), usuario, online);
	}

	@Override
	public ObjetoExpedienteInside createClosedViewExpedient(String identificador, String identifierView, boolean signatureServer,
			String usuario, boolean online) throws InSideServiceException {

		ObjetoExpedienteInside nuevoExpediente = createNewViewExp(identificador, identifierView, true);

		if (signatureServer)
			nuevoExpediente = importarExpediente(nuevoExpediente, identificador, "/", signatureServer, usuario, online);
		else
	...
	public ObjetoExpedienteInside createNewViewExp(String identificador, String identifierView, boolean isClosedView)
			throws InSideServiceException {
		...
		if (isClosedView)
			nuevoExpediente.getMetadatos().setEstado(ObjetoExpedienteInsideMetadatosEnumeracionEstados.E_02);

		return nuevoExpediente;
	}

	protected void addElementosIndizadosImportados(ObjetoExpedienteInsideIndiceContenidoElementoContenedorElementos contenedor,
			List<ObjetoExpedienteInsideIndiceContenidoElementoIndizado> elementos) throws InsideServiceInternalException {
		for (ObjetoExpedienteInsideIndiceContenidoElementoIndizado elementoIndizado : elementos) {
			if (elementoIndizado instanceof ObjetoExpedienteInsideIndiceContenidoElementoContenedorElementos) {
				ObjetoExpedienteInsideIndiceContenidoElementoContenedorElementos contenedorIndizado = (ObjetoExpedienteInsideIndiceContenidoElementoContenedorElementos) elementoIndizado;
				...
				if (contenedorIndizado instanceof ObjetoExpedienteInsideIndiceContenidoCarpetaIndizada) {
					ObjetoExpedienteInsideIndiceContenidoCarpetaIndizada carpetaIndizada = (ObjetoExpedienteInsideIndiceContenidoCarpetaIndizada) contenedorIndizado;
					ObjetoExpedienteInsideIndiceContenidoCarpetaIndizada carpIndizadaImportada = new ObjetoExpedienteInsideIndiceContenidoCarpetaIndizada();
					...
					ObjetoExpedienteInsideIndiceContenido expIndizado = (ObjetoExpedienteInsideIndiceContenido) contenedorIndizado;
					ObjetoExpedienteInsideIndiceContenido expIndizadoImportado = new ObjetoExpedienteInsideIndiceContenido();
					expIndizadoImportado.setFechaIndiceElectronico(expIndizado.getFechaIndiceElectronico());
					expIndizadoImportado.setIdentificadorExpedienteAsociado(expIndizado.getIdentificadorExpedienteAsociado());
				...
				addElementosIndizadosImportados(nuevoContenedor, contenedorIndizado.getElementosIndizados());
				...
				ObjetoExpedienteInsideIndiceContenidoDocumentoIndizado docIndizadoImportado = new ObjetoExpedienteInsideIndiceContenidoDocumentoIndizado();
				docIndizadoImportado.setOrdenDocumentoExpediente(documentoIndizado.getOrdenDocumentoExpediente());
				...
				docIndizadoImportado.setFechaIncorporacionExpediente(documentoIndizado.getFechaIncorporacionExpediente());
				docIndizadoImportado.setIdentificadorDocumento(documentoIndizado.getIdentificadorDocumento());
	...
	public ObjetoExpedienteInside borrarCarpeta(String identificadorExpediente, String identificadorCarpeta, String ruta)
		...
		ObjetoExpedienteInsideIndiceContenidoElementoContenedorElementos destino = getCarpetaOExpedienteDeRuta(expediente, ruta);
		logger.debug("destino tras getCarpetaOExpedienteDeRuta(expediente,ruta); : " + destino.toString());

		ObjetoExpedienteInsideIndiceContenidoCarpetaIndizada carpetaBorrar = null;

		for (ObjetoExpedienteInsideIndiceContenidoElementoIndizado elementoIndizado : destino.getElementosIndizados()) {
	...
	public ObjetoDocumentoInside validarDocumento(ObjetoDocumentoInside documento) throws InSideServiceException {
		...
		logger.debug("Parametro <documento> : " + InsideConverterDocumento.documentoInsideToString(documento));
		documento = validate(documento);
		logger.debug("documento tras validate(documento); : " + InsideConverterDocumento.documentoInsideToString(documento));
	...
	public ObjetoExpedienteInside validarExpediente(ObjetoExpedienteInside expediente) throws InSideServiceException {
		...
		logger.debug("Parametro <expediente> : " + InsideConverterExpediente.expedienteInsideToString(expediente));
		expediente = validate(expediente);
	...
	public ObjetoExpedienteInside obtenerVisualizacionIndiceSiActivo(ObjetoExpedienteInside expediente, boolean estamparImagen,
		...
		if (insideVisualizacion.isActivo()) {
			...
			logger.debug("expediente tras insideVisualizacion.expedienteConVisualizacionIndice(expediente, opciones); : "
					+ InsideConverterExpediente.expedienteInsideToString(expediente));
		} else {
	...
	public ObjetoExpedienteInside obtenerVisualizacionIndiceSiActivo(ObjetoExpedienteInside expediente)
		...
		if (insideVisualizacion.isActivo()) {
			...
			logger.debug("expediente tras insideVisualizacion.expedienteConVisualizacionIndice(expediente); : "
					+ InsideConverterExpediente.expedienteInsideToString(expediente));
		} else {
			logger.debug("El servicio de visualizacion no esta activo y no se invoca");
		}
	...
	public ObjetoExpedienteInside vincularDocumentosEnExpedienteWithoutSave(ObjetoExpedienteInside expediente,
		...
		for (ObjetoDocumentoInside documento : documentos) {
			ObjetoExpedienteInsideIndiceContenidoDocumentoIndizado documentoIndizado = new ObjetoExpedienteInsideIndiceContenidoDocumentoIndizado();
			...
			byte[] bytesToDigest = (documento.getContenido().getValorBinario() != null)
					? documento.getContenido().getValorBinario() : documento.getContenido().getReferencia().getBytes();
	...
	public ObjetoExpedienteInside vincularDocumentosEnExpediente(ObjetoExpedienteInside expediente,
		...
		expediente = vincularDocumentosEnExpedienteWithoutSave(expediente, documentos, ruta, usuario, online);
	...
	public ObjetoExpedienteInside cambiarUbicacionEnExpediente(String identificadorExpediente,
			...
			throws InSideServiceException {
		logger.debug("Inicio operacion cambiarUbicacionEnExpediente (identificadorExpediente, identificadoresDocumentos, ruta)");
		...
		ObjetoExpedienteInsideIndiceContenidoElementoContenedorElementos rutaOrigenContenedora = getCarpetaOExpedienteDeRuta(
				expediente, rutaOrigen);
		logger.debug(
				"rutaContenedora tras getCarpetaOExpedienteDeRuta(expediente,rutaOrigen); : " + rutaOrigenContenedora.toString());

		ObjetoExpedienteInsideIndiceContenidoElementoContenedorElementos rutaDestinoContenedora = getCarpetaOExpedienteDeRuta(
				expediente, rutaDestino);
		logger.debug("rutaContenedora tras getCarpetaOExpedienteDeRuta(expediente,rutaDestinoOrigen); : "
		...
		for (String identificadorElemento : identificadoresElementos) {
			...
			ObjetoExpedienteInsideIndiceContenidoElementoIndizado contenidoEncontrado = InsideObjectsUtils
					.getElementoIndizadoInList(identificadorElemento, null, rutaOrigenContenedora.getElementosIndizados());
			if (contenidoEncontrado != null) {
				...
				logger.debug(
						"eliminado elementoIndizado con identificador " + identificadorElemento + " de la ruta :" + rutaOrigen);
				rutaDestinoContenedora.getElementosIndizados().add(contenidoEncontrado);
				logger.debug(
						"añadido elementoIndizado con identificador " + identificadorElemento + " a la ruta :" + rutaDestino);
			} else {
				throw new InSideServiceRequestErrorException("No existe el elemento del tipo indicado con identificador "
						+ identificadorElemento + " en la ruta " + rutaOrigen);
			}
		}

		logger.debug(
				"expediente tras cambiar elementos de ruta: " + InsideConverterExpediente.expedienteInsideToString(expediente));

		InsideObjectsUtils.asignarOrdenAElementosIndizados(rutaDestinoContenedora.getElementosIndizados());
	...
	public ObjetoDocumentoInside getDocumento(String identificador) throws InSideServiceException {
		...
		ObjetoDocumentoInside documento = getObjetoInside(ObjetoDocumentoInside.class, identificador, null);
	...
	public ObjetoDocumentoInsideContenido getDocumentoContenido(String identificador, byte[] bytesContenido)
		...
		try {
			contenido = InsideConverterDocumento.documentoInsideToObjetoDocumentoInsideContenido(documento, infoFirmaService,
					bytesContenido);
		} catch (InsideConverterException e) {
			throw new InSideServiceContentExtractException("Error al extraer el contenido del documento firmado", e);
		}
	...
	public ObjetoDocumentoInsideMetadatos getMetadatosDocumento(String identificador) throws InSideServiceException {
		...
		ObjetoDocumentoInsideMetadatos metadatos = getObjetoInsideMetadatos(ObjetoDocumentoInside.class, identificador, null);
		logger.debug("metadatos tras insideStore.getObjectMetadatos(ObjetoDocumentoInside.class,identificador); : "
				+ metadatos.toString());
	...
	public Integer getNumeroBytesDocumento(String identificador) throws InSideServiceException {
		...
		logger.debug("bytes tras InsideObjectsUtils.getBytesObjetoDocumentoInside(documento): " + bytes);
	...
	@Override
	public ObjetoDocumentoInside modificaDocumento(ObjetoDocumentoInside documento, String identificadorExpediente, String ruta,
			String usuario, boolean online) throws InSideServiceException {
		logger.debug("Inicio operacion modificaDocumento");
	 ...
	 * @return Lista con las firmas CSV que tiene un documento. Si no tiene
	...
	public List<FirmaInside> getFirmasCSVDocumentoInside(String identificador) throws InSideServiceException {
		...
		logger.debug("firmasCSV tras InsideObjectsUtils.getFirmasCSV(documento.getFirmas()): " + firmasCSV);
	...
	public List<ResultadoValidacionExpediente> validaExpedienteEniFile(byte[] expediente,
		...
		try {
			expedienteConDSSignature = es.mpt.dsic.inside.service.util.XMLUtils.deFirmaBase64_A_DSSignature(expediente);
		} catch (IOException e) {
	...
	public void validacionClasificacionExp(List<OpcionValidacionExpediente> opciones, ObjetoExpedienteInside expedienteInside,
	...
	public void validacionUnidadesOrganicasExp(List<OpcionValidacionExpediente> opciones, ObjetoExpedienteInside expedienteInside,
			List<ResultadoValidacionExpediente> resultados) {
		boolean valido = true;
		String mensaje = VALIDACION_CORRECTA;
	...
	/*
	 * Si opciones viene vacio es por el proceso de validar documento y desde
	 * ahi, si no tiene firma puede ser un eni valido, pero si tiene firma y es
	 * distinta de csv hay que validarla. Si opciones viene relleno, procede de
	 * otros procesos internos de inside y debe validar que sea firmado y la
	 * validacion de la firma siempre que no sea csv
	 */
	private boolean validarFirma(ObjetoDocumentoInside documentoInside, List<OpcionValidacionDocumento> opciones)
			throws InSideServiceException {
		boolean validarFirmaEnDocumento = true;
		
		ObjetoDocumentoInsideMetadatosEstadoElaboracionEnumeracion estadoElaboracionDocumento = documentoInside.getMetadatos().getEstadoElaboracion().getValorEstadoElaboracion();
		//si el estado de elaboracion de un documento es OTROS, debe permitirse el documento
		if(estadoElaboracionDocumento.value().equalsIgnoreCase(ObjetoDocumentoInsideMetadatosEstadoElaboracionEnumeracion.EE_99.value()))
		{
		...
		if (!CollectionUtils.isEmpty(opciones)) {
			if (CollectionUtils.isEmpty(documentoInside.getFirmas())) {
				throw new InsideServiceInternalException(
						messageSource.getMessage("importarDocumento.error.docNoValido.sin.firmas", null, Locale.getDefault())
								+ " " + documentoInside.getIdentificador());
			} else {
				if (FirmaInsideTipoFirmaEnum.TF_01.value().equals(documentoInside.getFirmas().get(0).getTipoFirma().value())) {
		...
		// validar documentoENI
			...
			if (!CollectionUtils.isEmpty(documentoInside.getFirmas()) && !FirmaInsideTipoFirmaEnum.TF_01.value()
	...
	private Validaciones configurarValidacionesExpediente(boolean validarSIA) throws InSideServiceException {
		Validaciones validaciones = new Validaciones();
		validaciones.setValidaSchema(true);
		validaciones.setValidaDir3(true);
	...
	public List<ResultadoValidacionDocumento> validaDocumentoEniFile(byte[] documento, List<OpcionValidacionDocumento> opciones,
		...
		List<ResultadoValidacionDocumento> resultados = consumidorValidacionENI.validaDocumentoENI(documento, validaciones);

		return resultados;
	}

	public void validacionFirmasDoc(List<OpcionValidacionDocumento> opciones, ObjetoDocumentoInside documentoInside,
		...
		try {
			if (opciones.contains(OpcionValidacionDocumento.TOVD_03) && checkIfNotCsvSign(documentoInside.getFirmas())) {
	...
	public void validacionUnidadesOrganicasDoc(List<OpcionValidacionDocumento> opciones, ObjetoDocumentoInside documentoInside,
			List<ResultadoValidacionDocumento> resultados) {
		boolean valido = true;
		String mensaje = VALIDACION_CORRECTA;
	 ...
	 * 
	 * @param documento
	 *            Documento Inside que se quiere visualizar
	 * @param estamparImagen
	 *            Indica si se desea estampar el logo del Ministerio.
	 * @param estamparNombreOrganismo
	 *            Indica si se quiere estampar el nombre del organismo
	 * @param lineasNombreOrganismo
	 *            Nombre del organismo, separado en las líneas en que se desee
	 *            que se estampen.
	 * 
	 */
	@Override
	public ResultadoVisualizacionDocumento visualizaDocumentoInside(ObjetoDocumentoInside documento, boolean estamparImagen,
		...
		ResultadoVisualizacionDocumento resultadoVisualizacionDocumento = insideVisualizacion.visualizacionDocumento(documento,
				opciones, bytesContenido);
	...
	/**
	 * Elimina una lista de elementos indizados con identificadores determinados
	 * de un expediente. La ruta donde se encuentren se ha de pasar como
	 * parámetro
	 * 
	 * @param expediente
	 *            Expediente del que se quiere eliminar elementos indizados.
	 * @param identificadoresContenido
	 *            identificador del elemento indizado a eliminar: -
	 *            identificador del documento en caso del documento -
	 *            identificador del expediente vinculado o importado -
	 *            identificador de la carpeta
	 * @param Class
	 *            <T> clase del elemento a eliminar, si es null no se tendrá en
	 *            cuenta.
	 * @param ruta
	 *            Ruta donde se encuentra el elemento indizado.
	...
	private <T extends ObjetoExpedienteInsideIndiceContenidoElementoIndizado> ObjetoExpedienteInside eliminarContenidoDeExpediente(
			ObjetoExpedienteInside expediente, List<String> identificadoresContenido, Class<T> clase, String ruta)
			throws InSideServiceException {
		logger.debug("Inicio operacion desvincularDocumentosEnExpediente (expediente, documentos, ruta)");
		logger.debug("Parametro <expediente> : " + InsideConverterExpediente.expedienteInsideToString(expediente));
		...
		ObjetoExpedienteInsideIndiceContenidoElementoContenedorElementos rutaContenedora = getCarpetaOExpedienteDeRuta(expediente,
				ruta);
		logger.debug("rutaContenedora tras getCarpetaOExpedienteDeRuta(expediente,ruta); : " + rutaContenedora.toString());
		...
		for (String identificadorContenido : identificadoresContenido) {
			...
			ObjetoExpedienteInsideIndiceContenidoElementoIndizado contenidoEncontrado = InsideObjectsUtils
					.getElementoIndizadoInList(identificadorContenido, clase, rutaContenedora.getElementosIndizados());
			if (contenidoEncontrado != null) {
				...
				throw new InSideServiceRequestErrorException("No existe el elemento del tipo indicado con identificador "
						+ identificadorContenido + " en la ruta " + ruta);
			}
		}

		logger.debug(
				"expediente tras eliminar elementoIndizado: " + InsideConverterExpediente.expedienteInsideToString(expediente));
	...
	/**
	 * Devuelve la carpeta o el expediente indizado de un indice en la ruta
	...
	private ObjetoExpedienteInsideIndiceContenidoElementoContenedorElementos getCarpetaOExpedienteDeRuta(
		...
		ObjetoExpedienteInsideIndiceContenidoElementoIndizado ret = getElementoIndizado(expediente.getIndice(), ruta);
		...
		throw new InSideServiceRequestErrorException("No se encuentra carpeta o expediente en la ruta " + ruta);
	...
	private ObjetoExpedienteInsideIndiceContenidoElementoIndizado getElementoIndizado(
		...
		return getElementoIndizado(objetoExpedienteInsideIndice.getIndiceContenido().getElementosIndizados(), path, 0);
	}

	private ObjetoExpedienteInsideIndiceContenidoElementoIndizado getElementoIndizado(
			List<ObjetoExpedienteInsideIndiceContenidoElementoIndizado> elementosIndizados, String[] path, int nivel) {
		Assert.notNull(elementosIndizados);
		Assert.notNull(path);
		Assert.notNull(nivel);
		if (nivel > path.length) {
			throw new IndexOutOfBoundsException(
					"El nivel (" + nivel + ") no puede ser superior a la longitud de path (" + path.length + ")");
		}
		...
		for (ObjetoExpedienteInsideIndiceContenidoElementoIndizado elemento : elementosIndizados) {
			if (elemento instanceof ObjetoExpedienteInsideIndiceContenido) {
				ObjetoExpedienteInsideIndiceContenido indiceIndizado = (ObjetoExpedienteInsideIndiceContenido) elemento;
			...
			if (StringUtils.equals(compare, elemNombre)) {
				if ((nivel + 1) == path.length) {
					...
					return getElementoIndizado(
							((ObjetoExpedienteInsideIndiceContenidoElementoContenedorElementos) elemento).getElementosIndizados(),
							path, nivel + 1);
				}
			}
		}
	...
	/**
	 * Nos aseguramos de que los objetos siempre se den de alta con un
	 * identificador
	 * 
	 * @param objeto
	 */
	...
	public void validateObjetoInsideIdentificador(ObjetoInside<?> objeto) throws InSideServiceException {
		if (objeto.getIdentificador() == null) {
			objeto.setIdentificador(InsideServiceIdentifierGenerator.generateObjetoInsideIdentificador(objeto));
			logger.debug("El objeto " + objeto.getClass().getSimpleName() + " no tenía identificador, le asigno el: "
					+ objeto.getIdentificador());
		}
	}
	...
	private void validateObjetoInsideVersion(ObjetoInside<?> objeto) {
		if ((objeto instanceof ObjetoInsideVersionable) && ((ObjetoInsideVersionable) objeto).getVersion() == null) {
			((ObjetoInsideVersionable) objeto).setVersion(ObjetoInsideVersion.createFirstVersion());
			logger.debug("Creada primera versión para objeto de tipo " + objeto.getClass().getSimpleName() + " con identificador "
					+ objeto.getIdentificador());
	...
	/**
	 * Recupera un objeto del repositorio, si la version es inferior a 1 se
	 * llama al getObject (sin version)
	 * 
	 * @param tipo
	 * @param identificador
	 * @param version
	...
	private <T extends ObjetoInside<?>> T getObjetoInside(final Class<T> tipo, final String identificador, final Integer version)
			throws InsideServiceStoreException, InsideStoreObjectNotFoundException, InsideStoreObjectNoActiveException {
	...
	private <T extends ObjetoInside<K>, K extends ObjetoInsideMetadatos> K getObjetoInsideMetadatos(Class<T> tipo,
			String identificador, Integer version) throws InsideServiceStoreException, InsideStoreObjectNotFoundException {
		if (version != null && version >= 1) {
	...
	private <T extends ObjetoInside<K>, K extends ObjetoInsideMetadatos> T validate(T objeto)
			throws InSideServiceObjectDefinitionNotFoundException, InSideServiceValidationException, InSideServiceException {
		@SuppressWarnings("unchecked")
	...
	private <T extends ObjetoInside<?>> T convertFromRepository(T objeto)
			throws InSideServiceObjectDefinitionNotFoundException, InsideServiceObjectConverterException {
		@SuppressWarnings("unchecked")
		T objetoConvertido = (T) objectDefinitions.getConverter(objeto.getClass()).fromRepository(objeto);
		return objetoConvertido;
	}

	private <T extends ObjetoInside<?>> T sign(T objeto, String usuario) throws InSideServiceException {
		@SuppressWarnings("unchecked")
	...
	/**
	 * Establece el Algoritmo que se utiliza para calcular la huella digital de
	 * los documentos para el indice del Expediente electrónico
	 * 
	...
	public void setFuncionResumenDocumentos(String funcionResumen) throws NoSuchAlgorithmException {
		logger.info("Estableciendo función de Resumen para documentos del índice a '" + funcionResumen + "'");
	...
	public void deleteDocument(String identificador) throws InSideServiceException {
		ObjetoDocumentoInside objeto = getObjetoInside(ObjetoDocumentoInside.class, identificador, null);
	...
	public void deleteExpedient(String identificador) throws InSideServiceException {
		ObjetoExpedienteInside objeto = getObjetoInside(ObjetoExpedienteInside.class, identificador, null);
		checkElementosAsociados(objeto, identificador);
		deleteRepository(objeto);
		insideStore.deleteExpedient(identificador);
	}

	public void checkElementosAsociados(ObjetoInside objeto, String identificador) throws InSideServiceException {
		List<ObjetoExpedienteInside> expVinculados = getExpedientesAsociadosDocumento(objeto.getClass(), identificador);
	...
	public void firmarIndiceExpediente(ObjetoExpedienteInside expediente, WSCredentialInside info, String usuario)
		...
		try {
			...
			byte[] firmaIndice = insideSigner.firmarFicheroWhitPropertie(data.getBytes(), null, "XAdES Enveloped", "IMPLICIT",
					idNodeToSign, info);
			...
			//String nodofirma = es.mpt.dsic.inside.service.util.XMLUtils.signatureString("expediente/indice/Signature", firmaIndice);
			String nodofirma = es.mpt.dsic.inside.service.util.XMLUtils.signatureString("//*[local-name()='Signature']", firmaIndice);
			
			logger.debug("incluimos nodo signature:" + nodofirma);
			Base64 bs64 = new Base64();
			byte[] firmaBase64 = bs64.encode(nodofirma.getBytes(es.mpt.dsic.inside.service.util.XMLUtils.UTF8_CHARSET));
//			establecerFirmaExpedienteANodoFirmaBase64(expediente, "FIRMA_0", FirmaInsideTipoFirmaEnum.TF_02, firmaBase64, expediente.getIdentificador());
			establecerFirmaExpedienteANodoFirmaBase64(expediente, "FIRMA_0", FirmaInsideTipoFirmaEnum.TF_03, firmaBase64, expediente.getIdentificador());
	...
	private String marshallDataExpedient(Object datos) throws JAXBException {
		...
		if (datos instanceof TipoExpediente) {
			...
			JAXBElement<TipoExpediente> jx = new JAXBElement<TipoExpediente>(
					new QName("http://administracionelectronica.gob.es/ENI/XSD/v1.0/expediente-e", "expediente", "exp"),
		...
		if (datos instanceof TipoExpedienteInsideConMAdicionales) {
			...
			Marshaller marshaller = context.createMarshaller();
			marshaller.setProperty(Marshaller.JAXB_FORMATTED_OUTPUT, Boolean.TRUE);
			JAXBElement<TipoExpedienteInsideConMAdicionales> jx = new JAXBElement<TipoExpedienteInsideConMAdicionales>(
					new QName("https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService", "expediente", "insidews"),
	...
	public void establecerFirmaExpedienteANodoFirmaBase64(ObjetoExpedienteInside expediente, String idFirma,
			FirmaInsideTipoFirmaEnum tipoFirma, byte[] firmaBase64, String ref) {
		...
		ContenidoFirmaCertificadoContenidoBinarioInside firmaConCertificado = new ContenidoFirmaCertificadoContenidoBinarioInside();
	...
	public void establecerFirmaExpediente(ObjetoExpedienteInside expediente, String idFirma, FirmaInsideTipoFirmaEnum tipoFirma,
		...
		ContenidoFirmaCertificadoDsSignatureInside firmaConCertificado = new ContenidoFirmaCertificadoDsSignatureInside();
	...
	public ObjetoDocumentoInside documentoConversionToInside(TipoDocumentoConversionInside documentoConversion,
		...
		try {
			if (firmar) {
				...
				byte[] firma = insideSigner.firmarFichero(documentoConversion.getContenido(), null, formatoFirma, null, info);
				ObjetoAuditoriaFirmaServidor objetoAuditoriaFirmaServidor = new ObjetoAuditoriaFirmaServidor(
						Constantes.ELEMENTO_DOCUMENTO, documentoConversion.getMetadatosEni().getIdentificador(),
						info.getIdaplicacion());
				saveAuditoriaFirmaServidor(objetoAuditoriaFirmaServidor);
				documentoConversion.setContenido(firma);
				documentoConversion.setFirmadoConCertificado(true);
			}
			return InsideConverterDocumento.documentoConversionToInside(documentoConversion, infoFirmaService, contenido);
		} catch (InSideServiceSignerException e) {
	...
	@Override
	public boolean permisoObjetoUnidad(ObjetoInside<?> obj, String identificadorUsuario, boolean online)
			throws InSideServiceException {
		return insideStore.validarObjetoUnidad(obj, identificadorUsuario, online);
	}

	@Override
	public List<ObjetoInsideExpedienteUnidad> getExpedientesUnidad(ObjetoInsideUsuario usuario, boolean soloUnidadActiva)
			throws InSideServiceException {
	...
	@Override
	public List<ObjetoInsideExpedienteUnidad> getExpedientesUnidadAutocompleter(ObjetoInsideUsuario usuario,
	...
	@Override
	public List<ObjetoInsideDocumentoUnidad> getDocumentosUnidad(ObjetoInsideUsuario usuario, boolean soloUnidadActiva)
			throws InSideServiceException {
		if (usuario == null || StringUtils.isBlank(usuario.getNif())) {
			throw new InsideServiceInternalException("Debe especificar usuario");
		}
	...
	@Override
	public ObjetoExpedienteToken getTokenByUsuarioExpediente(ObjetoExpedienteToken usuarioToken) throws InSideServiceException {
		return insideStore.getTokenByUsuarioExpediente(usuarioToken);
	}

	@Override
	public ObjetoExpedienteToken getTokenByData(ObjetoExpedienteToken usuarioToken) throws InSideServiceException {
	...
	@Override
	public void saveAuditoriaToken(ObjetoAuditoriaToken objectAuditoriaToken) throws InSideServiceException {
	...
	@Override
	public ResultadoBusquedaUsuario getUsuarios(ObjetoFilterPageRequest data) throws InSideServiceException {
	...
	@Override
	public ObjetoInsideAplicacion altaAplicacion(ObjetoInsideAplicacion data) throws InSideServiceException {
		return insideStore.altaAplicacion(data);
	}

	@Override
	public ObjetoInsideAplicacion bajaAplicacion(ObjetoInsideAplicacion data) throws InSideServiceException {
		return insideStore.bajaAplicacion(data);
	}

	@Override
	public ObjetoInsideUnidad asociarUnidadAplicacion(String idUnidad, String numeroProcedimiento, String idAplicacion)
			throws InSideServiceException {
		return insideStore.altaUnidadAplicacion(idUnidad, numeroProcedimiento, idAplicacion);
	}

	@Override
	public void eliminarUnidadAplicacion(String idUnidad, String numeroProcedimiento, String idAplicacion)
			throws InSideServiceException {
		insideStore.deleteUnidadAplicacion(idUnidad, numeroProcedimiento, idAplicacion);
	}

	@Override
	public ObjetoInsideUnidad asociarUnidadUsuario(String idUnidad, String numeroProcedimiento, String idUsuarios)
			throws InSideServiceException {
	...
	@Override
	public List<ObjetoInsideUnidad> getUnidadesAplicacion(String idAplicacion, boolean todas) throws InSideServiceException {
		return insideStore.getUnidadesAplicacion(idAplicacion, todas);
	}

	@Override
	public List<ObjetoInsideUnidad> getUnidadesUsuario(String idUsuarios, boolean todas) throws InSideServiceException {
	...
	public ObjetoInsideRol getRolUnidadUsuario(String codigoUnidad, String nif) throws InSideServiceException
	{
		...
		UsuarioInside usuarioInside = (UsuarioInside) insideServiceJta.findObjeto(UsuarioInside.class, criteriasUsuario);
		...
		UnidadOrganica unidadOrganica = (UnidadOrganica) insideServiceJta.findObjeto(UnidadOrganica.class, criteriasUnidad);
		...
		UnidadUsuario usuarioUnidad = (UnidadUsuario) insideServiceJta.findObjeto(UnidadUsuario.class, criterias);
	...
	@Override
	public boolean comprobarUnidadesOrganicasActivasUsuario(Object usuario) throws InSideServiceException {
		return insideStore.comprobarUnidadesOrganicasActivasUsuario(usuario);
	}

	@Override
	public boolean checkAssociatedViewsExpedient(String identificadorExpediente) throws InSideServiceException {
		boolean existView = false;
		List<ObjetoInsideExpedienteUnidad> listViews = insideStore.getViewsExpedient(identificadorExpediente);
	...
	@Override
	public List<ObjetoInsideExpedienteUnidad> getViewsExpedient(String identificadorExpediente) throws InSideServiceException {
	...
	public void guardarRespuestaRemisionJusticiaExpediente(ObjectInsideRespuestaEnvioJusticia objectInsideRespuestaEnvioJusticia,
		...
		insideStore.insertRespuestaRemisionJusticia(objectInsideRespuestaEnvioJusticia, identificadorExpediente, version);
	}
	...
	public void guardarRespuestaRemisionJusticiaExpedienteNoInside(
			...
			throws InSideServiceException {
		insideStore.insertRespuestaRemisionJusticiaExpedienteNoInside(objectInsideRespuestaEnvioJusticia, identificadorExpediente,
				version);
	}

	@Override
	public ObjetoInsideUnidadAplicacionEeutil getApplicationEeutilByUser(ObjetoInsideUsuario user) throws InSideServiceException {
		...
		if (CollectionUtils.isNotEmpty(list)) {
			for (Object dato : list) {
				if (dato instanceof ObjetoExpedienteInsideIndiceContenidoDocumentoIndizado) {
					retorno.put(((ObjetoExpedienteInsideIndiceContenidoDocumentoIndizado) dato).getIdentificadorDocumento(),
							path);
					...
					auxPath += ((ObjetoExpedienteInsideIndiceContenidoCarpetaIndizada) dato).getIdentificadorCarpeta();
					retorno.putAll(obtenerDocsExpInside(
							((ObjetoExpedienteInsideIndiceContenidoCarpetaIndizada) dato).getElementosIndizados(), auxPath));
				} else if (dato instanceof ObjetoExpedienteInsideIndiceContenidoElementoContenedorElementos) {
					retorno.putAll(obtenerDocsExpInside(
							((ObjetoExpedienteInsideIndiceContenidoElementoContenedorElementos) dato).getElementosIndizados(),
							path));
				}
			}
		}
		...
		if (CollectionUtils.isNotEmpty(datos)) {
			for (Object dato : datos) {
				if (dato instanceof TipoDocumentoIndizado) {
					...
					retorno.putAll(obtenerDocsExpTipo(
							((TipoCarpetaIndizada) dato).getDocumentoIndizadoOrExpedienteIndizadoOrCarpetaIndizada(), auxPath));
				} else if (dato instanceof TipoIndiceContenido) {
					retorno.putAll(obtenerDocsExpTipo(
							((TipoIndiceContenido) dato).getDocumentoIndizadoOrExpedienteIndizadoOrCarpetaIndizada(), path));
				}
			}
		}
		return retorno;
	...
	public void getRepeatIds(List<String> idsRepetidos, Map<String, String> origen, Map<String, String> destino) {
	...
	@SuppressWarnings("unchecked")
	@Override
	public Collection<String> correspondencia(Object expediente, List<String> identificadoresDocumento) {
		Map<String, String> idDocumentosExpediente = null;

		if (expediente instanceof ObjetoExpedienteInside)
			idDocumentosExpediente = obtenerDocsExpInside(
					((ObjetoExpedienteInside) expediente).getIndice().getIndiceContenido().getElementosIndizados(), "/");
		else if (expediente instanceof TipoExpediente)
			idDocumentosExpediente = obtenerDocsExpTipo(((TipoExpediente) expediente).getIndice().getIndiceContenido()
	...
	public boolean checkSignatureServerByUser(ObjetoInsideUsuario objetoInsideUsuario) {
		...
		try {
			if (objetoInsideUsuario != null) {
				ObjetoInsideUnidadAplicacionEeutil aplicationEeutil = getApplicationEeutilByUser(objetoInsideUsuario);
	...
	public ObjetoInsideAplicacion crearActualizarSerialNumberCertificado(String idAplicacion, String serialNumberCertificado)
			throws InsideServiceStoreException {
		return insideStore.crearActualizarSerialNumberCertificado(idAplicacion, serialNumberCertificado);
	}
	...
	public List<ObjetoComunicacionTokenExpediente> getComunicacionesTokenExpedienteActivas(int maximoResultados,
		...
		return insideStore.getComunicacionesTokenExpedienteActivas(maximoResultados, numeroMaximoIntentos);
	}
	...
	public void validarFirma(byte[] firma) throws InSideServiceException {
		try {
			ResultadoValidacionInfo resultado = insideVisualizacion.llamadaValidacionFirmaService(firma, null);
	...
	public void validarFirma(byte[] firma, byte[] documento) throws InSideServiceException {
		try {
			...
			ResultadoValidacionInfo resultado = insideVisualizacion.llamadaValidacionFirmaService(firmaAValidar, datos);
			if (resultado != null && !BooleanUtils.isTrue(resultado.isEstado()))
				throw new InsideServiceInternalException("Firma incorrecta.");
	...
	public void getDocumentoEnIndiceExpediente(List<ObjetoExpedienteInsideIndiceContenidoElementoIndizado> elementosIndizados,
		...
		for (ObjetoExpedienteInsideIndiceContenidoElementoIndizado elemento : elementosIndizados) {
			if (elemento instanceof ObjetoExpedienteInsideIndiceContenido) {
				getDocumentoEnIndiceExpediente(((ObjetoExpedienteInsideIndiceContenido) elemento).getElementosIndizados(),
						elemNombre, contenidoDoc);
			} else if (elemento instanceof ObjetoExpedienteInsideIndiceContenidoCarpetaIndizada) {
				getDocumentoEnIndiceExpediente(
						((ObjetoExpedienteInsideIndiceContenidoCarpetaIndizada) elemento).getElementosIndizados(), elemNombre,
						contenidoDoc);
			} else if (elemento instanceof ObjetoExpedienteInsideIndiceContenidoDocumentoIndizado) {
				compare = ((ObjetoExpedienteInsideIndiceContenidoDocumentoIndizado) elemento).getIdentificadorDocumento();
				if (StringUtils.equals(compare, elemNombre)) {
					contenidoDoc.setIdentificadorDocumento(
							((ObjetoExpedienteInsideIndiceContenidoDocumentoIndizado) elemento).getIdentificadorDocumento());
					contenidoDoc
							.setValorHuella(((ObjetoExpedienteInsideIndiceContenidoDocumentoIndizado) elemento).getValorHuella());
				}
			}
		}
	}
	...
	@Override
	public ObjetoComunicacionTokenExpediente getComunicacionTokenExpedientePorId(
			String id) throws InsideServiceStoreException {
