...
public class WebConstants {
  ...
  // firma longeva
  public static final String MSG_GENERAR_FIRMA_LONGEVA_ERROR = "generar.firma.longeva.error";

  // generar expediente
  public static final String MSG_GENERAR_EXP_OK = "generarExpediente.ok";
  public static final String MSG_GENERAR_EXP_CARPETAS_PADRE_DENTRO_HIJO =
      "generarExpediente.carpetas.padreDentroHijo";
  public static final String MSG_GENERAR_EXP_CARPETAS_MISMO_ID =
      "generarExpediente.carpetas.mismoId";
  public static final String MSG_CALCULAR_HASH_DOCUMENTO_ERROR =
      "generarExpediente.calcular.hash.documento.error";
  ...
  public static final String MSG_IMPORTAR_EXP_CARPETA_NO_VACIA =
      "importarExpediente.error.carpetaNoVacia";
  ...
  // ENVIO AL CARGADOR
  public static final String MSG_FORMATO_DOCUMENTO_NO_PERMITIDO_MJU =
      "remitirExpediente.remitirMJU.formato.documento.no.permitido";
