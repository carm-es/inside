...
/**
 * <p>
 * Clase Java para CargosWsObject complex type.
 * 
 * <p>
...
@XmlType(name = "CargosWsObject", propOrder = {"entidades", "organismos", "unidades",
    "instituciones", "nombre", "apellido1", "apellido2", "nif", "email"})
public class CargosWsObject {
   ...
   * 
   * @return possible object is {@link CargoEntidadWsObjectArray }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link CargoEntidadWsObjectArray }
   * 
   */
   ...
   * 
   * @return possible object is {@link CargoOrganismoWsObjectArray }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link CargoOrganismoWsObjectArray }
   * 
   */
   ...
   * 
   * @return possible object is {@link CargoUnidadDirWsObjectArray }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link CargoUnidadDirWsObjectArray }
   * 
   */
   ...
   * 
   * @return possible object is {@link CargoInstitucionWsObjectArray }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link CargoInstitucionWsObjectArray }
   * 
   */
