...
/**
 * Validador fechas encapsuladas en objetos Calendar
 * 
 * @author miguel.ortega
 *
 */
public class MetadatoValidatorCalendar implements MetatadatoValidator<Calendar> {

  @Override
  public Calendar clean(Calendar data) throws InSideServiceMetadatoValidationException {
    // validar la fecha en función de parámetros
    return data;
  }
