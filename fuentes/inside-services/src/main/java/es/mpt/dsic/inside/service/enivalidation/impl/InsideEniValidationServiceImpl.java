...
public class InsideEniValidationServiceImpl implements InsideEniValidationService {
  ...
  @Override
  public boolean validarExpedienteDocumentoEniFile(byte[] xmlBytes)
    ...
    try {
      ...
      throw new InsideEniValidationException(
          "Validación incorrecta: No se puede parsear la fuente");
