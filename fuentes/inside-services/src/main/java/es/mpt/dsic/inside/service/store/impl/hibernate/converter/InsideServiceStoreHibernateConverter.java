...
public interface InsideServiceStoreHibernateConverter<T extends ObjetoInside<?>, K extends Object> {

  public K toEntity(T object, Session session) throws InsideServiceStoreException;
