...
public class Constantes {
	...
	public static final String INSIDE_ADMINISTRADORORGANISMO_DESCRIPCION 	= "INSIDE-AdministradorOrganismo";
	...
	// Cargos considerados especiales que pasan a inside como role gestor aunque no esten dados de alta en portales con algun rol de inside
	...
	public static final String PORTALES_INTERVENCION_TESORERIA_HAB_ESTATAL 	= "intervencion_tesoreria_hab_estatal";
	...
	public static final String MSG_IMPORTAR_DOC_NO_VALIDO_SIN_FIRMAS = "importarDocumento.error.docNoValido.sin.firmas";
