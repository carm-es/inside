...
public class InsideServiceStoreHibernateConverterExpedienteToken {
	...
	public ExpedienteToken toEntity(ObjetoExpedienteToken token,
		...
		if (token.getUsuario() != null
			&& StringUtils.isNotBlank(token.getUsuario().getNif())) {
	...
	public ObjetoExpedienteToken toInside(ExpedienteToken entity) throws InsideServiceStoreException {
		...
		expediente.setUsuario(InsideServiceStoreHibernateConverterUsuario.toInside(entity.getUsuario()));
