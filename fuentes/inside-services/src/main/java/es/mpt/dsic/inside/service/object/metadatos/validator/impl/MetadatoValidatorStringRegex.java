...
/**
 * Validador para validar cadenas de caracteres con un patrón regular
 * 
 * @author miguel.ortega
 *
 */
public class MetadatoValidatorStringRegex extends MetadatoValidatorString
    implements MetatadatoValidator<String> {
  ...
  public String clean(String data) throws InSideServiceValidationException {
    ...
    if (!matcher.matches()) {
      throw new InSideServiceValidationException(
          "El dato '" + data + "' no cumple con la expresión regular '" + expresionRegular + "'");
    }
    return data;
