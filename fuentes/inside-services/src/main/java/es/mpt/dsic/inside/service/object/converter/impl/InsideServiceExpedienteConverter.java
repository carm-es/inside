...
public class InsideServiceExpedienteConverter implements
    InsideServiceObjectConverter<ObjetoExpedienteInside, ObjetoExpedienteInsideMetadatos> {
  ...
  public ObjetoExpedienteInside toRepository(ObjetoExpedienteInside expediente)
    ...
    try {
      ...
      throw new InsideServiceObjectConverterException(
          "Error almacenando el Expediente en el repositorio ", e);
    }
  ...
  public ObjetoExpedienteInside fromRepository(ObjetoExpedienteInside objeto)
    ...
    try {
      ...
      throw new InsideServiceObjectConverterException(
          "Error obteniendo del repositorio el expediente", e);
    }
  ...
  public ObjetoExpedienteInside delete(ObjetoExpedienteInside expediente)
    ...
    try {
      ...
      throw new InsideServiceObjectConverterException(
          "Excepción eliminando el expediente del repositorio CSVSTORAGE", e);
    }
    return expediente;
  }
