...
public class UtilsTest {
  ...
  public static ObjetoDocumentoInside createObjetoDocumentoInside(boolean conMetadatos,
      boolean conIdentificador, boolean conContenido, boolean conFirma) {
    ...
    if (conContenido) {
      ...
      try {
        contenido.setValorBinario(
            IOUtils.toByteArray(new FileInputStream("src/test/resources/PEDEFE.pdf")));
    ...
    if (conFirma) {
      ...
      try {
        ...
        contenidoFirma.setValorBinario(
            IOUtils.toByteArray(new FileInputStream("src/test/resources/firmaXades.xsig")));
  ...
  public static ObjetoExpedienteInside createObjetoExpedienteInside(boolean conIdentificador,
      boolean conMetadatos, boolean conIndice) {
  ...
  public static void assertEqual(ObjetoExpedienteInside expediente1,
      ObjetoExpedienteInside expediente2, boolean checkContenidoFirma) throws AssertionError {
    ...
    if (!StringUtils.equals(expediente1.getIdentificadorRepositorio(),
        expediente2.getIdentificadorRepositorio())) {
  ...
  private static void assertEqual(ObjetoExpedienteInsideIndice indice1,
      ObjetoExpedienteInsideIndice indice2, boolean checkContenidoFirma) throws AssertionError {
  ...
  private static void asserEqualFirmas(List<FirmaInside> firmas1, List<FirmaInside> firmas2,
      boolean checkContenidoFirma) {
  ...
  private static void assertEqual(ObjetoExpedienteInsideIndiceContenido indiceContenido1,
      ObjetoExpedienteInsideIndiceContenido indiceContenido2) throws AssertionError {
    if (indiceContenido1 != null && indiceContenido2 != null) {
      assertEqual(indiceContenido1.getFechaIndiceElectronico(),
          indiceContenido2.getFechaIndiceElectronico());
      if (indiceContenido1.getElementosIndizados() != null
          && indiceContenido2.getElementosIndizados() != null) {
        if (indiceContenido1.getElementosIndizados().size() != indiceContenido1
            .getElementosIndizados().size()) {
          throw new AssertionError("No coincide el número de elementos indizados");
        }

        for (ObjetoExpedienteInsideIndiceContenidoElementoIndizado elementoIndizado1 : indiceContenido1
            .getElementosIndizados()) {
          boolean iguales = false;
          for (ObjetoExpedienteInsideIndiceContenidoElementoIndizado elementoIndizado2 : indiceContenido2
              .getElementosIndizados()) {
            try {
      ...
      } else if (indiceContenido1.getElementosIndizados() == null
          && indiceContenido2.getElementosIndizados() == null) {
        // ok
      } else if (indiceContenido1.getElementosIndizados() == null
          && (indiceContenido2.getElementosIndizados() != null
              && indiceContenido2.getElementosIndizados().size() == 0)) {
        // ok
      } else if (indiceContenido2.getElementosIndizados() == null
          && (indiceContenido1.getElementosIndizados() != null
              && indiceContenido1.getElementosIndizados().size() == 0)) {
        // ok
      } else {
        throw new AssertionError(
            "Uno de los listados de elementos del índice está vacio y el otro no");
      }
  ...
  private static void assertEqual(
    ...
    if (elementoIndizado1 != null && elementoIndizado2 != null) {
      ...
      if (elementoIndizado1 instanceof ObjetoExpedienteInsideIndiceContenidoDocumentoIndizado
          && elementoIndizado2 instanceof ObjetoExpedienteInsideIndiceContenidoDocumentoIndizado) {
        ObjetoExpedienteInsideIndiceContenidoDocumentoIndizado documentoIndizado1 =
            (ObjetoExpedienteInsideIndiceContenidoDocumentoIndizado) elementoIndizado1;
        ObjetoExpedienteInsideIndiceContenidoDocumentoIndizado documentoIndizado2 =
            (ObjetoExpedienteInsideIndiceContenidoDocumentoIndizado) elementoIndizado2;
        assertEqual(documentoIndizado1.getFechaIncorporacionExpediente(),
            documentoIndizado2.getFechaIncorporacionExpediente());
        if (!StringUtils.equals(documentoIndizado1.getFuncionResumen(),
            documentoIndizado2.getFuncionResumen())) {
          throw new AssertionError("No coincide la función de reumen");
        }
        if (!StringUtils.equals(documentoIndizado1.getIdentificadorDocumento(),
            documentoIndizado2.getIdentificadorDocumento())) {
        ...
        if (!StringUtils.equals(documentoIndizado1.getValorHuella(),
            documentoIndizado2.getValorHuella())) {
          throw new AssertionError("No coincide el valor de la huella");
        }
      } else if (elementoIndizado1 instanceof ObjetoExpedienteInsideIndiceContenido
          && elementoIndizado2 instanceof ObjetoExpedienteInsideIndiceContenido) {
        ObjetoExpedienteInsideIndiceContenido indiceContenido1 =
            (ObjetoExpedienteInsideIndiceContenido) elementoIndizado1;
        ObjetoExpedienteInsideIndiceContenido indiceContenido2 =
            (ObjetoExpedienteInsideIndiceContenido) elementoIndizado2;
        assertEqual(indiceContenido1, indiceContenido2);
      } else if (elementoIndizado1 instanceof ObjetoExpedienteInsideIndiceContenidoCarpetaIndizada
          && elementoIndizado2 instanceof ObjetoExpedienteInsideIndiceContenidoCarpetaIndizada) {
  ...
  public static void assertEqual(ObjetoDocumentoInside documento1, ObjetoDocumentoInside documento2,
      boolean checkContenidoFirma, boolean checkContenidoFirmaDocumento) throws AssertionError {
    ...
    if (!StringUtils.equals(documento1.getIdentificadorRepositorio(),
        documento2.getIdentificadorRepositorio())) {
      throw new AssertionError("No coincide el identificador del repositorio");
    }
  ...
  private static void assertEqual(ObjetoDocumentoInsideContenido contenido1,
    ...
    if (contenido1 != null && contenido2 != null) {
      ...
      if (checkContenidoFirmaDocumento
          && contenido1.getValorBinario() != contenido2.getValorBinario()) {
   ...
   */
  public static void assertEqual(ObjetoExpedienteInsideMetadatos metadatosExp1,
      ObjetoExpedienteInsideMetadatos metadatosExp2) {
    if (metadatosExp1 != null && metadatosExp2 != null) {
      assertEqual(metadatosExp1.getFechaAperturaExpediente(),
          metadatosExp2.getFechaAperturaExpediente());
      ...
      if (!StringUtils.equals(metadatosExp1.getIdentificadorObjetoInside(),
          metadatosExp2.getIdentificadorObjetoInside())) {
   ...
   */
  public static void assertEqual(ObjetoDocumentoInsideMetadatos metadatosDoc1,
      ObjetoDocumentoInsideMetadatos metadatosDoc2) {
    if (metadatosDoc1 != null && metadatosDoc2 != null) {
      ...
      if (!StringUtils.equals(metadatosDoc1.getIdentificadorObjetoInside(),
          metadatosDoc2.getIdentificadorObjetoInside())) {
  ...
  private static void assertEqual(
    ...
    if (estadoElaboracion1 != null && estadoElaboracion2 != null) {
      if (!StringUtils.equals(estadoElaboracion1.getIdentificadorDocumentoOrigen(),
          estadoElaboracion2.getIdentificadorDocumentoOrigen())) {
        throw new AssertionError("No coincide el identificador de documento de origen");
      }
      if (estadoElaboracion1.getValorEstadoElaboracion()
          .compareTo(estadoElaboracion2.getValorEstadoElaboracion()) != 0) {
   ...
   */
  public static void assertEqual(ObjetoInsideVersion version1, ObjetoInsideVersion version2)
      throws AssertionError {
   ...
   */
  public static void assertEqual(FirmaInside firma1, FirmaInside firma2,
      boolean checkContenidoFirma) throws AssertionError {
  ...
  private static void assertEqual(ContenidoFirmaInside contenidoFirma1,
      ContenidoFirmaInside contenidoFirma2, boolean checkContenidoFirma) throws AssertionError {
    if (contenidoFirma1 != null && contenidoFirma2 != null) {
      if (contenidoFirma1.getClass() == contenidoFirma2.getClass()) {
        if (contenidoFirma1 instanceof ContenidoFirmaCertificadoAlmacenableInside) {
          ContenidoFirmaCertificadoAlmacenableInside contenidofirmaAlmacenable1 =
              (ContenidoFirmaCertificadoAlmacenableInside) contenidoFirma1;
          ContenidoFirmaCertificadoAlmacenableInside contenidofirmaAlmacenable2 =
              (ContenidoFirmaCertificadoAlmacenableInside) contenidoFirma2;

          if (!StringUtils.equals(contenidofirmaAlmacenable1.getIdentificadorRepositorio(),
              contenidofirmaAlmacenable2.getIdentificadorRepositorio())) {
            throw new AssertionError("No coincide el identificador del repositorio de las firmas");
          }
          if (!StringUtils.equals(contenidofirmaAlmacenable1.getMime(),
              contenidofirmaAlmacenable2.getMime())) {
            throw new AssertionError("No coincide el tipo mime de las firmas");
          }
          if (checkContenidoFirma && contenidofirmaAlmacenable1
              .getValorBinario() != contenidofirmaAlmacenable2.getValorBinario()) {
          ...
          ContenidoFirmaCertificadoReferenciaInside contenidofirmaReferencia1 =
              (ContenidoFirmaCertificadoReferenciaInside) contenidoFirma1;
          ContenidoFirmaCertificadoReferenciaInside contenidofirmaReferencia2 =
              (ContenidoFirmaCertificadoReferenciaInside) contenidoFirma2;
          if (!StringUtils.equals(contenidofirmaReferencia1.getReferenciaFirma(),
              contenidofirmaReferencia2.getReferenciaFirma())) {
          ...
          if (!StringUtils.equals(contenidofirmaCsv1.getRegulacionGeneracionCSV(),
              contenidofirmaCsv2.getRegulacionGeneracionCSV())) {
            throw new AssertionError("No coincide la regulación del CSV");
          }
          if (!StringUtils.equals(contenidofirmaCsv1.getValorCSV(),
              contenidofirmaCsv2.getValorCSV())) {
            throw new AssertionError("No coincide el valor del CSV");
          }
        } else {
          throw new AssertionError(
              "No sé comparar contenidos de firmas de tipo" + contenidoFirma1.getClass());
        }
      } else {
   ...
   */
  public static void assertEqual(Calendar fecha1, Calendar fecha2) throws AssertionError {
  ...
  private static void assertEqual(Map<String, ObjetoInsideMetadatoAdicional> metadatosAdicionales,
