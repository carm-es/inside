...
public class InsideObjectConverterTest<T extends ObjetoInside<?>> extends InSideServiceTestBase {
  ...
  public void testObjetoDocumentoInsideToRepository() throws InSideServiceException {
    ...
    try {
      ...
      if (contenidoFirma instanceof ContenidoFirmaCertificadoContenidoBinarioInside) {
        Assert.assertNotNull(((ContenidoFirmaCertificadoContenidoBinarioInside) contenidoFirma)
            .getIdentificadorRepositorio());
        idFirma = ((ContenidoFirmaCertificadoContenidoBinarioInside) contenidoFirma)
            .getIdentificadorRepositorio();
      } else {
        throw new AssertionError(
            "El contenido de la firma no es de tipo ContenidoFirmaCertificadoContenidoBinarioInside");
      }
  ...
  public void testObjetoDocumentoInsideFromRepository() throws InSideServiceException {
    ...
    try {
      ...
      if (contenidoFirmaSalida instanceof ContenidoFirmaCertificadoContenidoBinarioInside) {
        Assert
            .assertNotNull(((ContenidoFirmaCertificadoContenidoBinarioInside) contenidoFirmaSalida)
                .getValorBinario());
      } else {
        throw new AssertionError(
            "El contenido de la firma no es de tipo ContenidoFirmaCertificadoContenidoBinarioInside");
  ...
  public void testObjetoExpedienteInsideFromRepository() throws InSideServiceException {
    ...
    try {
      ObjetoExpedienteInside salida =
          (ObjetoExpedienteInside) convierteObjetoInside(entrada, "from");
      ...
      Assert.assertArrayEquals(interesados.toArray(),
          salida.getMetadatos().getInteresado().toArray());
    } catch (Exception e) {
      e.printStackTrace();
      Assert.assertTrue(false);
    }
  ...
  private ObjetoInside<?> convierteObjetoInside(
      @SuppressWarnings("rawtypes") ObjetoInside objetoInside, String fromTo)
      throws InSideServiceException {
    @SuppressWarnings("rawtypes")
    ObjetoInside salida = null;
    try {
      if (StringUtils.equalsIgnoreCase("from", fromTo)) {
        salida = objectDefinitions.getConverter(objetoInside.getClass())
            .fromRepository((T) objetoInside);
      } else if (StringUtils.equalsIgnoreCase("to", fromTo)) {
        salida =
            objectDefinitions.getConverter(objetoInside.getClass()).toRepository((T) objetoInside);
      }
