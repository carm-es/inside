...
public interface GInsideOperationWebService {
  ...
  public DocumentoEniFileInside convertirDocumentoAEni(TipoDocumentoConversionInside documento,
      byte[] contenido, Boolean firmar, WSCredentialInside credentialUtil) throws InsideWSException;
  ...
  public TipoResultadoValidacionExpedienteInside validarExpedienteEniFile(
      TipoExpedienteValidacionInside expediente, WSCredentialInside credentialUtil)
      throws InsideWSException;

  public TipoResultadoValidacionDocumentoInside validarDocumentoEniFile(
      TipoDocumentoValidacionInside documento, WSCredentialInside credentialUtil)
      throws InsideWSException;

  public TipoResultadoVisualizacionDocumentoInside visualizarDocumentoEni(
      TipoDocumentoVisualizacionInside documento, WSCredentialInside credentialUtil)
      throws InsideWSException;
