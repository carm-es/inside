...
@WebService(name = "InSideWebService",
...
public interface InsideCredentialWebService {
  ...
  public ExpedienteInsideInfo altaExpedienteEni(@WebParam(name = "credential",
  ...
  @WebResult(name = "ExpedienteInsideInfo", partName = "ExpedienteInsideInfo",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/expediente-e/expedienteInfo")
  public ExpedienteInsideInfo altaExpedienteEniXml(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
  ...
  @WebResult(name = "ExpedienteInsideInfo", partName = "ExpedienteInsideInfo",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/expediente-e/expedienteInfo")
  public ExpedienteInsideInfo cambiaMetadatosExpediente(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
  ...
  public DocumentoInsideInfo cambiaMetadatosDocumento(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "identificador") @XmlElement(required = true,
          name = "identificador") String identificador,
  ...
  @WebResult(name = "ExpedienteInsideInfo", partName = "ExpedienteInsideInfo",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/expediente-e/expedienteInfo")
  public ExpedienteInsideInfo modificaExpedienteEni(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "expediente") @XmlElement(required = true,
          name = "expediente") TipoExpediente expediente,
  ...
  @WebResult(name = "ExpedienteInsideInfo", partName = "ExpedienteInsideInfo",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/expediente-e/expedienteInfo")
  public ExpedienteInsideInfo altaCarpetaEnExpediente(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
  ...
  @WebResult(name = "ExpedienteInsideInfo", partName = "ExpedienteInsideInfo",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/expediente-e/expedienteInfo")
  public ExpedienteInsideInfo borrarCarpetaEnExpediente(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "identificadorExpediente") @XmlElement(required = true,
          name = "identificadorExpediente") String identificadorExpediente,
  ...
  @WebResult(name = "ExpedienteInsideInfo", partName = "ExpedienteInsideInfo",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/expediente-e/expedienteInfo")
  public ExpedienteInsideInfo cambiaEstadoExpediente(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "identificador") @XmlElement(required = true,
          name = "identificador") String identificador,
  ...
  @WebResult(name = "ExpedienteInsideInfo", partName = "ExpedienteInsideInfo",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/expediente-e/expedienteInfo")
  public ExpedienteInsideInfo importarExpediente(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "identificador") @XmlElement(required = true,
          name = "identificador") String identificador,
  ...
  @WebResult(name = "ExpedienteInsideInfo", partName = "ExpedienteInsideInfo",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/expediente-e/expedienteInfo")
  public ExpedienteInsideInfo vincularExpediente(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "identificador") @XmlElement(required = true,
          name = "identificador") String identificador,
  ...
  @WebResult(name = "ExpedienteInsideInfo", partName = "ExpedienteInsideInfo",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/expediente-e/expedienteInfo")
  public ExpedienteInsideInfo crearVistaAbiertaExpediente(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "identificador") @XmlElement(required = true,
          name = "identificador") String identificador)
  ...
  @WebResult(name = "ExpedienteInsideInfo", partName = "ExpedienteInsideInfo",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/expediente-e/expedienteInfo")
  public ExpedienteInsideInfo crearVistaCerradaExpediente(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "identificador") @XmlElement(required = true,
          name = "identificador") String identificador)
  ...
  @WebResult(name = "ExpedienteInsideInfo", partName = "ExpedienteInsideInfo",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/expediente-e/expedienteInfo")
  public ExpedienteInsideInfo vincularDocumentosEnExpediente(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "identificador") @XmlElement(required = true,
          name = "identificador") String identificador,
  ...
  @WebResult(name = "ExpedienteInsideInfo", partName = "ExpedienteInsideInfo",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/expediente-e/expedienteInfo")
  public ExpedienteInsideInfo desvincularDocumentosEnExpediente(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "identificador") @XmlElement(required = true,
          name = "identificador") String identificador,
  ...
  @WebResult(name = "ExpedienteInsideInfo", partName = "ExpedienteInsideInfo",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/expediente-e/expedienteInfo")
  public ExpedienteInsideInfo cambiarUbicacionEnExpediente(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "identificadorExpediente") @XmlElement(required = true,
          name = "identificadorExpediente") String identificadorExpediente,
  ...
  public TipoExpedienteInside getExpediente(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "identificador") @XmlElement(required = true,
          name = "identificador") String identificador,
  ...
  public TipoExpediente getExpedienteEni(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "identificador") @XmlElement(required = true,
          name = "identificador") String identificador)
  ...
  public TipoExpedienteEniFileInside getExpedienteEniFile(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "identificador") @XmlElement(required = true,
          name = "identificador") String identificador,
  ...
  /*
   * @WebMethod(operationName = "getFicheroFoliado", action = "urn:getFicheroFoliado")
   * 
   * @WebResult(name = "ficheroFoliado", partName = "ficheroFoliado") public TipoContenido
   * getFicheroFoliado(
   * 
   ...
   * (required = true, name = "credential") WSCredentialInside info,
   * 
   * @WebParam(name = "identificador") @XmlElement(required = true, name = "identificador") String
   * identificador) throws InsideWSException;
   */
  ...
  public TipoIndice getIndiceExpediente(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "identificador") @XmlElement(required = true,
          name = "identificador") String identificador)
  ...
  public ExpedienteInsideMetadatos getExpedienteMetadatos(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "identificador") @XmlElement(required = true,
          name = "identificador") String identificador,
  ...
  public List<TipoVersionInside> getVersionesExpediente(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "identificador") @XmlElement(required = true,
          name = "identificador") String identificador)
  ...
  @WebResult(name = "DocumentoInsideInfo", partName = "DocumentoInsideInfo",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/documento-e/documentoInfo")
  public DocumentoInsideInfo altaDocumentoOriginal(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
  ...
  @WebResult(name = "DocumentoInsideInfo", partName = "DocumentoInsideInfo",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/documento-e/documentoInfo")
  public DocumentoInsideInfo altaDocumentoDigitalizado(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "documento") @XmlElement(required = true,
          name = "documento") TipoDocumentoAltaInside documento)
  ...
  @WebResult(name = "DocumentoInsideInfo", partName = "DocumentoInsideInfo",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/documento-e/documentoInfo")
  public DocumentoInsideInfo altaDocumentoCopiaParcial(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "documento") @XmlElement(required = true,
          name = "documento") TipoDocumentoAltaInside documento,
  ...
  @WebResult(name = "DocumentoInsideInfo", partName = "DocumentoInsideInfo",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/documento-e/documentoInfo")
  public DocumentoInsideInfo altaDocumentoCambioFormato(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "documento") @XmlElement(required = true,
          name = "documento") TipoDocumentoAltaInside documento,
  ...
  @WebResult(name = "DocumentoInsideInfo", partName = "DocumentoInsideInfo",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/documento-e/documentoInfo")
  public DocumentoInsideInfo altaDocumentoOtros(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "documento") @XmlElement(required = true,
          name = "documento") TipoDocumentoAltaInside documento)
  ...
  @WebResult(name = "DocumentoInsideInfo", partName = "DocumentoInsideInfo",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/documento-e/documentoInfo")
  public DocumentoInsideInfo altaDocumentoEni(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "documento") @XmlElement(required = true,
  ...
  @WebResult(name = "DocumentoInsideInfo", partName = "DocumentoInsideInfo",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/documento-e/documentoInfo")
  public DocumentoInsideInfo altaDocumentoEniXml(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
  ...
  @WebResult(name = "DocumentoInsideInfo", partName = "DocumentoInsideInfo",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/documento-e/documentoInfo")
  public DocumentoInsideInfo modificaDocumento(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "documento") @XmlElement(required = true,
          name = "documento") TipoDocumento documento,
  ...
  public TipoDocumentoInside getDocumento(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "identificador") @XmlElement(required = true,
          name = "identificador") String identificador)
  ...
  public TipoDocumento getDocumentoEni(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "identificador") @XmlElement(required = true,
          name = "identificador") String identificador)
  ...
  public TipoDocumentoEniFileInside getDocumentoEniFile(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "identificador") @XmlElement(required = true,
          name = "identificador") String identificador)
  ...
  public TipoContenido getDocumentoContenido(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "identificador") @XmlElement(required = true,
          name = "identificador") String identificador)
  ...
  public DocumentoInsideMetadatos getMetadatosDocumento(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "identificador") @XmlElement(required = true,
          name = "identificador") String identificador)
  ...
  @WebResult(name = "numeroBytes", partName = "numeroBytes",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/version")
  public Integer getNumeroBytesDocumentoFirmado(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "identificador") @XmlElement(required = true,
          name = "identificador") String identificador)
  ...
  public Firmas getFirmasEniCSVDocumento(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "identificador") @XmlElement(required = true,
          name = "identificador") String identificador)
  ...
  public ExpedienteResultadoBusqueda buscarExpedientes(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
  ...
  @WebResult(name = "resultados", partName = "resultados",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/busqueda/resultados")
  public DocumentoResultadoBusqueda buscarDocumentos(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "consulta") @XmlElement(required = true,
          name = "consulta") ConsultaWsInside consulta,
  ...
  public DocumentoEniFileInside convertirDocumentoAEni(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "documento") @XmlElement(required = true,
          name = "documento") TipoDocumentoConversionInside documento,
  ...
  public ExpedienteEniFileInside convertirExpedienteAEni(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "expediente") @XmlElement(required = true,
  ...
  public void eliminarDocumento(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "identificador") @XmlElement(required = true,
          name = "identificador") String identificador)
  ...
  public void eliminarExpediente(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "identificador") @XmlElement(required = true,
          name = "identificador") String identificador)
  ...
  @WebResult(name = "expediente", partName = "expediente",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/expediente-e/expedienteInfo")
  public List<ExpedienteInsideInfo> expedientesAsociadoDocumento(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "identificador") @XmlElement(required = true,
          name = "identificador") String identificador)
  ...
  public TipoResultadoVisualizacionDocumentoInside visualizarDocumento(@WebParam(
      name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "identificador") @XmlElement(required = true,
