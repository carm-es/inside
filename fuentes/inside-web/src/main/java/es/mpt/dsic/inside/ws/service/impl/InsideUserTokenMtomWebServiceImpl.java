...
@WebService(endpointInterface = "es.mpt.dsic.inside.ws.service.InsideUserTokenMtomWebService",
    targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService",
    portName = "InsideUserTokenMtomWSPort", serviceName = "InsideUserTokenMtomWS")
public class InsideUserTokenMtomWebServiceImpl implements InsideUserTokenMtomWebService {
  ...
  public TipoExpedienteInsideMtom getExpediente(String identificador, Integer version)
      throws InsideWSException {
    try {
      return InsideConverterMtom.tipoExpedienteInsideToMtom(insideOperationWebService
          .getExpediente(identificador, version, credentialUtil.getAppLogged()));
    } catch (Exception e) {
      throw InsideExceptionConverter.convertToException(e);
    }
  }
  ...
  @Override
  @Secured("ROLE_LEER_EXPEDIENTE")
  public TipoExpedienteEniFileInsideMtom getExpedienteEniFile(String identificador,
    ...
    try {
      return InsideConverterMtom.tipoExpedienteEniFileToMtom(insideOperationWebService
          .getExpedienteEniFile(identificador, visualizacionIndice, credentialUtil.getAppLogged()));
    } catch (Exception e) {
      throw InsideExceptionConverter.convertToException(e);
    }
  ...
  public DocumentoInsideInfo altaDocumentoOriginal(TipoDocumentoAltaInsideMtom documento)
      throws InsideWSException {
    try {
  ...
  @Override
  @Secured("ROLE_ALTA_DOCUMENTO")
  public DocumentoInsideInfo altaDocumentoDigitalizado(TipoDocumentoAltaInsideMtom documento)
      throws InsideWSException {
    try {
      TipoDocumentoAltaInside documentoAlta =
          InsideConverterMtom.mtomTipoDocumentoAltaToInside(documento);
  ...
  @Override
  @Secured("ROLE_ALTA_DOCUMENTO")
  public DocumentoInsideInfo altaDocumentoOtros(TipoDocumentoAltaInsideMtom documento)
      throws InsideWSException {
    try {
      TipoDocumentoAltaInside documentoAlta =
          InsideConverterMtom.mtomTipoDocumentoAltaToInside(documento);
  ...
  public DocumentoInsideInfo modificaDocumento(TipoDocumentoMtom documentoMtom,
      TipoMetadatosAdicionales metadatosAdicionales) throws InsideWSException {
    try {
  ...
  public TipoDocumentoMtom getDocumentoEni(String identificador) throws InsideWSException {
    try {
      return InsideConverterMtom.tipoDocumentoToMtom(
          insideOperationWebService.getDocumentoEni(identificador, credentialUtil.getAppLogged()));
    } catch (Exception e) {
      throw InsideExceptionConverter.convertToException(e);
    }
  }
  ...
  @Override
  @Secured("ROLE_LEER_DOCUMENTO")
  public TipoDocumentoEniFileInsideMtom getDocumentoEniFile(String identificador)
      throws InsideWSException {
    try {
      return InsideConverterMtom.tipoDocumentoEniFileToMtom(insideOperationWebService
          .getDocumentoEniFile(identificador, credentialUtil.getAppLogged()));
    } catch (Exception e) {
      throw InsideExceptionConverter.convertToException(e);
    }
  }
  ...
  public TipoContenidoMtom getDocumentoContenido(String identificador) throws InsideWSException {
    try {
      return InsideConverterMtom.tipoContenidoToMtom(insideOperationWebService
          .getDocumentoContenido(identificador, credentialUtil.getAppLogged()));
    } catch (Exception e) {
      throw InsideExceptionConverter.convertToException(e);
    }
  }
    ...
    try {
      ...
      return InsideConverterMtom.tipoDocumentoToMtom(
          (insideOperationWebService.convertirDocumentoAEni(documentoConversion, bytesContenido,
              firmar, credentialUtil.getCredentialEeutilUserToken(wsContext)).getDocumento()));
    } catch (Exception e) {
      throw InsideExceptionConverter.convertToException(e);
    }
  }
  ...
  public TipoExpedienteMtom convertirExpedienteAEni(
    ...
    try {
      return InsideConverterMtom.tipoExpedienteToMtom(
          (insideOperationWebService.convertirExpedienteAEni(expedienteConversion, contenidoFirma,
  ...
  @Override
  @Secured("ROLE_LEER_DOCUMENTO")
  public TipoResultadoVisualizacionDocumentoInsideMtom visualizarDocumento(String identificador)
      throws InsideWSException {
    try {
      return InsideConverterMtom.tipoResultadoVisualizacionDocumentoToMtom(insideOperationWebService
          .visualizarDocumento(identificador, credentialUtil.getAppLogged()));
    } catch (Exception e) {
      throw InsideExceptionConverter.convertToException(e);
    }
  }
