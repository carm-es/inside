...
public class GInsideOperationWebServiceImpl implements GInsideOperationWebService {
  ...
  public DocumentoEniFileInside convertirDocumentoAEni(TipoDocumentoConversionInside documento,
      byte[] contenido, Boolean firmar, WSCredentialInside credentialUtil)
    ...
    try {
      ...
      TipoDocumentoInsideConMAdicionales tDocAdicionales =
          insideUtilService.convertirDocumentoAEniConMAdicionales(documento, metadatosAdicionales,
              contenido, BooleanUtils.toBoolean(firmar), credentialUtil);

      if (!insideUtilService
          .esLongitudIdentificadorValido(tDocAdicionales.getDocumento().getId())) {
        throw new InsideWSException(InsideWsErrors.IDENTIFICADOR_DOCUMENTO_LONGITUD, null, "");
      }
    ...
    try {
      ...
      TipoExpedienteInsideConMAdicionales tExp =
          insideUtilService.convertirExpedienteAEniConMAdicionales(expediente, metadatosAdicionales,
              contenidoFirma, true, credentialUtil);
  ...
  public ExpedienteEniFileInside convertirExpedienteAEniAutocontenido(
      TipoExpedienteConversionInsideWS expediente, String contenidoFirma,
    ...
    try {
      ...
      TipoExpedienteConversionInside expConvert =
          InsideConverterTipoExpedienteConversion.convertTipoExpedienteFromWS(expediente);
      TipoExpediente expedienteEni = insideUtilService.convertirExpedienteAEni(expConvert,
          contenidoFirma, true, credentialUtil);
  ...
  public ExpedienteEniFileInsideConMAdicionales convertirExpedienteAEniConMAdicionalesAutocontenido(
    ...
    try {
      logger.debug(
          "Inicio GInSideWebServiceImpl.convertirExpedienteAEniConMAdicionalesAutocontenido");
      ExpedienteEniFileInsideConMAdicionales retorno = new ExpedienteEniFileInsideConMAdicionales();
      TipoExpedienteConversionInside expConvert =
          InsideConverterTipoExpedienteConversion.convertTipoExpedienteFromWS(expediente);


      TipoExpedienteInsideConMAdicionales expedienteEni =
          insideUtilService.convertirExpedienteAEniConMAdicionales(expConvert, metadatosAdicionales,
              contenidoFirma, true, credentialUtil);
      ...
      byte[] expediente_Despues_Transformacion =
          transformarExpedienteParaValidarFirma(expedienteEni);
      retorno.setExpedienteEniBytes(expediente_Despues_Transformacion);
  ...
  public TipoResultadoValidacionExpedienteInside validarExpedienteEniFile(
      TipoExpedienteValidacionInside expedienteValidacion, WSCredentialInside credentialUtil)
      throws InsideWSException {
    ...
    try {
      ...
      TipoResultadoValidacionExpedienteInside expedientiEniFile =
          insideUtilService.validarExpedienteEniFile(expedienteValidacion, false);
  ...
  public TipoResultadoValidacionDocumentoInside validarDocumentoEniFile(
      TipoDocumentoValidacionInside documentoValidacion, WSCredentialInside credentialUtil)
      throws InsideWSException {
    try {
      logger.debug("Iniciado validarDocumentoEniFile en WS");

      TipoResultadoValidacionDocumentoInside documentoEniFile =
          insideUtilService.validarDocumentoEniFile(documentoValidacion);
  ...
  public TipoResultadoVisualizacionDocumentoInside visualizarDocumentoEni(
      TipoDocumentoVisualizacionInside documentoVisualizacion, WSCredentialInside credentialUtil)
      throws InsideWSException {

    try {
      logger.debug("Inicio operación visualizarDocumentoEni");

      TipoResultadoVisualizacionDocumentoInside documentoEni =
          insideUtilService.visualizarDocumentoEni(documentoVisualizacion);
