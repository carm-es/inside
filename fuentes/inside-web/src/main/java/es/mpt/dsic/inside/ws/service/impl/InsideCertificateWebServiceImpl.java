...
import es.mpt.dsic.inside.ws.service.InsideCertificateWebService;
...
@WebService(endpointInterface = "es.mpt.dsic.inside.ws.service.InsideCertificateWebService", targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService", portName = "InsideCertificateWSPort", serviceName = "InsideCertificateWS")
public class InsideCertificateWebServiceImpl implements InsideCertificateWebService {
	protected static final Log logger = LogFactory.getLog(InsideCertificateWebServiceImpl.class);
	...
	public RespuestaRemisionAJusticiaType remisionAJusticia(PeticionRemisionAJusticiaType peticionRemisionAJusticiaType)
		...
		try {
			...
			ParametrosEnvioJusticia parametroMJU = servicioRemisionNube
					.getParametrosMJU(peticionRemisionAJusticiaType.getDatosRemisionJusticia(), peticionRemisionAJusticiaType.getDir3Juzgado());
