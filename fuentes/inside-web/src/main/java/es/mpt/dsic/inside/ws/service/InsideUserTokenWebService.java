...
@WebService(name = "InSideUserTokenWebService",
...
public interface InsideUserTokenWebService {
  ...
  public ExpedienteInsideInfo altaCarpetaEnExpediente(
      ...
      @WebParam(name = "carpetaIndizada") @XmlElement(required = true,
          name = "carpetaIndizada") TipoCarpetaIndizada identificadorCarpeta,
  ...
  @WebMethod(operationName = "consultaEstadoRemisionAJusticia",
      action = "urn:consultaEstadoRemisionAJusticia")
  @WebResult(name = "RespuestaConsultaEnvioJusticia", partName = "RespuestaConsultaEnvioJusticia",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/respuestaConsultaEnvioJusticia")
  public RespuestaConsultaEnvioJusticia consultaEstadoRemisionAJusticia(
      @WebParam(name = "codigoEnvioATEA") @XmlElement(required = true,
          name = "codigoEnvioATEA") String codigoEnvioATEA)
      throws InsideWSException;
