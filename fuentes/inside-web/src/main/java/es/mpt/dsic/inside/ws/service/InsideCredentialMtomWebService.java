...
@WebService(name = "InSideMtomWebService",
...
public interface InsideCredentialMtomWebService {
  ...
  public DocumentoInsideInfo altaDocumentoOriginal(@WebParam(name = "credential",
      ...
      @WebParam(name = "documento") @XmlElement(required = true,
          name = "documento") TipoDocumentoAltaInsideMtom documentoMtom)
  ...
  public TipoDocumentoMtom convertirDocumentoAEni(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "documento") @XmlElement(required = true,
          name = "documento") TipoDocumentoConversionInsideMtom documentoMtom,
  ...
  public DocumentoInsideInfo altaDocumentoEni(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "documento") @XmlElement(required = true,
          name = "documento") TipoDocumentoMtom documentoMtom,
      @WebParam(name = "asociadoaExpediente") @XmlElement(required = false,
          name = "asociadoaExpediente") TipoDocumentoAsociadoaExpedienteMtom asociadoaExpediente,
  ...
  @WebResult(name = "documento", partName = "documento",
      targetNamespace = "http://administracionelectronica.gob.es/ENI/XSD/v1.0/documento-e")
  public TipoDocumentoMtom getDocumentoEni(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
  ...
  public TipoDocumentoEniFileInsideMtom getDocumentoEniFile(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "identificador") @XmlElement(required = true,
          name = "identificador") String identificador)
  ...
  public TipoExpedienteEniFileInsideMtom getExpedienteEniFile(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "identificador") @XmlElement(required = true,
          name = "identificador") String identificador,
  ...
  public ExpedienteInsideInfo altaExpedienteEni(@WebParam(name = "credential",
      ...
      @WebParam(name = "expediente") @XmlElement(required = true,
          name = "expediente") TipoExpedienteMtom expedienteMtom,
      @WebParam(name = "metadatosAdicionales") @XmlElement(required = false,
          name = "metadatosAdicionales") TipoMetadatosAdicionales metadatosAdicionales)
      throws InsideWSException;
  ...
  public TipoExpedienteMtom getExpedienteEni(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "identificador") @XmlElement(required = true,
          name = "identificador") String identificador)
  ...
  @WebResult(name = "expediente", partName = "expediente",
      targetNamespace = "http://administracionelectronica.gob.es/ENI/XSD/v1.0/expediente-e")
  public TipoExpedienteMtom convertirExpedienteAEni(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "expediente") @XmlElement(required = true,
  ...
  public TipoResultadoVisualizacionDocumentoInsideMtom visualizarDocumento(@WebParam(
      name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "identificador") @XmlElement(required = true,
  ...
  public TipoExpedienteInsideMtom getExpediente(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "identificador") @XmlElement(required = true,
          name = "identificador") String identificador,
  ...
  public TipoDocumentoInsideMtom getDocumento(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "identificador") @XmlElement(required = true,
          name = "identificador") String identificador)
  ...
  public TipoContenidoMtom getDocumentoContenido(@WebParam(name = "credential",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(
          required = true, name = "credential") WSCredentialInside info,
      @WebParam(name = "identificador") @XmlElement(required = true,
          name = "identificador") String identificador)
