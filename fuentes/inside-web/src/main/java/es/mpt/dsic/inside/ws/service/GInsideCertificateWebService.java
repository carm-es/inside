...
@WebService(name = "GInsideCertificateWebService",
...
public interface GInsideCertificateWebService {
  ...
  public ExpedienteEniFileInside convertirExpedienteAEniAutocontenido(
      @WebParam(name = "expediente") @XmlElement(required = true,
          name = "expediente") TipoExpedienteConversionInsideWS expediente,
      @WebParam(name = "contenidoFirma") @XmlElement(required = false,
          name = "contenidoFirma") String contenidoFirma)
      throws InsideWSException;
  ...
  public TipoResultadoValidacionExpedienteInside validarExpedienteEniFile(
      @WebParam(name = "expediente") @XmlElement(required = true,
          name = "expediente") TipoExpedienteValidacionInside expediente)
      throws InsideWSException;
  ...
  public TipoResultadoValidacionDocumentoInside validarDocumentoEniFile(
      @WebParam(name = "documento") @XmlElement(required = true,
          name = "documento") TipoDocumentoValidacionInside documento)
      throws InsideWSException;
  ...
  public TipoResultadoVisualizacionDocumentoInside visualizarDocumentoEni(
      @WebParam(name = "documento") @XmlElement(required = true,
          name = "documento") TipoDocumentoVisualizacionInside documento)
      throws InsideWSException;
