...
@WebService(endpointInterface = "es.mpt.dsic.inside.ws.service.InsideCredentialMtomWebService",
    targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService",
    portName = "InsideMtomWSPort", serviceName = "InsideMtomWS")
public class InsideCredentialMtomWebServiceImpl implements InsideCredentialMtomWebService {
  ...
  public ExpedienteInsideInfo altaExpedienteEni(WSCredentialInside info,
      TipoExpedienteMtom expedienteEniMtom, TipoMetadatosAdicionales metadatosAdicionales)
      throws InsideWSException {
    try {
      TipoExpediente expedienteEni =
          InsideConverterMtom.mtomTipoExpedienteToInside(expedienteEniMtom);
  ...
  public TipoExpedienteInsideMtom getExpediente(WSCredentialInside info, String identificador,
  ...
  @Override
  @Secured("ROLE_LEER_EXPEDIENTE")
  public TipoExpedienteMtom getExpedienteEni(WSCredentialInside info, String identificador)
      throws InsideWSException {
    try {
      return InsideConverterMtom.tipoExpedienteToMtom(
          insideOperationWebService.getExpedienteEni(identificador, info.getIdaplicacion()));
    } catch (Exception e) {
      throw InsideExceptionConverter.convertToException(e);
    }
  }
  ...
  @Override
  @Secured("ROLE_LEER_EXPEDIENTE")
  public TipoExpedienteEniFileInsideMtom getExpedienteEniFile(WSCredentialInside info,
      String identificador, Boolean visualizacionIndice) throws InsideWSException {
    try {
      return InsideConverterMtom.tipoExpedienteEniFileToMtom(insideOperationWebService
          .getExpedienteEniFile(identificador, visualizacionIndice, info.getIdaplicacion()));
    } catch (Exception e) {
      throw InsideExceptionConverter.convertToException(e);
    }
  ...
  public DocumentoInsideInfo altaDocumentoOriginal(WSCredentialInside info,
      TipoDocumentoAltaInsideMtom documento) throws InsideWSException {
    try {
      TipoDocumentoAltaInside documentoAlta =
          InsideConverterMtom.mtomTipoDocumentoAltaToInside(documento);
  ...
  public DocumentoInsideInfo altaDocumentoCopiaParcial(WSCredentialInside info,
      TipoDocumentoAltaInsideMtom documento, String identificadorDocumentoOrigen)
      throws InsideWSException {
    try {
      TipoDocumentoAltaInside documentoAlta =
          InsideConverterMtom.mtomTipoDocumentoAltaToInside(documento);
  ...
  public DocumentoInsideInfo altaDocumentoEni(WSCredentialInside info, TipoDocumentoMtom documento,
      TipoDocumentoAsociadoaExpedienteMtom asociadoAExpedienteMtom,
    ...
    try {
      ...
      return insideOperationWebService.altaDocumentoEni(documentoEni, expediente,
  ...
  public DocumentoInsideInfo modificaDocumento(WSCredentialInside info,
      TipoDocumentoMtom documentoMtom, TipoMetadatosAdicionales metadatosAdicionales)
      throws InsideWSException {
    try {
  ...
  public TipoDocumentoInsideMtom getDocumento(WSCredentialInside info, String identificador)
      throws InsideWSException {
    try {
      return InsideConverterMtom.tipoDocumentoInsideToMtom(
          insideOperationWebService.getDocumento(identificador, info.getIdaplicacion()));
    } catch (Exception e) {
      throw InsideExceptionConverter.convertToException(e);
    }
  }
  ...
  @Override
  @Secured("ROLE_LEER_DOCUMENTO")
  public TipoDocumentoMtom getDocumentoEni(WSCredentialInside info, String identificador)
      throws InsideWSException {
    try {
      return InsideConverterMtom.tipoDocumentoToMtom(
          insideOperationWebService.getDocumentoEni(identificador, info.getIdaplicacion()));
    } catch (Exception e) {
      throw InsideExceptionConverter.convertToException(e);
    }
  }
  ...
  @Override
  @Secured("ROLE_LEER_DOCUMENTO")
  public TipoDocumentoEniFileInsideMtom getDocumentoEniFile(WSCredentialInside info,
  ...
  @Override
  @Secured("ROLE_LEER_DOCUMENTO")
  public TipoContenidoMtom getDocumentoContenido(WSCredentialInside info, String identificador)
      throws InsideWSException {
    try {
      return InsideConverterMtom.tipoContenidoToMtom(
          insideOperationWebService.getDocumentoContenido(identificador, info.getIdaplicacion()));
    } catch (Exception e) {
      throw InsideExceptionConverter.convertToException(e);
    }
  }
  ...
  public TipoDocumentoMtom convertirDocumentoAEni(WSCredentialInside info,
      TipoDocumentoConversionInsideMtom documentoConversionMtom, byte[] bytesContenido,
      Boolean firmar) throws InsideWSException {
    try {
      TipoDocumentoConversionInside documentoConversion =
          InsideConverterMtom.mtomTipoDocumentoConversionToInside(documentoConversionMtom);
      return InsideConverterMtom.tipoDocumentoToMtom(
          (insideOperationWebService.convertirDocumentoAEni(documentoConversion, bytesContenido,
              firmar, info)).getDocumento());
    } catch (Exception e) {
      throw InsideExceptionConverter.convertToException(e);
    }
  }
  ...
  public TipoExpedienteMtom convertirExpedienteAEni(WSCredentialInside info,
      ...
      throws InsideWSException {
    try {
      return InsideConverterMtom.tipoExpedienteToMtom((insideOperationWebService
          .convertirExpedienteAEni(expedienteConversion, contenidoFirma, info)).getExpediente());
    } catch (Exception e) {
      throw InsideExceptionConverter.convertToException(e);
    }
  }
  ...
  @Override
  @Secured("ROLE_LEER_DOCUMENTO")
  public TipoResultadoVisualizacionDocumentoInsideMtom visualizarDocumento(WSCredentialInside info,
      String identificador) throws InsideWSException {
    try {
