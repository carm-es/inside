...
@WebService(name = "AdminWebService",
...
public interface AdminWebService {
  ...
  @WebResult(name = "Usuario", partName = "Usuario",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/usuario")
  public Usuario altaUsuario(@WebParam(name = "usuario",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/usuario") @XmlElement(
          required = true, name = "usuario") Usuario data)
      throws InsideWSException;

  @WebMethod(operationName = "bajaUsuario", action = "urn:bajaUsuario")
  @WebResult(name = "Usuario", partName = "Usuario",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/usuario")
  public Usuario bajaUsuario(@WebParam(name = "usuario",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/usuario") @XmlElement(
          required = true, name = "usuario") Usuario data)
      throws InsideWSException;
  ...
  @WebResult(name = "Aplicacion", partName = "Aplicacion",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/aplicacion")
  public Aplicacion bajaAplicacion(@WebParam(name = "aplicacion",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/aplicacion") @XmlElement(
          required = true, name = "aplicacion") Aplicacion data)
      throws InsideWSException;
  ...
  @WebResult(name = "Unidad", partName = "Unidad",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/unidad")
  public Unidad altaUnidadAplicacion(
      @WebParam(name = "nombreAplicacion") @XmlElement(required = true,
          name = "nombreAplicacion") String identificadorAplicacion,
      @WebParam(name = "codigoUnidadOrganica") @XmlElement(required = true,
          name = "codigoUnidadOrganica") String identificadorUnidad,
  ...
  public Unidad altaUnidadUsuario(
      @WebParam(name = "nifUsuario") @XmlElement(required = true,
          name = "nifUsuario") String identificadorUsuario,
      @WebParam(name = "codigoUnidadOrganica") @XmlElement(required = true,
          name = "codigoUnidadOrganica") String identificadorUnidad,
      @WebParam(name = "numeroProcedimiento") @XmlElement(required = false,
          name = "numeroProcedimiento") String numeroProcedimiento)
  ...
  @WebResult(name = "Unidad", partName = "Unidad",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/unidad")
  public List<Unidad> getUnidadesUsuario(@WebParam(name = "nifUsuario") @XmlElement(required = true,
      name = "nifUsuario") String identificadorUsuario) throws InsideWSException;
  ...
  @WebMethod(operationName = "comprobarDirectorioTemporal",
  ...
  @WebResult(name = "Aplicacion", partName = "Aplicacion",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/aplicacion")
  public Aplicacion actualizarCredencialesEeetuilApp(@WebParam(name = "aplicacion",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/aplicacion") @XmlElement(
          required = true, name = "aplicacion") Aplicacion data)
      throws InsideWSException;
  ...
  @WebResult(name = "UnidadAplicacionEeutil", partName = "UnidadAplicacionEeutil",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/unidadAplicacionEeutil")
  public UnidadAplicacionEeutil crearActualizarUnidadAplicacionEeutil(@WebParam(
      name = "unidadAplicacionEeutil",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/unidadAplicacionEeutil") @XmlElement(
          required = true, name = "unidadAplicacionEeutil") UnidadAplicacionEeutil data)
      throws InsideWSException;
  ...
  public List<UnidadAplicacionEeutil> getUnidadAplicacionEeutil(
      @WebParam(name = "codigoUnidadOrganica") @XmlElement(required = true,
          name = "codigoUnidadOrganica") String codigoUnidadOrganica)
      throws InsideWSException;

  @WebMethod(operationName = "crearActualizarSerialNumberCertificado",
      action = "urn:crearActualizarSerialNumberCertificado")
  @WebResult(name = "Aplicacion", partName = "Aplicacion",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/aplicacion")
  public Aplicacion crearActualizarSerialNumberCertificado(
      @WebParam(name = "idAplicacion") @XmlElement(required = true,
          name = "idAplicacion") String idAplicacion,
      @WebParam(name = "serialNumberCertificado") @XmlElement(required = true,
          name = "serialNumberCertificado") String serialNumberCertificado)
      throws InsideWSException;

  @WebMethod(operationName = "listaNumeroProcedimiento", action = "urn:listaNumeroProcedimiento")
  @WebResult(name = "numeroProcedimiento", partName = "numeroProcedimiento",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/numeroProcedimiento")
  ...
  public NumeroProcedimiento altaNumeroProcedimiento(
      @WebParam(name = "numeroProcedimiento") @XmlElement(required = true,
          name = "numeroProcedimiento") String numeroProcedimiento)
      throws InsideWSException;

  @WebMethod(operationName = "listaEstructuraCarpeta", action = "urn:listaEstructuraCarpeta")
  @WebResult(name = "estructuraCarpeta", partName = "estructuraCarpeta",
  ...
  public List<EstructuraCarpeta> listaEstructuraCarpeta(
      @WebParam(name = "identificadorEstructura") @XmlElement(required = false,
  ...
  public EstructuraCarpeta altaEstructuraCarpeta(
      @WebParam(name = "estructuraCarpeta") @XmlElement(required = true,
          name = "estructuraCarpeta") EstructuraCarpeta estructuraCarpeta)
      throws InsideWSException;
  ...
  @WebResult(name = "UsuarioResultadoBusqueda", partName = "UsuarioResultadoBusqueda",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/usuario")
  public UsuarioResultadoBusqueda listaUsuariosPaginado(
      @WebParam(name = "filterPageRequest",
          targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/filter") @XmlElement(
              required = false, name = "filterPageRequest") FilterPageRequest data)
      throws InsideWSException;

  @WebMethod(operationName = "actualizarUsuarioAdminMensajes",
      action = "urn:actualizarUsuarioAdminMensajes")
  @WebResult(name = "UsuarioAdminMensajes", partName = "UsuarioAdminMensajes",
      targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/usuario")
  public UsuarioAdminMensajes actualizarUsuarioAdminMensajes(
      @WebParam(name = "usuarioAdminMensajes",
          targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/usuario") @XmlElement(
              required = true,
              name = "usuarioAdminMensajes") UsuarioAdminMensajes usuarioAdminMensajes)
      throws InsideWSException;
