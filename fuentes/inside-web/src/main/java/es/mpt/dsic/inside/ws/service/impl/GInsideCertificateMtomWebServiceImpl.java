...
@WebService(endpointInterface = "es.mpt.dsic.inside.ws.service.GInsideCertificateMtomWebService",
    targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService",
    portName = "GInsideCertificateMtomWSPort", serviceName = "GInsideCertificateMtomWS")
public class GInsideCertificateMtomWebServiceImpl implements GInsideCertificateMtomWebService {
  ...
  public DocumentoEniFileInsideMtom convertirDocumentoAEni(
    ...
    try {
      ...
      DocumentoEniFileInside tDoc = gInsideOperationWebService.convertirDocumentoAEni(
          documentoConversion, getContent(contenido), firmar, credentialUtil.getCredentialEeutil());
  ...
  public DocumentoEniFileInsideConMAdicionalesMtom convertirDocumentoAEniConMAdicionales(
    ...
    try {
      ...
      DocumentoEniFileInsideConMAdicionales tDocAdicionales = gInsideOperationWebService
          .convertirDocumentoAEniConMAdicionales(documentoConversion, metadatosAdicionales,
  ...
  public ExpedienteEniFileInsideConMAdicionalesMtom convertirExpedienteAEniConMAdicionales(
    ...
    try {
      ...
      ExpedienteEniFileInsideConMAdicionales expedienteEniFile =
          gInsideOperationWebService.convertirExpedienteAEniConMAdicionales(expediente,
  ...
  public ExpedienteEniFileInsideConMAdicionalesMtom convertirExpedienteAEniConMAdicionalesAutocontenido(
    ...
    try {
      ...
      TipoExpedienteConversionInside expConvert =
          InsideConverterTipoExpedienteMtomConversion.convertTipoExpedienteFromWS(expediente);
      ExpedienteEniFileInsideConMAdicionales expedienteEniFile =
          gInsideOperationWebService.convertirExpedienteAEniConMAdicionales(expConvert,
              metadatosAdicionales, contenidoFirma, credentialUtil.getCredentialEeutil());
      logger.debug(
