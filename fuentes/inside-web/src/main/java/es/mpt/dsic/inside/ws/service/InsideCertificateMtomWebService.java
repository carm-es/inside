...
@WebService(name = "InSideCertificateMtomWebService",
...
public interface InsideCertificateMtomWebService {
  ...
  public TipoDocumentoMtom getDocumentoEni(@WebParam(name = "identificador") @XmlElement(
  ...
  public TipoExpedienteMtom getExpedienteEni(@WebParam(name = "identificador") @XmlElement(
      required = true, name = "identificador") String identificador) throws InsideWSException;
  ...
  public TipoDocumentoInsideMtom getDocumento(@WebParam(name = "identificador") @XmlElement(
      required = true, name = "identificador") String identificador) throws InsideWSException;
  ...
  public TipoContenidoMtom getDocumentoContenido(@WebParam(name = "identificador") @XmlElement(
      required = true, name = "identificador") String identificador) throws InsideWSException;
