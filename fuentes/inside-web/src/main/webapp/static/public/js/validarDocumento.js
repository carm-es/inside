...
$(document).ready(function() {
    configurarPlUploadValidarDocumento();
});

function configurarPlUploadValidarDocumento() {
    ...
    $.ajax({
        ...
        success : function(data) {
            ...
            if (data.mensajeUsuario != null) {
                ...
                $(data.resultado.validacionDetalle).each(
                        function(index, data) {
                            var divContent = "<div ";
                            if (data.resultadoValidacion) {
                                if (data.tipoValidacion) {
                                    divContent += 'class="fld mf-msg mf-msg__success">';
                                } else {
                                    divContent += 'class="fld mf-msg mf-msg__info">';
                                    data.tipoValidacion = 'Documento Eni + adicionales';
                                }
                            } else {
                                divContent += 'class="fld mf-msg mf-msg__error">'; //msg-error
                            }
                            var tipo = typeof ($('#' + data.tipoValidacion).val()) != 'undefined' ? $(
                                    '#' + data.tipoValidacion).val() : data.tipoValidacion;
