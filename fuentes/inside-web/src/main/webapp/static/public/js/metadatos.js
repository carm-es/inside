...
function removeMetadatoExp(position) {
    ...
    while (metadatosAdded - 1 > position) {
        ...
        $("#metadatosAdicionales.metadatoAdicional" + aux + ".nombre").setAttribute("name",
                "metadatosAdicionales.metadatoAdicional[" + position + "].nombre");
        $("#metadatosAdicionales.metadatoAdicional" + aux + ".nombre").setAttribute("id",
                "metadatosAdicionales.metadatoAdicional" + position + ".nombre");
        $("#metadatosAdicionales.metadatoAdicional" + aux + ".valor").setAttribute("name",
                "metadatosAdicionales.metadatoAdicional[" + position + "].valor");
        $("#metadatosAdicionales.metadatoAdicional" + aux + ".valor").setAttribute("id",
                "metadatosAdicionales.metadatoAdicional" + position + ".valor");
