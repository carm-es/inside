...
public class FolderCmisUtils {
	 ...
	 */
	public static boolean existPathInFolder(final Folder folder, final String path) throws CmisBaseException {
		return getFolderByPath(folder, path) != null;
	}

	/**
	 * Devuelve un folder con nombre igual al parámetro path, que esté dentro de la carpeta definida en el parámetro folder
	 ...
	 * @throws CmisBaseException
	 */
	public static Folder getFolderByPath(final Folder folder, final String path) throws CmisBaseException {
		if (logger.isDebugEnabled()) {
	 ...
	 * @throws CmisBaseException
	 */
	public static Folder createFolder(final Folder folder, final String name) throws CmisBaseException {
	...
	public static Folder createFolder(final Folder folder, final Map<String, Object> folderProperties)
			throws CmisBaseException {
		if (logger.isDebugEnabled()) {
			logger.debug(String.format("Creando '%s' (%s) en el folder %s", folderProperties.get(PropertyIds.NAME),
	...
	public static Folder createFolder (final Folder folder, final String folderId, 
			final String objectTypeId, final Map<String, Object> folderProperties) throws CmisBaseException{
