...
public class InsideObjectSignerTest <T extends ObjetoInside<?>> extends InSideServiceTestBase {
	...
	public void firmaDocumento () {
		...
		ObjetoDocumentoInside documento = UtilsTest.createObjetoDocumentoInside(true, true, true, false);
		...
		if(contenidoFirma instanceof ContenidoFirmaCertificadoContenidoBinarioInside){
			Assert.assertNotNull(((ContenidoFirmaCertificadoContenidoBinarioInside)contenidoFirma).getValorBinario());	
		}
	...
	private ObjetoInside<?> firmaObjetoInside (@SuppressWarnings("rawtypes") ObjetoInside objetoInside, String usuario) throws InSideServiceException{
