...
public class InsideObjectValidationTest <T extends ObjetoInside<?>> extends InSideServiceTestBase {
	...
	public void testObjetoExpedienteInside() throws InSideServiceException{
		...
		ObjetoExpedienteInside.getMetadatos().setEstado(ObjetoExpedienteInsideMetadatosEnumeracionEstados.E_01);
		
		ObjetoExpedienteInsideIndiceContenido contenidoIndice = ObjetoExpedienteInside.getIndice().getIndiceContenido();
	...
	public void testObjetoDocumentoInside() throws InSideServiceException{
		...
		ObjetoDocumentoInside.getMetadatos().setTipoDocumental(ObjetoDocumentoInsideMetadatosTipoDocumental.TD_01);
