...
/**
 * Un validador para metadatos boleanos
 * @author miguel.ortega
 *
 */
public class MetadatoValidatorBoolean implements MetatadatoValidator<Boolean>{

	@Override
	public Boolean clean(Boolean data)throws InSideServiceMetadatoValidationException {
		return data;
	}
