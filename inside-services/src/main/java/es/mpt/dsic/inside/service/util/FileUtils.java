...
public class FileUtils {
	...
	/**
	 * Obtiene una lista de los ficheros con una extensión dentro de un directorio.
	 * Si el directorio no se puede acceder, no existe o no contiene ficheros devuelve una lista vacía.
