...
public class InsideUtils {
	...
	/**
	 * Convierte un String delimitado por guiones bajos a su equivalente
	 * "camelizado" Ej: version_nti => versionNti
	 * 
	...
	/**
	 * Convierte un String "camelizado" a su equivalente delimitado por guiones
	 * bajos Ej versionNti => version_nti
	 * 
	...
	public static String getNombreFormatoByMime(String mime) {
		...
		if ("application/pdf".equalsIgnoreCase(mime)) {
			...
			nombreFormato = "RTF";
		} else if ("text/plain".equalsIgnoreCase(mime) || "application/octet-stream".equalsIgnoreCase(mime)) {
			nombreFormato = "TXT";
	 ...
	 * el mime de éste.
	 * 	Ficheros .pdf firma PADES
	 *  Ficheros .xml firma XADES Enveloped
	 *  Resto ficheros firma CADES Attached.
	 * 
	 * @param mime
	 * @return
	 */
	...
	/**
	 * Devuelve una cadena formada por la concatenación de los elementos de la
	 * lista, pasados a String. Cada elemento estará separado del siguiente por
	 * la cadena que se indique en el parámetro "sep". El parámetro sepFinal
	 * indica si se quiere meter también la cadena de separación al final. El
	 * parámetro notNull tomará valor true cuando se quiera que si la lista es
	...
	/**
	 * Se divide la lista en trozos (paginas), de un número de elementos
	 * concreto (elementosPorPagina). Se devuelve el "trozo" correspondiente al
	 * número de página indicado en el parámetro "pagina".
	 * 
	 * @param <T>
	 *            Tipo de los objetos de la lista
	 * @param lista
	 *            Lista de la que se quiere obtener una sublista.
	 * @param elementosPorPagina
	 *            Número de elementos por página
	 * @param pagina
	 *            Número de página que se quiere obtener.
	 * @return Si la lista es vacía, se devuelve la lista vacía. Si la página
	 *         pedida es mayor que el número real de página se devuelve la lista
	 *         vacía.
	 */
	...
	/**
	 * Comprueba si en la clase de un objeto existe el atributo que indique el
	 * parámetro "fieldName". Si no lo encuentra lo cameliza. Si no lo encuentra
	 * compara sin tener en cuenta mayúsculas y minúsculas.
	 * 
	 * @param objeto
	 * @param fieldName
	 * @return Devuelve el propertyDescriptor asociado al objeto y el atributo.
	 *         Null si ninguno coincide con el nombre.
	 */
	...
	public static byte[] generateZip(Map<String, byte[]> ficheros, String extension) throws IOException {
