...
public class InSideServicePermisosImpl implements InSideServicePermisos {
	...
	public <T extends ObjetoInside<?>> void checkPermisosWithValidateFlags(String identificador, Integer version, Class<T> tipo,
			String nombreAplicacion, boolean validateFlags) throws InSideServiceException {
	...
	@Override
	public <T extends ObjetoInside<?>> void checkPermisos(ResultadoBusquedaInside<?> datos, String nombreAplicacion)
	...
	private void checkPermiso(String nombreAplicacion, ObjetoInside<?> objeto, boolean online) throws InSideServiceException {
		...
		if (!validacion)
			throw new InsideStoreObjectPermisosException(nombreAplicacion, objeto.getIdentificador(), "Objeto sin permisos");
	}
}
