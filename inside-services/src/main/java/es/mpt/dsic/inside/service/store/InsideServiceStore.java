...
public interface InsideServiceStore {
	...
	public <T extends ObjetoInside<?>> T getObjectVersion(Class<T> tipo, final String Identifier, int version)
			throws InsideServiceStoreException, InsideStoreObjectNotFoundException;

	public <T extends ObjetoInside<K>, K extends ObjetoInsideMetadatos> K getObjectMetadatos(Class<T> tipo,
			final String Identifier) throws InsideServiceStoreException, InsideStoreObjectNotFoundException;

	public <T extends ObjetoInside<K>, K extends ObjetoInsideMetadatos> K getObjectMetadatos(Class<T> tipo,
			final String Identifier, int version) throws InsideServiceStoreException, InsideStoreObjectNotFoundException;
	...
	public <T extends ObjetoInside<?>> SortedMap<ObjetoInsideVersion, T> getVersionesObjeto(Class<T> tipo, String Identifier,
			Integer version) throws InsideServiceStoreException, InsideStoreObjectNotFoundException;
	...
	Object asociarObjetoUnidad(ObjetoInside<?> obj, String usuario, boolean online) throws InsideServiceStoreException;
	...
	boolean validarObjetoUnidad(ObjetoInside<?> obj, String usuario, boolean online) throws InsideServiceStoreException;
	...
	List<ObjetoInsideExpedienteUnidad> getExpedientesUnidadAutocompleter(String nif, boolean soloUnidadActiva)
			throws InsideServiceStoreException;

	List<ObjetoInsideDocumentoUnidad> getDocumentosUnidad(String nif, boolean soloUnidadActiva) throws InsideServiceStoreException;

	ObjetoExpedienteToken getTokenByUsuarioExpediente(ObjetoExpedienteToken data) throws InsideServiceStoreException;

	ObjetoExpedienteToken getTokenByData(ObjetoExpedienteToken usuarioToken) throws InsideServiceStoreException;

	void saveToken(ObjetoExpedienteToken usuarioToken) throws InsideServiceStoreException;

	void saveAuditoriaToken(ObjetoAuditoriaToken objectAuditoriaToken) throws InsideServiceStoreException;
	...
	ObjetoInsideAplicacion altaAplicacion(ObjetoInsideAplicacion data) throws InsideServiceStoreException;

	ObjetoInsideAplicacion bajaAplicacion(ObjetoInsideAplicacion data) throws InsideServiceStoreException;

	ObjetoInsideUnidad altaUnidadAplicacion(String idUnidad, String numeroProcedimiento, String idAplicacion)
			throws InsideServiceStoreException;

	void deleteUnidadAplicacion(String idUnidad, String numeroProcedimiento, String idAplicacion)
			throws InsideServiceStoreException;

	ObjetoInsideUnidad altaUnidadUsuario(String idUnidad, String numeroProcedimiento, String idUsuario)
			throws InsideServiceStoreException;

	void deleteUnidadUsuario(String idUnidad, String numeroProcedimiento, String idUsuario) throws InsideServiceStoreException;

	List<ObjetoInsideUnidad> getUnidadesAplicacion(String idAplicacion, boolean todas) throws InsideServiceStoreException;

	List<ObjetoInsideUnidad> getUnidadesUsuario(String idUsuario, boolean todas) throws InsideServiceStoreException;

	boolean comprobarUnidadesOrganicasActivasUsuario(Object usuario) throws InsideServiceStoreException;

	List<ObjetoInsideExpedienteUnidad> getViewsExpedient(String identificadorExpediente) throws InsideServiceStoreException;
	...
	void insertRespuestaRemisionJusticiaExpedienteNoInside(ObjectInsideRespuestaEnvioJusticia objectInsideRespuestaEnvioJusticia,
			String identificadorExpediente, String version) throws InsideServiceStoreException;

	ObjetoInsideAplicacion getAplicacionBySerialNumber(String serialNumberCertificado) throws InsideServiceStoreException;

	ObjetoInsideUnidadAplicacionEeutil getApplicationEeutilByUser(ObjetoInsideUsuario user) throws InsideServiceStoreException;

	ObjetoInsideUnidadAplicacionEeutil crearActualizarUnidadAplicacionEeutil(String codigoUnidad, String aplicacion,
			String password) throws InsideServiceStoreException;

	ObjetoInsideUnidadAplicacionEeutil getUnidadAplicacionEeutil(String codigoUnidad) throws InsideServiceStoreException;

	List<ObjetoInsideUnidadAplicacionEeutil> getListUnidadAplicacionEeutil() throws InsideServiceStoreException;
	...
	public ObjectInsideRespuestaEnvioJusticia getRespuestaEnvioJusticiaByCodigoEnvio(String codigoEnvio) throws InSideServiceException;
