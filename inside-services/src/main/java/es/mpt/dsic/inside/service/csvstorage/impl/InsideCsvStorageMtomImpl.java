...
public class InsideCsvStorageMtomImpl implements InsideCsvStorageMtomService {
	...
	public GuardarDocumentoResponse guardarDocumentoCsvStorage(String dir3, String idEni, byte[] contenido, String mimeType) throws CSVStorageException {
		...
		try {
			...
			configure();
			GuardarDocumentoMtomRequest guardarDocumentoRequest = crearPeticionDocumento(dir3, idEni, contenido, mimeType);
			...
			logger.error("No se puede crear la petición al csvStorage "
					+ properties.getProperty("csvstorage.url"), e);
		} 
	...
	@Override
	public GuardarDocumentoResponse guardarFirmaCsvStorage(String dir3, String idEni, byte[] contenido, String mimeType)
			throws CSVStorageException {
		logger.debug("Entra en guardarFirmaCsvStorage");
		
		configure();
		GuardarDocumentoMtomRequest guardarDocumentoRequest = crearPeticionFirma(idEni, dir3, contenido, mimeType);
		GuardarDocumento guardarDocumento = new GuardarDocumento();
		guardarDocumento.setCredential(getCredentials());
		guardarDocumento.setGuardarDocumentoRequest(guardarDocumentoRequest);
		
		GuardarDocumentoResponse response = this.csvDocumentMtomService.guardarDocumento(guardarDocumento);
	...
	@Override
	public GuardarDocumentoResponse modificarFirmaCsvStorage(String dir3, String idEni, byte[] contenido, String mimeType)
			throws CSVStorageException {
		...
		GuardarDocumentoResponse response = this.csvDocumentMtomService.modificarDocumento(modificarDocumento);
	...
	public DocumentoMtomResponse obtenerDocumentoCsvStorage(String identificador, String dir3)
		...
		configure();
		ObtenerDocumentoRequest peticion = this.crearPeticionObtenerDocumentoByDocumento(identificador, dir3);
		
		DocumentoMtomResponse documentoRecuperado = this.csvDocumentMtomService.obtenerDocumento(getCredentials(), peticion);
	...
	public DocumentoEniMtomResponse obtenerDocumentoEniCsvStorage(String identificador, String dir3)
		...
		logger.debug("Entra en obtenerDocumentoEniCsvStorage");
		configure();
		ObtenerDocumentoEniRequest peticion = this.crearPeticionObtenerDocumentoEniByDocumento(identificador, dir3);
		
		DocumentoEniMtomResponse documentoEniRecuperado = this.csvDocumentMtomService.obtenerDocumentoENI(getCredentials(), peticion);
		logger.debug("Sale de obtenerDocumentoEniCsvStorage");
	...
	public EliminarDocumentoResponse eliminarDocumento(String identificador, String dir3)
		...
		EliminarDocumentoResponse eliminarDocumentoResponse = this.csvDocumentMtomService.eliminarDocumento(eliminarDocumento);
	...
	private ObtenerDocumentoRequest crearPeticionObtenerDocumentoByDocumento(String nombreFirma, String dir3) {
	...
	private GuardarDocumentoMtomRequest crearPeticionDocumento(String dir3, String idEni, byte[] contenido, String mimeType) {
	...
	private GuardarDocumentoMtomRequest crearPeticionFirma(String id, String dir3, byte[] firma, String mimetype) {
	...
	private ObtenerDocumentoEniRequest crearPeticionObtenerDocumentoEniByDocumento(String identificador, String dir3) {
