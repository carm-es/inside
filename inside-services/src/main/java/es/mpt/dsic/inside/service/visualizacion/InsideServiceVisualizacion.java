...
public interface InsideServiceVisualizacion {
	...
	public ResultadoVisualizacionDocumento visualizacionDocumento(ObjetoDocumentoInside documento,
			OpcionesVisualizacionIndice opcionesVisualizacion, byte[] bytesContenido) throws InsideServiceVisualizacionException;

	public boolean isActivo();

	byte[] visualizarContenidoOriginal(ObjetoDocumentoInside documento) throws InsideServiceVisualizacionException;
	...
	TipoResultadoVisualizacionDocumentoInside visualizacionConPlantilla(String plantilla,
			TipoDocumentoVisualizacionInside tipoDocumentoVisualizacionInside) throws InsideServiceVisualizacionException;
}
