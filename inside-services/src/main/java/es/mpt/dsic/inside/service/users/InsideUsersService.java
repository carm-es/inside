...
package es.mpt.dsic.inside.service.users;
...
public interface InsideUsersService {
	...
	ObjetoInsideUsuario getUsuario(String nif) throws InsideUsersServiceException;
	
	ObjetoInsideAplicacion getAplicacionBySerialNumber(String serialNumberCertificado) throws InsideUsersServiceException;
