...
public class InsideStoreObjectNotFoundException extends InSideServiceRequestErrorException {
	...
	public <T extends ObjetoInside<?>> InsideStoreObjectNotFoundException(Class<T> tipo,String identificador) {
		super(generateMessage(tipo, identificador,""));
	}
	
	public <T extends ObjetoInside<?>> InsideStoreObjectNotFoundException(Class<T> tipo,String identificador,String message) {
	...
	protected static <T extends ObjetoInside<?>> String generateMessage(Class<T> tipo,String identificador,String message){
		return "No se encuentra el objeto de tipo " + tipo + " con identificador " + identificador + " " + message;
	}
