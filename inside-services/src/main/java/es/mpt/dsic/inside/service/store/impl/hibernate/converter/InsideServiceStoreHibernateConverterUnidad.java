...
public class InsideServiceStoreHibernateConverterUnidad<E extends Object> {
	...
	protected static final Log logger = LogFactory.getLog(InsideServiceStoreHibernateConverterUnidad.class);

	public static ObjetoInsideUnidad toInside(UnidadOrganica entity, String numeroProcedimiento, boolean activo) {
