...
public class InsideServiceDocumentoConverter
	...
	public ObjetoDocumentoInside fromRepository(ObjetoDocumentoInside objeto)
		...
		try {
			...
			throw new InsideServiceObjectConverterException("Excepción trasladando el documento electrónico al repositorio CSVSTORAGE",e);
		}
	...
	@Override
	/**
	 * Convierte un ObjetoDocumentoInside. El objeto de entrada debe contener metadatos.
	 * El objeto de salida tendrá relleno:
	 * 	- El identificador del documento, con el identificador del objeto de entrada.
	 * 	- El identificador del repositorio del documento, con el identificador de objeto .	  	
	 *  - Metadatos del documento, con los metadatos del del objeto de entrada.
	 *  - La versión del documento.
	 *  - Las firmas, con las firmas del objeto de entrada, EXCEPTO los bytes de la firma.
	 */
	...
	public ObjetoDocumentoInside delete(ObjetoDocumentoInside documento)
		...
		try {
			...
			throw new InsideServiceObjectConverterException("Excepción eliminando el documento electrónico del repositorio CSVSTORAGE",e);
		}
		return documento;
	}
