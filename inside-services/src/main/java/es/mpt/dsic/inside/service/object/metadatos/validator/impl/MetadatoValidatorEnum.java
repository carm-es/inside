...
//			throw new InSideServiceMetadatoValidationException ("El valor : " + data + " no está en el listado de valores permitidos");
//		}
//		
...
//	}
		...
		throws InSideServiceValidationException,InsideServiceMetadatoValueExtractionException
	{
		if (!valoresAdmitidos.contains(data.toString())) {
			throw new InSideServiceValidationException ("El valor : " + data + " no está en el listado de valores permitidos");
		}
