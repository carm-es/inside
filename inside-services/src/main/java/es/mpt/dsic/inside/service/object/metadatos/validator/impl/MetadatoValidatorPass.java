...
/**
 * Un validador para metadatos que nunca falla
 * @author miguel.ortega
 *
 */
public class MetadatoValidatorPass implements MetatadatoValidator<Object>{

	@Override
	public Object clean(Object data)throws InSideServiceMetadatoValidationException {
		return data;
	}
