...
public class EnviaSIA {
    ...
    public static class ACTUACIONES {
        ...
        public static class ACTUACION {
             ...
             * @return
             *     possible object is
             *     {@link EnviaSIA.ACTUACIONES.ACTUACION.TIPOSACTUACION }
             *     
             */
             ...
             * @return
             *     possible object is
             *     {@link EnviaSIA.ACTUACIONES.ACTUACION.ORGANISMORESPONSABLE }
             *     
             */
             ...
             *     
             */
            public void setORGANISMORESPONSABLE(EnviaSIA.ACTUACIONES.ACTUACION.ORGANISMORESPONSABLE value) {
             ...
             * @return
             *     possible object is
             *     {@link EnviaSIA.ACTUACIONES.ACTUACION.AMBITOSGEOGRAFICOS }
             *     
             */
             ...
             * @return
             *     possible object is
             *     {@link EnviaSIA.ACTUACIONES.ACTUACION.AQUIENESVADIRIGIDO }
             *     
             */
             ...
             *     
             */
            public void setSISTEMASIDENTIFICACION(EnviaSIA.ACTUACIONES.ACTUACION.SISTEMASIDENTIFICACION value) {
             ...
             * @return
             *     possible object is
             *     {@link EnviaSIA.ACTUACIONES.ACTUACION.VOLTRAMITACIONES }
             *     
             */
             ...
             * @return
             *     possible object is
             *     {@link EnviaSIA.ACTUACIONES.ACTUACION.CATALOGACIONES }
             *     
             */
            ...
            public static class AMBITOSGEOGRAFICOS {
                ...
                public List<EnviaSIA.ACTUACIONES.ACTUACION.AMBITOSGEOGRAFICOS.AMBITOGEOGRAFICO> getAMBITOGEOGRAFICO() {
                    if (ambitogeografico == null) {
                        ambitogeografico = new ArrayList<EnviaSIA.ACTUACIONES.ACTUACION.AMBITOSGEOGRAFICOS.AMBITOGEOGRAFICO>();
                    }
            ...
            public static class AQUIENESVADIRIGIDO {
                ...
                public List<EnviaSIA.ACTUACIONES.ACTUACION.AQUIENESVADIRIGIDO.AQUIENVADIRIGIDO> getAQUIENVADIRIGIDO() {
                    if (aquienvadirigido == null) {
                        aquienvadirigido = new ArrayList<EnviaSIA.ACTUACIONES.ACTUACION.AQUIENESVADIRIGIDO.AQUIENVADIRIGIDO>();
                    }
            ...
            public static class CATALOGACIONES {
                ...
                public List<EnviaSIA.ACTUACIONES.ACTUACION.CATALOGACIONES.CATALOGACION> getCATALOGACION() {
                    if (catalogacion == null) {
                        catalogacion = new ArrayList<EnviaSIA.ACTUACIONES.ACTUACION.CATALOGACIONES.CATALOGACION>();
                    }
            ...
            public static class SISTEMASIDENTIFICACION {
                ...
                public List<EnviaSIA.ACTUACIONES.ACTUACION.SISTEMASIDENTIFICACION.SISTEMAIDENTIFICACION> getSISTEMAIDENTIFICACION() {
                    if (sistemaidentificacion == null) {
                        sistemaidentificacion = new ArrayList<EnviaSIA.ACTUACIONES.ACTUACION.SISTEMASIDENTIFICACION.SISTEMAIDENTIFICACION>();
                    }
            ...
            public static class TIPOSACTUACION {
                ...
                public List<EnviaSIA.ACTUACIONES.ACTUACION.TIPOSACTUACION.TIPOACTUACION> getTIPOACTUACION() {
                    if (tipoactuacion == null) {
                        tipoactuacion = new ArrayList<EnviaSIA.ACTUACIONES.ACTUACION.TIPOSACTUACION.TIPOACTUACION>();
                    }
            ...
            public static class VOLTRAMITACIONES {
                ...
                public List<EnviaSIA.ACTUACIONES.ACTUACION.VOLTRAMITACIONES.VOLTRAMITACION> getVOLTRAMITACION() {
                    if (voltramitacion == null) {
                        voltramitacion = new ArrayList<EnviaSIA.ACTUACIONES.ACTUACION.VOLTRAMITACIONES.VOLTRAMITACION>();
                    }
