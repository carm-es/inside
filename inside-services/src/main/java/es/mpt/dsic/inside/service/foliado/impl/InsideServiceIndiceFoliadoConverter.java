...
public class InsideServiceIndiceFoliadoConverter {
	 ...
	 */
	public static FoliadoNodo getEstructuraFoliadoNodo (String identificador, ObjetoExpedienteInsideIndice indiceInside,InSideService service, boolean validateFlags)
		throws InSideServiceException 
	{
		FoliadoNodo padre = new FoliadoNodo ();
		padre.setNombre("EXPEDIENTE_" + identificador);
		
		for (ObjetoExpedienteInsideIndiceContenidoElementoIndizado elementoIndizado : indiceInside.getIndiceContenido().getElementosIndizados()) {

			FoliadoNodo nodoHijo = getFoliadoNodoElementoIndizado (elementoIndizado,service, validateFlags);
	 ...
	 * @throws InSideServiceException
	 */
	public static FoliadoNodo getFoliadoNodoElementoIndizado (ObjetoExpedienteInsideIndiceContenidoElementoIndizado elementoIndizado,InSideService service, boolean validateFlags) throws InSideServiceException{
		...
		if (elementoIndizado instanceof ObjetoExpedienteInsideIndiceContenidoDocumentoIndizado) {
			...
			try {
				...
				logger.warn("No se puede añadir el documento con identificador " + ((ObjetoExpedienteInsideIndiceContenidoDocumentoIndizado)elementoIndizado).getIdentificadorDocumento()+ " al foliado del expediente " + documentoIndizado.getIdentificadorDocumento() + " porque no existe en Inside" );
			...
			if (carpetaIndizada.getElementosIndizados() != null) {
				...
				for (ObjetoExpedienteInsideIndiceContenidoElementoIndizado hijoIndizado : carpetaIndizada.getElementosIndizados()) {
					
					FoliadoNodo nodoHijo = getFoliadoNodoElementoIndizado (hijoIndizado,service, validateFlags);
			...
			ObjetoExpedienteInsideIndiceContenido indiceContenido = (ObjetoExpedienteInsideIndiceContenido) elementoIndizado;
			nodo.setNombre("INDICE");
			
			if (indiceContenido.getElementosIndizados() != null) {
				
				for (ObjetoExpedienteInsideIndiceContenidoElementoIndizado hijoIndizado : indiceContenido.getElementosIndizados()) {
