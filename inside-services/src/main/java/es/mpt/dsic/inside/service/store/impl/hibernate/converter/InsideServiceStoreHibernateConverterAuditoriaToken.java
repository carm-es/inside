...
public class InsideServiceStoreHibernateConverterAuditoriaToken {
	...
	public AuditoriaToken toEntity(ObjetoAuditoriaToken auditoriatoken,
	...
	public static ObjetoAuditoriaToken toInside(AuditoriaToken entity) throws InsideServiceStoreException {
		...
		InsideServiceStoreHibernateConverterExpedienteToken converter = new InsideServiceStoreHibernateConverterExpedienteToken();
