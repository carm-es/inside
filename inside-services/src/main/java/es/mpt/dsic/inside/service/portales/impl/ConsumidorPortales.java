...
public class ConsumidorPortales {	 
	...
	public List<UnidadOrganicaRolPortales> listaUnidadesOrganicasRolesPortales(String nif) 
	{
		...
		if(listaUnidadesRolPortales.getItem()!=null && listaUnidadesRolPortales.getItem().size()>0){
			listaUnidades = unidadesOrganicasRolesINSIDE(listaUnidadesRolPortales.getItem());
			listaResultado.addAll(listaUnidades);
		}
		
		if(listaEntidadesRolPortales.getItem()!=null && listaEntidadesRolPortales.getItem().size()>0){
			listaEntidades = entidadesRolesINSIDE(listaEntidadesRolPortales.getItem());	
			listaResultado.addAll(listaEntidades);
		}
		
		if(listaOrganismosRolPortales.getItem()!=null && listaOrganismosRolPortales.getItem().size()>0){
			listaOrganismos = organismosRolesINSIDE(listaOrganismosRolPortales.getItem());
			listaResultado.addAll(listaOrganismos);
		}
		
		if(listaInstitucionesRolPortales.getItem()!=null && listaInstitucionesRolPortales.getItem().size()>0){
	...
	private boolean isCargoEspecial(String cargoDescripcionId)
	{
		...
		if(cargoDescripcionId.equalsIgnoreCase(Constantes.PORTALES_ALCALDE) 
			...
			|| cargoDescripcionId.equalsIgnoreCase(Constantes.PORTALES_INTERVENCION_TESORERIA_HAB_ESTATAL)
	...
	//  INSIDE-Consulta					-  	3
	//  INSIDE-Remisor					-   2
	private List<UnidadOrganicaRolPortales> unidadesOrganicasRolesINSIDE(List<CargoUnidadDirWsObject> lista)
	{
		...
		{									
			...
			if(aux.getCargoTipo().equalsIgnoreCase(Constantes.PORTALES_GESTOR_ID) || isCargoEspecial(aux.getCargoTipo()))
			{
				UnidadOrganicaRolPortales obj0 = new UnidadOrganicaRolPortales(aux.getCodigoDir(),Constantes.INSIDE_GESTOR_ROL);
				resultado.add(obj0);
				
			}
			else if(aux.getCargoTipo().equalsIgnoreCase(Constantes.PORTALES_ADMINISTRADORORGANISMO_ID))
			{
				UnidadOrganicaRolPortales obj1 = new UnidadOrganicaRolPortales(aux.getCodigoDir(),Constantes.INSIDE_ADMINISTRADORORGANISMO_ROL);
				resultado.add(obj1);
								
			}
			else if(aux.getCargoTipo().equalsIgnoreCase(Constantes.PORTALES_REDACTOR_ID))
			{
				UnidadOrganicaRolPortales obj2 = new UnidadOrganicaRolPortales(aux.getCodigoDir(),Constantes.INSIDE_REDACTOR_ROL);
				resultado.add(obj2);
				
			}
			else if(aux.getCargoTipo().equalsIgnoreCase(Constantes.PORTALES_CONSULTA_ID))
			{
				UnidadOrganicaRolPortales obj3 = new UnidadOrganicaRolPortales(aux.getCodigoDir(),Constantes.INSIDE_CONSULTA_ROL);
				resultado.add(obj3);
				
			}
			else if(aux.getCargoTipo().equalsIgnoreCase(Constantes.PORTALES_REDACTOR_ID))
			{
				UnidadOrganicaRolPortales obj4 = new UnidadOrganicaRolPortales(aux.getCodigoDir(),Constantes.INSIDE_REDACTOR_ROL);
				resultado.add(obj4);
	...
	//  INSIDE-Consulta					-  	3
	//  INSIDE-Remisor					-   2
	private List<UnidadOrganicaRolPortales> organismosRolesINSIDE(List<CargoOrganismoWsObject> lista)
	{
		ArrayList<UnidadOrganicaRolPortales> resultado = new ArrayList<UnidadOrganicaRolPortales>();
		...
		{									
			...
			{
				UnidadOrganicaRolPortales obj4 = new UnidadOrganicaRolPortales(aux.getCodigoEell(),Constantes.INSIDE_REDACTOR_ROL);
				resultado.add(obj4);
	...
	//  INSIDE-Consulta					-  	3
	//  INSIDE-Remisor					-   2
	private List<UnidadOrganicaRolPortales> institucionesRolesINSIDE(List<CargoInstitucionWsObject> lista)
	{
		ArrayList<UnidadOrganicaRolPortales> resultado = new ArrayList<UnidadOrganicaRolPortales>();
		...
		{									
			...
			if(aux.getPerfil().equalsIgnoreCase(Constantes.PORTALES_GESTOR_ID)  || isCargoEspecial(aux.getPerfil()))
			{
				UnidadOrganicaRolPortales obj0 = new UnidadOrganicaRolPortales(aux.getCodigoDir(),Constantes.INSIDE_GESTOR_ROL);
				resultado.add(obj0);
			...
			{
				UnidadOrganicaRolPortales obj2 = new UnidadOrganicaRolPortales(aux.getCodigoDir(),Constantes.INSIDE_REMISOR_ROL);
				resultado.add(obj2);
