...
public class InsideServiceMetadatoNotFoundInObjectException extends InsideServiceMetadatoValueExtractionException {
	...
	public InsideServiceMetadatoNotFoundInObjectException(Metadato<?> metadato, Object objeto) {
		super("No se encuentra el metadato " + metadato.getNombre() + " en las propiedades del objeto " + objeto.getClass());
	}
