...
import es.mpt.dsic.inside.ws.service.GInsideCertificateMtomWebService;
...
@WebService(endpointInterface = "es.mpt.dsic.inside.ws.service.GInsideCertificateMtomWebService", targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService", portName = "GInsideCertificateMtomWSPort", serviceName = "GInsideCertificateMtomWS")
public class GInsideCertificateMtomWebServiceImpl implements GInsideCertificateMtomWebService {

	protected static final Log logger = LogFactory.getLog(GInsideCertificateMtomWebServiceImpl.class);
	...
	@Override
	public DocumentoEniFileInsideMtom convertirDocumentoAEni(TipoDocumentoConversionInsideMtom documento, DataHandler contenido,
			Boolean firmar) throws InsideWSException {
		try {
			logger.debug("Inicio GInSideMtomWebServiceImpl.convertirDocumentoAEni");
			TipoDocumentoConversionInside documentoConversion = InsideConverterMtom.tipoDocumentoConversionToInside(documento);
			DocumentoEniFileInside tDoc = gInsideOperationWebService.convertirDocumentoAEni(documentoConversion,
					getContent(contenido), firmar, credentialUtil.getCredentialEeutil());
	...
	public DocumentoEniFileInsideConMAdicionalesMtom convertirDocumentoAEniConMAdicionales(
			TipoDocumentoConversionInsideMtom documento, TipoMetadatosAdicionales metadatosAdicionales, DataHandler contenido,
			Boolean firmar) throws InsideWSException {
		try {
			logger.debug("Inicio GInSideMtomWebServiceImpl.convertirDocumentoAEniConMAdicionales");
			TipoDocumentoConversionInside documentoConversion = InsideConverterMtom.tipoDocumentoConversionToInside(documento);
			DocumentoEniFileInsideConMAdicionales tDocAdicionales = gInsideOperationWebService
					.convertirDocumentoAEniConMAdicionales(documentoConversion, metadatosAdicionales, getContent(contenido),
	...
	@Override
	public ExpedienteEniFileInsideMtom convertirExpedienteAEni(TipoExpedienteConversionInside expediente, String contenidoFirma)
			throws InsideWSException {
		try {
			logger.debug("Inicio GInSideMtomWebServiceImpl.convertirExpedienteAEni");
			ExpedienteEniFileInside expedienteEniFile = gInsideOperationWebService.convertirExpedienteAEni(expediente,
		...
		try {
			...
			ExpedienteEniFileInsideConMAdicionales expedienteEniFile = gInsideOperationWebService
					.convertirExpedienteAEniConMAdicionales(expediente, metadatosAdicionales, contenidoFirma,
							credentialUtil.getCredentialEeutil());
	...
	@Override
	public ExpedienteEniFileInsideMtom convertirExpedienteAEniAutocontenido(TipoExpedienteConversionInsideWSMtom expediente,
		...
		try {
			...
			TipoExpedienteConversionInside expConvert = InsideConverterTipoExpedienteMtomConversion
					.convertTipoExpedienteFromWS(expediente);
			ExpedienteEniFileInside expedienteEniFile = gInsideOperationWebService.convertirExpedienteAEni(expConvert,
					contenidoFirma, credentialUtil.getCredentialEeutil());
	...
	public ExpedienteEniFileInsideConMAdicionalesMtom convertirExpedienteAEniConMAdicionalesAutocontenido(
			TipoExpedienteConversionInsideWSMtom expediente, TipoMetadatosAdicionales metadatosAdicionales, String contenidoFirma)
					throws InsideWSException {
		try {
			logger.debug("Inicio GInSideMtomWebServiceImpl.convertirExpedienteAEniConMAdicionalesAutocontenido");
			TipoExpedienteConversionInside expConvert = InsideConverterTipoExpedienteMtomConversion
					.convertTipoExpedienteFromWS(expediente);
			ExpedienteEniFileInsideConMAdicionales expedienteEniFile = gInsideOperationWebService
					.convertirExpedienteAEniConMAdicionales(expConvert, metadatosAdicionales, contenidoFirma,
							credentialUtil.getCredentialEeutil());
			logger.debug("Fin GInSideMtomWebServiceImpl.convertirExpedienteAEniConMAdicionalesAutocontenido");
			return InsideConverterMtom.expedienteEniFileToMtomConAdicionales(expedienteEniFile);
		} catch (InsideConverterException e) {
			throw InsideExceptionConverter.convertToException(e);
		} catch (Exception e) {
	...
	@Override
	public TipoResultadoValidacionDocumentoInside validarDocumentoEniFile(TipoDocumentoValidacionInsideMtom documentoMtom)
			throws InsideWSException {
		try {
			logger.debug("Iniciado validarDocumentoEniFile en WS");
			TipoDocumentoValidacionInside documentoValidacion = InsideConverterMtom
					.tipoDocumentoValidacionToInside(documentoMtom);
	...
	@Override
	public TipoResultadoValidacionExpedienteInside validarExpedienteEniFile(TipoExpedienteValidacionInsideMtom expedienteMtom)
			throws InsideWSException {
		try {
			logger.debug("Iniciado validarDocumentoEniFile en WS");
			TipoExpedienteValidacionInside expedienteValidacion = InsideConverterMtom
					.tipoExpedienteValidacionToInside(expedienteMtom);
	...
	public TipoResultadoVisualizacionDocumentoInsideMtom visualizarDocumentoEni(
		...
		try {
			...
			TipoDocumentoVisualizacionInside documentoVisualizacion = InsideConverterMtom
					.tipoDocumentoVisualizacionToInside(documentoMtom);
			return InsideConverterMtom.tipoResultadoVisualizacionDocumentoToMtom(gInsideOperationWebService
					.visualizarDocumentoEni(documentoVisualizacion, credentialUtil.getCredentialEeutil()));
		} catch (Exception e) {
			throw InsideExceptionConverter.convertToException(e);
		}
	}
