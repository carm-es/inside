...
@WebService(name = "InSideUserTokenWebService", targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService")
...
public interface InsideUserTokenWebService {
	...
	public ExpedienteInsideInfo altaExpedienteEni(
			@WebParam(name = "expediente") @XmlElement(required = true, name = "expediente") TipoExpediente expediente,
	...
	public ExpedienteInsideInfo altaExpedienteEniXml(
			@WebParam(name = "expedienteEniFile") @XmlElement(required = true, name = "expedienteEniFile") TipoExpedienteEniFileInsideConDocumentos expedienteEniXml)
					throws InsideWSException;
	...
	public ExpedienteInsideInfo cambiaMetadatosExpediente(
			...
			@WebParam(name = "metadatosEni") @XmlElement(required = true, name = "metadatosEni") TipoMetadatos metadatosEni,
			@WebParam(name = "metadatosAdicionales") @XmlElement(required = false, name = "metadatosAdicionales") TipoMetadatosAdicionales metadatosAdicionales)
					throws InsideWSException;
	...
	public DocumentoInsideInfo cambiaMetadatosDocumento(
			@WebParam(name = "identificador") @XmlElement(required = true, name = "identificador") String identificador,
			@WebParam(name = "metadatosEni") @XmlElement(required = true, name = "metadatosEni") es.mpt.dsic.inside.xml.eni.documento.metadatos.TipoMetadatos metadatosEni,
			@WebParam(name = "metadatosAdicionales") @XmlElement(required = false, name = "metadatosAdicionales") TipoMetadatosAdicionales metadatosAdicionales)
					throws InsideWSException;
	...
	public ExpedienteInsideInfo altaCarpetaEnExpediente(
			@WebParam(name = "identificadorExpediente") @XmlElement(required = true, name = "identificadorExpediente") String identificadorExpediente,
			@WebParam(name = "carpetaIndizada") @XmlElement(required = true, name = "carpetaIndizada") TipoCarpetaIndizada identificadorCarpeta,
			@WebParam(name = "ruta") @XmlElement(required = false, name = "ruta") String ruta) throws InsideWSException;
	...
	public ExpedienteInsideInfo borrarCarpetaEnExpediente(
			@WebParam(name = "identificadorExpediente") @XmlElement(required = true, name = "identificadorExpediente") String identificadorExpediente,
			@WebParam(name = "identificadorCarpeta") @XmlElement(required = true, name = "identificadorCarpeta") String identificadorCarpeta,
			@WebParam(name = "ruta") @XmlElement(required = false, name = "ruta") String ruta) throws InsideWSException;
	...
	public ExpedienteInsideInfo cambiaEstadoExpediente(
			@WebParam(name = "identificador") @XmlElement(required = true, name = "identificador") String identificador,
			@WebParam(name = "estado") @XmlElement(required = true, name = "estado") EnumeracionEstados estado)
					throws InsideWSException;
	...
	public ExpedienteInsideInfo importarExpediente(
			@WebParam(name = "identificador") @XmlElement(required = true, name = "identificador") String identificador,
			@WebParam(name = "identificadorImportado") @XmlElement(required = true, name = "identificadorImportado") String identificadorImportado,
			@WebParam(name = "ruta") @XmlElement(required = true, name = "ruta") String ruta) throws InsideWSException;

	@WebMethod(operationName = "vincularExpediente", action = "urn:vincularExpediente")
	@WebResult(name = "ExpedienteInsideInfo", partName = "ExpedienteInsideInfo", targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/expediente-e/expedienteInfo")
	public ExpedienteInsideInfo vincularExpediente(
			@WebParam(name = "identificador") @XmlElement(required = true, name = "identificador") String identificador,
			@WebParam(name = "identificadorVinculado") @XmlElement(required = true, name = "identificadorVinculado") String identificadorVinculado,
			@WebParam(name = "ruta") @XmlElement(required = true, name = "ruta") String ruta) throws InsideWSException;

	@WebMethod(operationName = "crearVistaAbiertaExpediente", action = "urn:crearVistaAbiertaExpediente")
	@WebResult(name = "ExpedienteInsideInfo", partName = "ExpedienteInsideInfo", targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/expediente-e/expedienteInfo")
	public ExpedienteInsideInfo crearVistaAbiertaExpediente(
			@WebParam(name = "identificador") @XmlElement(required = true, name = "identificador") String identificador)
					throws InsideWSException;

	@WebMethod(operationName = "crearVistaCerradaExpediente", action = "urn:crearVistaCerradaExpediente")
	@WebResult(name = "ExpedienteInsideInfo", partName = "ExpedienteInsideInfo", targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/expediente-e/expedienteInfo")
	public ExpedienteInsideInfo crearVistaCerradaExpediente(
			@WebParam(name = "identificador") @XmlElement(required = true, name = "identificador") String identificador)
					throws InsideWSException;

	@WebMethod(operationName = "vincularDocumentosEnExpediente", action = "urn:vincularDocumentosEnExpediente")
	@WebResult(name = "ExpedienteInsideInfo", partName = "ExpedienteInsideInfo", targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/expediente-e/expedienteInfo")
	public ExpedienteInsideInfo vincularDocumentosEnExpediente(
			@WebParam(name = "identificador") @XmlElement(required = true, name = "identificador") String identificador,
			@WebParam(name = "identificadorDocumento") @XmlElement(required = true, name = "identificadorDocumento") List<String> identificadoresDocumentos,
			@WebParam(name = "ruta") @XmlElement(required = true, name = "ruta") String ruta) throws InsideWSException;

	@WebMethod(operationName = "desvincularDocumentosEnExpediente", action = "urn:desvincularDocumentosEnExpediente")
	@WebResult(name = "ExpedienteInsideInfo", partName = "ExpedienteInsideInfo", targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/expediente-e/expedienteInfo")
	...
	@WebMethod(operationName = "cambiarUbicacionEnExpediente", action = "urn:cambiarUbicacionEnExpediente")
	@WebResult(name = "ExpedienteInsideInfo", partName = "ExpedienteInsideInfo", targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/expediente-e/expedienteInfo")
	public ExpedienteInsideInfo cambiarUbicacionEnExpediente(
			@WebParam(name = "identificadorExpediente") @XmlElement(required = true, name = "identificadorExpediente") String identificadorExpediente,
			@WebParam(name = "identificadoresElementos") @XmlElement(required = true, name = "identificadoresElementos") List<String> identificadoresElementos,
			@WebParam(name = "rutaOrigen") @XmlElement(required = true, name = "rutaOrigen") String rutaOrigen,
			@WebParam(name = "rutaDestino") @XmlElement(required = true, name = "rutaDestino") String rutaDestino)
					throws InsideWSException;
	...
	public TipoExpedienteInside getExpediente(
			@WebParam(name = "identificador") @XmlElement(required = true, name = "identificador") String identificador,
			@WebParam(name = "version") @XmlElement(name = "version") Integer version) throws InsideWSException;
	...
	@WebResult(name = "indice", partName = "indice", targetNamespace = "http://administracionelectronica.gob.es/ENI/XSD/v1.0/expediente-e/indice-e")
	public TipoIndice getIndiceExpediente(
			@WebParam(name = "identificador") @XmlElement(required = true, name = "identificador") String identificador)
					throws InsideWSException;

	@WebMethod(operationName = "getExpedienteMetadatos", action = "urn:getExpedienteMetadatos")
	@WebResult(name = "metadatos", partName = "metadatos", targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/expediente-e/metadatos")
	...
	@WebResult(name = "versiones", partName = "versiones", targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/version")
	...
	public DocumentoInsideInfo altaDocumentoOriginal(
			@WebParam(name = "documento") @XmlElement(required = true, name = "documento") TipoDocumentoAltaInside documento)
					throws InsideWSException;
	...
	public DocumentoInsideInfo altaDocumentoEni(
			@WebParam(name = "documento") @XmlElement(required = true, name = "documento") TipoDocumento documento,
			@WebParam(name = "asociadoaExpediente") @XmlElement(required = false, name = "asociadoaExpediente") TipoDocumentoAsociadoaExpediente asociadoaExpediente,
			@WebParam(name = "metadatosAdicionales") @XmlElement(required = false, name = "metadatosAdicionales") TipoMetadatosAdicionales metadatosAdicionales,
	...
	public DocumentoInsideInfo altaDocumentoEniXml(
			@WebParam(name = "documentoEniFile") @XmlElement(required = true, name = "documentoEniFile") TipoDocumentoEniFileInside documentoEniFile)
					throws InsideWSException;
	...
	public TipoDocumentoInside getDocumento(
			@WebParam(name = "identificador") @XmlElement(required = true, name = "identificador") String identificador)
					throws InsideWSException;
	...
	public TipoContenido getDocumentoContenido(
			@WebParam(name = "identificador") @XmlElement(required = true, name = "identificador") String identificador)
					throws InsideWSException;

	@WebMethod(operationName = "getMetadatosDocumento", action = "urn:getMetadatosDocumento")
	@WebResult(name = "metadatos", partName = "metadatos", targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/documento-e/metadatos")
	public DocumentoInsideMetadatos getMetadatosDocumento(
			@WebParam(name = "identificador") @XmlElement(required = true, name = "identificador") String identificador)
					throws InsideWSException;

	@WebMethod(operationName = "getNumeroBytesDocumentoFirmado", action = "urn:getNumeroBytesDocumentoFirmado")
	@WebResult(name = "numeroBytes", partName = "numeroBytes", targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/version")
	public Integer getNumeroBytesDocumentoFirmado(
			@WebParam(name = "identificador") @XmlElement(required = true, name = "identificador") String identificador)
					throws InsideWSException;

	@WebMethod(operationName = "getFirmasEniCSVDocumento", action = "urn:getFirmasEniCSVDocumento")
	@WebResult(name = "firmasCSV", partName = "firmasCSV", targetNamespace = "http://administracionelectronica.gob.es/ENI/XSD/v1.0/firma")
	public Firmas getFirmasEniCSVDocumento(
			@WebParam(name = "identificador") @XmlElement(required = true, name = "identificador") String identificador)
					throws InsideWSException;

	@WebMethod(operationName = "buscarExpedientes", action = "urn:buscarExpedientes")
	@WebResult(name = "resultados", partName = "resultados", targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/busqueda/resultados")
	public ExpedienteResultadoBusqueda buscarExpedientes(
			@WebParam(name = "consulta") @XmlElement(required = true, name = "consulta") ConsultaWsInside consulta,
			@WebParam(name = "limite") @XmlElement(required = false, name = "limite") int limite,
			@WebParam(name = "pagina") @XmlElement(required = false, name = "pagina") int pagina) throws InsideWSException;
	...
	@WebMethod(operationName = "expedientesAsociadoDocumento", action = "urn:expedientesAsociadoDocumento")
	@WebResult(name = "expediente", partName = "expediente", targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/expediente-e/expedienteInfo")
	...
	@WebResult(name = "RespuestaRemisionAJusticiaType", partName = "RespuestaRemisionAJusticiaType", targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/remisionNube")
	public RespuestaRemisionAJusticiaType remisionAJusticia(
			@WebParam(name = "peticionRemisionAJusticiaType") @XmlElement(required = true, name = "peticionRemisionAJusticiaType") PeticionRemisionAJusticiaType peticionRemisionAJusticiaType)
					throws InsideWSException;
	
	@WebMethod(operationName = "consultaEstadoRemisionAJusticia", action = "urn:consultaEstadoRemisionAJusticia")
	@WebResult(name = "RespuestaConsultaEnvioJusticia", partName = "RespuestaConsultaEnvioJusticia", targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/respuestaConsultaEnvioJusticia")
	public RespuestaConsultaEnvioJusticia consultaEstadoRemisionAJusticia(
			@WebParam(name = "codigoEnvioATEA") @XmlElement(required = true, name = "codigoEnvioATEA") String codigoEnvioATEA)
					throws InsideWSException;

	@WebMethod(operationName = "getPdfExpediente", action = "urn:getPdfExpediente")
	@WebResult(name = "RespuestaPdfExpediente", partName = "RespuestaPdfExpediente", targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/respuestaPdfExpediente")
	public RespuestaPdfExpediente getPdfExpediente(@WebParam(name = "expedienteEni") @XmlElement(required = true, name = "expedienteEni") byte[] expedienteEni)
					throws InsideWSException;
