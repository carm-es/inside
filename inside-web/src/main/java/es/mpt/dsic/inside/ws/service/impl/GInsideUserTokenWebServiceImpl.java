...
@WebService(endpointInterface = "es.mpt.dsic.inside.ws.service.GInsideUserTokenWebService", targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService", portName = "GInsideUserTokenWSPort", serviceName = "GInsideUserTokenWS")
public class GInsideUserTokenWebServiceImpl implements GInsideUserTokenWebService {
	...
	public DocumentoEniFileInside convertirDocumentoAEni(TipoDocumentoConversionInside documento, byte[] contenido,
		...
		try {
			return gInsideOperationWebService.convertirDocumentoAEni(documento, contenido, firmar, credentialUtil.getCredentialEeutilUserToken(jaxwsContext));
		} catch (Exception e) {
	...
	public ExpedienteEniFileInside convertirExpedienteAEni(TipoExpedienteConversionInside expediente, String contenidoFirma)
		...
		try {
			return gInsideOperationWebService.convertirExpedienteAEni(expediente, contenidoFirma, credentialUtil.getCredentialEeutilUserToken(jaxwsContext));
		} catch (Exception e) {
			throw InsideExceptionConverter.convertToException(e);
		}
	}
	...
	public ExpedienteEniFileInside convertirExpedienteAEniAutocontenido(TipoExpedienteConversionInsideWS expediente,
		...
		try {
			return gInsideOperationWebService.convertirExpedienteAEniAutocontenido(expediente, contenidoFirma, credentialUtil.getCredentialEeutilUserToken(jaxwsContext));
		} catch (Exception e) {
			throw InsideExceptionConverter.convertToException(e);
		}
	}
	...
	public ExpedienteEniFileInsideConMAdicionales convertirExpedienteAEniConMAdicionalesAutocontenido(
		...
		try {
			return gInsideOperationWebService.convertirExpedienteAEniConMAdicionalesAutocontenido(expediente,
					metadatosAdicionales, contenidoFirma, credentialUtil.getCredentialEeutilUserToken(jaxwsContext));
		} catch (Exception e) {
			throw InsideExceptionConverter.convertToException(e);
		}
	}
	...
	public TipoResultadoValidacionExpedienteInside validarExpedienteEniFile(TipoExpedienteValidacionInside expedienteValidacion)
			throws InsideWSException {
		try {
			return gInsideOperationWebService.validarExpedienteEniFile(expedienteValidacion, credentialUtil.getCredentialEeutilUserToken(jaxwsContext));
		} catch (Exception e) {
			throw InsideExceptionConverter.convertToException(e);
		}
	}
	...
	public TipoResultadoVisualizacionDocumentoInside visualizarDocumentoEni(
		...
		try {
			return gInsideOperationWebService.visualizarDocumentoEni(documentoVisualizacion, credentialUtil.getCredentialEeutilUserToken(jaxwsContext));
		} catch (Exception e) {
			throw InsideExceptionConverter.convertToException(e);
		}
	}
