...
@WebService(endpointInterface = "es.mpt.dsic.inside.ws.service.GInsideUserTokenMtomWebService", targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService", portName = "GInsideUserTokenMtomWSPort", serviceName = "GInsideUserTokenMtomWS")
public class GInsideUserTokenMtomWebServiceImpl implements GInsideUserTokenMtomWebService {
	...
	public DocumentoEniFileInsideMtom convertirDocumentoAEni(TipoDocumentoConversionInsideMtom documento, DataHandler contenido,
		...
		try {
			...
			DocumentoEniFileInside tDoc = gInsideOperationWebService.convertirDocumentoAEni(documentoConversion,
					getContent(contenido), firmar, credentialUtil.getCredentialEeutilUserToken(jaxwsContext));
		...
		try {
			...
			DocumentoEniFileInsideConMAdicionales tDocAdicionales = gInsideOperationWebService
					.convertirDocumentoAEniConMAdicionales(documentoConversion, metadatosAdicionales, getContent(contenido),
							firmar, credentialUtil.getCredentialEeutilUserToken(jaxwsContext));
	...
	public TipoResultadoValidacionDocumentoInside validarDocumentoEniFile(TipoDocumentoValidacionInsideMtom documentoMtom)
		...
		try {
			...
			return gInsideOperationWebService.validarDocumentoEniFile(documentoValidacion, credentialUtil.getCredentialEeutilUserToken(jaxwsContext));
		} catch (Exception e) {
			throw InsideExceptionConverter.convertToException(e);
		}
	}
	...
	public TipoResultadoVisualizacionDocumentoInsideMtom visualizarDocumentoEni(
		...
		try {
			...
			return InsideConverterMtom.tipoResultadoVisualizacionDocumentoToMtom(gInsideOperationWebService
					.visualizarDocumentoEni(documentoVisualizacion, credentialUtil.getCredentialEeutilUserToken(jaxwsContext)));
		} catch (Exception e) {
			throw InsideExceptionConverter.convertToException(e);
		}
	}
