...
@WebService(endpointInterface = "es.mpt.dsic.inside.ws.service.InsideCertificateMtomWebService", targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService", portName = "InsideCertificateMtomWSPort", serviceName = "InsideCertificateMtomWS")
