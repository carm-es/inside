...
@WebService(name = "GInsideCertificateMtomWebService", targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebServiceFiles")
@Logging(limit=-1)
@GZIP
...
public interface GInsideCertificateMtomWebService {
	...
	public DocumentoEniFileInsideMtom convertirDocumentoAEni(
			@WebParam(name = "documento") @XmlElement(required = true, name = "documento") TipoDocumentoConversionInsideMtom documento,
			@WebParam(name = "contenido") @XmlElement(required = false, name = "contenido") @XmlMimeType("application/octet-stream") DataHandler contenido,
	...
	public ExpedienteEniFileInsideMtom convertirExpedienteAEniAutocontenido(
			@WebParam(name = "expediente") @XmlElement(required = true, name = "expediente") TipoExpedienteConversionInsideWSMtom expediente,
			@WebParam(name = "contenidoFirma") @XmlElement(required = false, name = "contenidoFirma") String contenidoFirma)
			throws InsideWSException;
	...
	public TipoResultadoValidacionExpedienteInside validarExpedienteEniFile(
			@WebParam(name = "expediente") @XmlElement(required = true, name = "expediente") TipoExpedienteValidacionInsideMtom expediente)
			throws InsideWSException;
	...
	public TipoResultadoValidacionDocumentoInside validarDocumentoEniFile(
			@WebParam(name = "documento") @XmlElement(required = true, name = "documento") TipoDocumentoValidacionInsideMtom documento)
			throws InsideWSException;
	...
	public TipoResultadoVisualizacionDocumentoInsideMtom visualizarDocumentoEni(
			@WebParam(name = "documento") @XmlElement(required = true, name = "documento") TipoDocumentoVisualizacionInsideMtom documento)
			throws InsideWSException;
