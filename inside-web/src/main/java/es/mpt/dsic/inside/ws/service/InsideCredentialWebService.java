...
@WebService(name = "InSideWebService", targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService")
...
public interface InsideCredentialWebService {
	...
	public ExpedienteInsideInfo altaExpedienteEni(
			@WebParam(name = "credential", targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement(required = true, name = "credential") WSCredentialInside info,
	...
	public ExpedienteInsideInfo altaCarpetaEnExpediente(
			...
			@WebParam(name = "carpetaIndizada") @XmlElement(required = true, name = "carpetaIndizada") TipoCarpetaIndizada carpetaIndizada,
	...
	// @WebResult(name = "expediente", partName =
	// "expediente",targetNamespace="https://ssweb.seap.minhap.es/Inside/XSD/v1.0/expediente-e")
	...
	/*
	 * @WebMethod(operationName = "getFicheroFoliado", action =
	 * "urn:getFicheroFoliado")
	 * 
	 * @WebResult(name = "ficheroFoliado", partName = "ficheroFoliado") public
	 * TipoContenido getFicheroFoliado(
	 * 
	 * @WebParam(name = "credential",targetNamespace=
	 * "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService/types/credential") @XmlElement
	 * (required = true, name = "credential") WSCredentialInside info,
	 * 
	 * @WebParam(name = "identificador") @XmlElement(required = true, name =
	 * "identificador") String identificador) throws InsideWSException;
	 */
