...
function removeMetadatoDoc (position){
	...
	while(metadatosDocAdded-1 > position) {
		...
		$("#metadatosAdicionalesDoc.metadatoAdicional" + aux + ".nombre").setAttribute("name", "metadatosAdicionalesDoc.metadatoAdicional[" + position + "].nombre");
		$("#metadatosAdicionalesDoc.metadatoAdicional" + aux + ".nombre").setAttribute("id", "metadatosAdicionalesDoc.metadatoAdicional" + position + ".nombre");
		$("#metadatosAdicionalesDoc.metadatoAdicional" + aux + ".valor").setAttribute("name", "metadatosAdicionalesDoc.metadatoAdicional[" + position + "].valor");
		$("#metadatosAdicionalesDoc.metadatoAdicional" + aux + ".valor").setAttribute("id", "metadatosAdicionalesDoc.metadatoAdicional" + position + ".valor");
